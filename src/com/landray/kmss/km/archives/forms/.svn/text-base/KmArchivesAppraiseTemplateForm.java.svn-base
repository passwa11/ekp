...
/**
  * 借阅申请模板
  */
public class KmArchivesAppraiseTemplateForm extends ExtendAuthForm
	...
	@Override
    public Class<KmArchivesAppraiseTemplate> getModelClass() {
		return KmArchivesAppraiseTemplate.class;
    }
