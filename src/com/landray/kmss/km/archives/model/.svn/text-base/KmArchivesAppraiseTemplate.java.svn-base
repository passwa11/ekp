 ...
 * 鉴定申请模板
 */
public class KmArchivesAppraiseTemplate extends ExtendAuthModel
	...
	@Override
	public Class<KmArchivesAppraiseTemplateForm> getFormClass() {
		return KmArchivesAppraiseTemplateForm.class;
    }
