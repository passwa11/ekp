...
/**
  * 借阅申请模板
  */
public class KmArchivesTemplate extends ExtendAuthModel
    ...
    private List<KmArchivesDense> listDenseLevel;

    @Override
	public Class<KmArchivesTemplateForm> getFormClass() {
        return KmArchivesTemplateForm.class;
    }
	...
	public ModelToFormPropertyMap getToFormPropertyMap() {
        if (toFormPropertyMap == null) {
            ...
            toFormPropertyMap.put("listDenseLevel", new ModelConvertor_ModelListToString("listDenseLevelIds:listDenseLevelNames", "fdId:fdName"));
        }
     ...
     * 密级程度
     */
    public List<KmArchivesDense> getListDenseLevel() {
		return listDenseLevel;
	}

    /**
     * 密级程度
     */
	public void setListDenseLevel(List<KmArchivesDense> listDenseLevel) {
		this.listDenseLevel = listDenseLevel;
	}
