...
public class KmArchivesHtmlHandler {

	private Logger logger = org.slf4j.LoggerFactory.getLogger(KmArchivesHtmlHandler.class);
	...
	public String handlingHTMLAgain(String html) {
		return handlingHTMLAgainZoom(html,"0.7");
	}
	
	public String handlingHTMLAgainZoom(String html,String zoom) {
		...
		//px整体缩小
		if(StringUtil.isNotNull(zoom)){
			float zoomVal = Float.parseFloat(zoom);
			html = handlingZoom(html, zoomVal);
		}
		return html;
	}
