 ...
 */
public class KmReviewMainEventByHrAttendJiTiQianKa implements IExtendDataEvent {
	private IKmReviewMainService kmReviewMainService;
	private static final Log log = LogFactory.getLog(KmReviewMainEventByHrAttendJiTiQianKa.class);
