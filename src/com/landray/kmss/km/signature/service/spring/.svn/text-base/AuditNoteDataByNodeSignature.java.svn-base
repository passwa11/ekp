...
public class AuditNoteDataByNodeSignature extends AbstractAuditNoteData {

	private static Logger logger = LoggerFactory
			.getLogger(AuditNoteDataByNodeSignature.class);
	...
	public String builderStyle2Out(LbpmAuditNote lbpmAuditNote,
		...
		try {
			...
			if ("true".equals(dataMap.get("kmss.integrate.esa.enabled"))) {
				AbstractAuditNoteData signatureNoteData = (AbstractAuditNoteData) SpringBeanUtil
						.getBean("esaAuditNoteDataByNodeSignature");
				signatureNoteData
		...
		String buildString = super.builderStyle2Out(lbpmAuditNote,
				auditNoteStyle, attachment);
		//System.out.println("buildString1:" + buildString);
		...
		//System.out.println("buildString2:" + buildString);
		return buildString;
	}
