 ...
 * @author 舒斌
 */
public class KmReviewTemplateKeywordForm extends BaseForm

{
	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 8881899757807166111L;
	/*
	 * 对象ID
	 */
	...
	public Class getModelClass() {
		return KmReviewTemplateKeyword.class;
	}
