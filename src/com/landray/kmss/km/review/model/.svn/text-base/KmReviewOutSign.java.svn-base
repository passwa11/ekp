...
import com.landray.kmss.km.review.forms.KmReviewOutSignForm;
import com.landray.kmss.sys.organization.model.SysOrgElement;
import com.landray.kmss.util.DateUtil;
public class KmReviewOutSign extends BaseModel{
	...
	@Override
    public Class<KmReviewOutSignForm> getFormClass() {
		return KmReviewOutSignForm.class;
    }
