...
import com.landray.kmss.km.calendar.ical.values.IcalObject;
import com.landray.kmss.km.calendar.ical.values.RDateList;
import com.landray.kmss.km.calendar.ical.values.RRule;
...
public class RecurrenceIteratorFactory {
	...
	private static final Logger LOGGER = org.slf4j.LoggerFactory.getLogger(RecurrenceIteratorFactory.class.getName());
	...
	private static IcalObject[] parseContentLines(String rdata, TimeZone tzid,
		...
		for (int i = 0; i < lines.length; ++i) {
			...
			try {
				...
				LOGGER.error("Dropping bad recurrence rule line: "
						+ line, ex);
				++nbad;
			} catch (IllegalArgumentException ex) {
				if (strict) {
