...
import com.landray.kmss.eop.basedata.forms.EopBasedataOtherForm;
...
/**
  * 供应商其他类型信息表
  */
public class EopBasedataOther extends ExtendAuthTmpModel implements IAttachment {

    private static ModelToFormPropertyMap toFormPropertyMap;

    private String fdName;

    private String fdCharacter;
    ...
    private List<EopBasedataOtherContact> fdContactPerson;
    ...
    @Override
    public Class<EopBasedataOtherForm> getFormClass() {
        return EopBasedataOtherForm.class;
    }
     ...
     * 联系人
     */
    public List<EopBasedataOtherContact> getFdContactPerson() {
     ...
     * 联系人
     */
    public void setFdContactPerson(List<EopBasedataOtherContact> fdContactPerson) {
     ...
     * @param fdCharacter
     */
    public void setFdCharacter(String fdCharacter) {
