...
import com.landray.kmss.eop.basedata.forms.EopBasedataCustomerAccountForm;

/**
  * 收款账户信息
  */
public class EopBasedataCustomerAccount extends BaseModel {
    ...
    @Override
    public Class<EopBasedataCustomerAccountForm> getFormClass() {
        return EopBasedataCustomerAccountForm.class;
    }
