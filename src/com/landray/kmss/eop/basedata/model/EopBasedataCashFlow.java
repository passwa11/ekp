...
/**
  * 现金流量项目
  */
public class EopBasedataCashFlow extends BaseTreeModel {
    ...
    private List<EopBasedataAccounts> fdAccountsList= new ArrayList<EopBasedataAccounts>();

    @Override
    public Class<EopBasedataCashFlowForm> getFormClass() {
        return EopBasedataCashFlowForm.class;
    }
    ...
    public ModelToFormPropertyMap getToFormPropertyMap() {
        if (toFormPropertyMap == null) {
			...
			toFormPropertyMap.put("fdAccountsList", new ModelConvertor_ModelListToString("fdAccountsListIds:fdAccountsListNames", "fdId:fdName"));
        }
    ...
    public List<EopBasedataAccounts> getFdAccountsList() {
		return fdAccountsList;
	}
    /** 
     * 会计科目
     * @param fdAccountsList
     */
	
	public void setFdAccountsList(List<EopBasedataAccounts> fdAccountsList) {
