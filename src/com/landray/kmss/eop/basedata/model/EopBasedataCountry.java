...
/**
  * 国家
  */
public class EopBasedataCountry extends BaseModel implements IAttachment {
    ...
    @Override
    public Class<EopBasedataCountryForm> getFormClass() {
        return EopBasedataCountryForm.class;
    }
