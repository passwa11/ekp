...
/**
  * 项目
  */
public class EopBasedataProject extends BaseTreeModel {
    ...
    private SysOrgPerson fdProjectManager;

    @Override
    public Class<EopBasedataProjectForm> getFormClass() {
        return EopBasedataProjectForm.class;
    }
    ...
    public ModelToFormPropertyMap getToFormPropertyMap() {
        if (toFormPropertyMap == null) {
			...
			toFormPropertyMap.put("fdProjectManager.fdId", "fdProjectManagerId");
			toFormPropertyMap.put("fdProjectManager.fdName", "fdProjectManagerName");
        }
     ...
     * @return
     */
	public SysOrgPerson getFdProjectManager() {
		return fdProjectManager;
	}
	/**
	 * 项目经理
	 * @param fdProjectManager
	 */
	public void setFdProjectManager(SysOrgPerson fdProjectManager) {
