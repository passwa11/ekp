...
import com.landray.kmss.eop.basedata.forms.EopBasedataOtherContactForm;

/**
  * 联系人
  */
public class EopBasedataOtherContact extends BaseModel {
    ...
    private EopBasedataOther docMain;

    private Integer docIndex;

    @Override
    public Class<EopBasedataOtherContactForm> getFormClass() {
        return EopBasedataOtherContactForm.class;
    }
    ...
    public EopBasedataOther getDocMain() {
        return this.docMain;
    }

    public void setDocMain(EopBasedataOther docMain) {
