...
public class EopBasedataSpecialItemDataAction extends BaseAction {
    ...
    public ActionForward fdSpecialItem(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        TimeCounter.logCurrentTime("fdSpecialItem", true, getClass());
        ...
        try {
            ...
            if (StringUtil.isNotNull(keyWord)) {
                ...
                where += "eopBasedataSpecialItem.fdName like :keyWord";
                hqlInfo.setWhereBlock(where);
            }
            hqlInfo.setWhereBlock(StringUtil.linkString(hqlInfo.getWhereBlock(), " and ",
					"eopBasedataSpecialItem.fdCompany.fdId=:fdCompanyId"));
			hqlInfo.setParameter("fdCompanyId", request.getParameter("fdCompanyId"));
            hqlInfo.setWhereBlock(
					StringUtil.linkString(hqlInfo.getWhereBlock(), " and ", " eopBasedataSpecialItem.fdIsAvailable=:fdIsAvailable "));
        ...
        TimeCounter.logCurrentTime("fdSpecialItem", false, getClass());
        if (messages.hasError()) {
            KmssReturnPage.getInstance(request).addMessages(messages).addButton(KmssReturnPage.BUTTON_CLOSE).save(request);
            return mapping.findForward("failure");
        } else {
            return mapping.findForward("fdSpecialItem");
        }
    }
}
