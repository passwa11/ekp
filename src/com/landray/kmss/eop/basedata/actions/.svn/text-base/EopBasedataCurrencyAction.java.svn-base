...
/**
 * @author wangwh
 * @description:货币action
 * @date 2021/5/7
 */
public class EopBasedataCurrencyAction extends EopBasedataBusinessAction {
    ...
    public void changeFindPageHQLInfo(HttpServletRequest request, HQLInfo hqlInfo) throws Exception {
        ...
        EopBasedataUtil.buildHqlInfoDate(hqlInfo, request, EopBasedataCurrency.class);
        EopBasedataUtil.buildHqlInfoModel(hqlInfo, request);
    }

    @Override
    public ActionForm createNewForm(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        EopBasedataCurrencyForm eopBasedataCurrencyForm = (EopBasedataCurrencyForm) super.createNewForm(mapping, form, request, response);
        ((IEopBasedataCurrencyService) getServiceImp(request)).initFormSetting((IExtendForm) form, new RequestContext(request));
        return eopBasedataCurrencyForm;
    }
    ...
    public ActionForward deleteall(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        TimeCounter.logCurrentTime("EopBasedataCurrencyAction-deleteall", true, getClass());
        ...
        TimeCounter.logCurrentTime("EopBasedataCurrencyAction-deleteall", false, getClass());
    ...
    public ActionForward delete(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        TimeCounter.logCurrentTime("EopBasedataCurrencyAction-delete", true, getClass());
        KmssMessages messages = new KmssMessages();
        try {
        ...
        TimeCounter.logCurrentTime("EopBasedataCurrencyAction-delete", false, getClass());
        if (messages.hasError()) {
            return getActionForward("failure", mapping, form, request, response);
        } else {
            return getActionForward("success", mapping, form, request, response);
