...
/**
  * 内部订单
  */
public class EopBasedataInnerOrderForm extends ExtendForm {
    ...
    @Override
    public Class<EopBasedataInnerOrder> getModelClass() {
        return EopBasedataInnerOrder.class;
    }
    ...
    public FormToModelPropertyMap getToModelPropertyMap() {
        if (toModelPropertyMap == null) {
			...
			toModelPropertyMap.put("fdParentId", new FormConvertor_IDToModel("fdParent", EopBasedataInnerOrder.class));
        }
