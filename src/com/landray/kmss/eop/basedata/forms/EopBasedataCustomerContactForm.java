...
import com.landray.kmss.eop.basedata.model.EopBasedataCustomerContact;
...
/**
  * 联系人
  */
public class EopBasedataCustomerContactForm extends ExtendForm {
    ...
    @Override
    public Class<EopBasedataCustomerContact> getModelClass() {
        return EopBasedataCustomerContact.class;
    }
    ...
    public FormToModelPropertyMap getToModelPropertyMap() {
        if (toModelPropertyMap == null) {
            ...
            toModelPropertyMap.put("docMainId", new FormConvertor_IDToModel("docMain", EopBasedataCustomer.class));
        }
