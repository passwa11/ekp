...
/**
  * 供应商类型
  */
public class EopBasedataSupTypeForm extends ExtendAuthTmpForm {
    ...
    @Override
    public Class<EopBasedataSupType> getModelClass() {
        return EopBasedataSupType.class;
    }
    ...
    public FormToModelPropertyMap getToModelPropertyMap() {
        if (toModelPropertyMap == null) {
            ...
            toModelPropertyMap.put("fdParentId", new FormConvertor_IDToModel("fdParent", EopBasedataSupType.class));
        }
