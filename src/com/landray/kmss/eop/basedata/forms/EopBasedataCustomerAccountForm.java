...
/**
  * 收款账户信息
  */
public class EopBasedataCustomerAccountForm extends ExtendForm {
    ...
    @Override
    public Class<EopBasedataCustomerAccount> getModelClass() {
        return EopBasedataCustomerAccount.class;
    }
