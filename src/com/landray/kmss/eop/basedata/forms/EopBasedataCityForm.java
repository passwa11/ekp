...
/**
  * 城市
  */
public class EopBasedataCityForm extends ExtendForm implements IAttachmentForm {
    ...
    @Override
    public Class<EopBasedataCity> getModelClass() {
        return EopBasedataCity.class;
    }
    ...
    public FormToModelPropertyMap getToModelPropertyMap() {
        if (toModelPropertyMap == null) {
            ...
            toModelPropertyMap.put("fdProvinceId", new FormConvertor_IDToModel("fdProvince", EopBasedataProvince.class));
     ...
     * 所属省份
     */
    public String getFdProvinceId() {
        return this.fdProvinceId;
    }

    /**
     * 所属省份
     */
    public void setFdProvinceId(String fdProvinceId) {
