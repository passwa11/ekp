...
/**
  * 供应商客户信息表
  */
public class EopBasedataCustomerForm extends ExtendAuthTmpForm implements IAttachmentForm {
    ...
    private AutoArrayList fdAccountList_Form = new AutoArrayList(EopBasedataCustomerAccountForm.class);
    ...
    private AutoArrayList fdContactPerson_Form = new AutoArrayList(EopBasedataCustomerContactForm.class);
    ...
    public void reset(ActionMapping mapping, HttpServletRequest request) {
        ...
        fdTaxNo = null;
        fdErpNo = null;
        fdAccountList_Form = new AutoArrayList(EopBasedataCustomerAccountForm.class);
        ...
        fdChargeName = null;
        fdTel = null;
        fdContactPerson_Form = new AutoArrayList(EopBasedataCustomerContactForm.class);
        fdContactPerson_Flag = null;
        super.reset(mapping, request);
    }

    @Override
    public Class<EopBasedataCustomer> getModelClass() {
        return EopBasedataCustomer.class;
    }
    ...
    public FormToModelPropertyMap getToModelPropertyMap() {
        if (toModelPropertyMap == null) {
            ...
            toModelPropertyMap.put("fdUserId", new FormConvertor_IDToModel("fdUser", SysOrgPerson.class));
            toModelPropertyMap.put("fdChargeId", new FormConvertor_IDToModel("fdCharge", SysOrgPerson.class));
    ...
    public String getFdChargeName() {
        return fdChargeName;
    }

    public void setFdChargeName(String fdChargeName) {
        this.fdChargeName = fdChargeName;
    }
