...
/**
  * 供应商客户信息表
  */
public class EopBasedataOtherForm extends ExtendAuthTmpForm implements IAttachmentForm {
    ...
    private AutoArrayList fdContactPerson_Form = new AutoArrayList(EopBasedataOtherContactForm.class);
    ...
    public void reset(ActionMapping mapping, HttpServletRequest request) {
        ...
        docCreatorId = null;
        docCreatorName = null;
        fdContactPerson_Form = new AutoArrayList(EopBasedataOtherContactForm.class);
    ...
    @Override
    public Class<EopBasedataOther> getModelClass() {
        return EopBasedataOther.class;
    }
