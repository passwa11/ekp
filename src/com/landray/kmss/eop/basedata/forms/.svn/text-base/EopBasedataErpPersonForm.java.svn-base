...
/**
  * ERP人员
  */
public class EopBasedataErpPersonForm extends ExtendForm {
    ...
    @Override
    public Class<EopBasedataErpPerson> getModelClass() {
        return EopBasedataErpPerson.class;
    }
    ...
    public FormToModelPropertyMap getToModelPropertyMap() {
        if (toModelPropertyMap == null) {
            ...
            toModelPropertyMap.put("fdOrgId", new FormConvertor_IDToModel("fdOrg", SysOrgPerson.class));
