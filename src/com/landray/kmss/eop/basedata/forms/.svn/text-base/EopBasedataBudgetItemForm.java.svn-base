...
/**
  * 预算科目(公司)
  */
public class EopBasedataBudgetItemForm extends ExtendForm {
    ...
    @Override
    public Class<EopBasedataBudgetItem> getModelClass() {
        return EopBasedataBudgetItem.class;
    }
    ...
    public FormToModelPropertyMap getToModelPropertyMap() {
        if (toModelPropertyMap == null) {
			...
			toModelPropertyMap.put("fdParentId", new FormConvertor_IDToModel("fdParent", EopBasedataBudgetItem.class));
