...
public class HrRatifyOtherAction extends HrRatifyMainAction {

	private IHrRatifyOtherService hrRatifyOtherService;

	@Override
	public IBaseService getServiceImp(HttpServletRequest request) {
		if (hrRatifyOtherService == null) {
			hrRatifyOtherService = (IHrRatifyOtherService) getBean(
					"hrRatifyOtherService");
		}
		return hrRatifyOtherService;
	}

	@Override
    public void changeFindPageHQLInfo(HttpServletRequest request,
                                      HQLInfo hqlInfo) throws Exception {
		HQLHelper.by(request).buildHQLInfo(hqlInfo, HrRatifyOther.class);
		hqlInfo.setOrderBy(getFindPageOrderBy(request, hqlInfo.getOrderBy()));
		com.landray.kmss.hr.ratify.util.HrRatifyUtil.buildHqlInfoDate(hqlInfo,
				request, com.landray.kmss.hr.ratify.model.HrRatifyOther.class);
		com.landray.kmss.hr.ratify.util.HrRatifyUtil.buildHqlInfoModel(hqlInfo,
				request);
	}
    ...
    public ActionForm createNewForm(ActionMapping mapping, ActionForm form,
		...
		((IHrRatifyOtherService) getServiceImp(request)).initFormSetting(
				(IExtendForm) form, new RequestContext(request));
		HrRatifyOtherForm hrRatifyOtherForm = (HrRatifyOtherForm) super.createNewForm(
				mapping, form, request, response);
		hrRatifyOtherForm.setDocTemplateName(
				getTemplatePath(hrRatifyOtherForm.getDocTemplateId()));
		return hrRatifyOtherForm;
	}
    ...
    public ActionForward print(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			// 引入打印机制
			HrRatifyOtherForm ratifyForm = (HrRatifyOtherForm) form;
			...
			HrRatifyOther main = (HrRatifyOther) getServiceImp(
					null)
	...
	public ActionForward add(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		String docTemplate = request.getParameter("i.docTemplate");
		HrRatifyTemplate template = (HrRatifyTemplate) getHrRatifyTemplateService()
