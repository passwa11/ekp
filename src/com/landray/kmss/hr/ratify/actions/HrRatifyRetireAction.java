...
public class HrRatifyRetireAction extends HrRatifyMainAction {

    private IHrRatifyRetireService hrRatifyRetireService;

    @Override
    public IBaseService getServiceImp(HttpServletRequest request) {
        if (hrRatifyRetireService == null) {
            hrRatifyRetireService = (IHrRatifyRetireService) getBean("hrRatifyRetireService");
        }
        return hrRatifyRetireService;
    }

    @Override
    public void changeFindPageHQLInfo(HttpServletRequest request, HQLInfo hqlInfo) throws Exception {
        HQLHelper.by(request).buildHQLInfo(hqlInfo, HrRatifyRetire.class);
        hqlInfo.setOrderBy(getFindPageOrderBy(request, hqlInfo.getOrderBy()));
        com.landray.kmss.hr.ratify.util.HrRatifyUtil.buildHqlInfoDate(hqlInfo, request, com.landray.kmss.hr.ratify.model.HrRatifyRetire.class);
    ...
    public ActionForm createNewForm(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		((IHrRatifyRetireService) getServiceImp(request)).initFormSetting(
				(IExtendForm) form, new RequestContext(request));
        HrRatifyRetireForm hrRatifyRetireForm = (HrRatifyRetireForm) super.createNewForm(mapping, form, request, response);
		hrRatifyRetireForm.setDocTemplateName(
				getTemplatePath(hrRatifyRetireForm.getDocTemplateId()));
        return hrRatifyRetireForm;
    }
    ...
    public ActionForward print(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			// 引入打印机制
			HrRatifyRetireForm ratifyForm = (HrRatifyRetireForm) form;
			...
			HrRatifyRetire main = (HrRatifyRetire) getServiceImp(
					null)
