 ...
 * @date 2022-09-03
 */
public class HrStaffContractContinueRobotServiceImp extends AbstractRobotNodeServiceImp {
...
//        BeanUtils.setProperty(personInfo, "fdHeadOfFirstLevelDepartment", sysOrgElement2);
        //办公所属区域
        //省
        BeanUtils.setProperty(personInfo, "fdOfficeAreaProvinceId", modelData.get(parameters.get("fdOfficeAreaProvinceId")));
        //市
