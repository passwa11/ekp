...
public class HrStaffSecurityServiceImp extends HrStaffImportServiceImp
		implements IHrStaffSecurityService {

	@Override
	public String[] getImportFields() {
		// TODO Auto-generated method stub
		return new String[] {
				"fdDeliveryDate","fdIdCard","fdAmountReceivableTotalReceivable","fdAmountReceivablePersonalTotal","fdAmountReceivableUnitTotal","fdSocialInsuranceCompany","fdEndowmentInsurancePaymentBase","fdEndowmentInsurancePersonalDelivery","fdEndowmentInsuranceUnitDelivery","fdReproductiveMedicinePaymentBase","fdReproductiveMedicinePersonalDelivery",
				"fdReproductiveMedicineUnitDelivery","fdIndustrialAndCommercialInsurancePaymentBase","fdIndustrialAndCommercialInsuranceUnitDelivery","fdUnemploymentInsurancePaymentBase","fdUnemploymentInsurancePersonalDelivery","fdUnemploymentInsuranceUnitDelivery",
				"fdBirthPaymentBase","fdBirthUnitDelivery","fdDisabilityInsurance","fdRemark","fdPlaceOfInsurancePayment",
				};
	}
	...
	public String add(IBaseModel modelObj) throws Exception {
		// 检查该员工是否已经有数据
		HrStaffSecurity model = (HrStaffSecurity) modelObj;
		HQLInfo hqlInfo = new HQLInfo();
		hqlInfo.setWhereBlock("fdId = :personInfoId");
		hqlInfo.setParameter("personInfoId", model.getFdId());
		List<HrStaffSecurity> list = findPage(hqlInfo).getList();
		if (!list.isEmpty()) {
