...
public class HrStaffContractTypeServiceImp extends BaseServiceImp
		implements IHrStaffContractTypeService, ICheckUniqueBean {
	...
	public List<String> getByName(String fdName, String fdId) throws Exception {
		...
		hqlInfo.setWhereBlock("hrStaffContractType.fdName = :fdName");
		if (StringUtil.isNotNull(fdId)) {
			hqlInfo.setWhereBlock(StringUtil.linkString(hqlInfo.getWhereBlock(),
					" and ", "hrStaffContractType.fdId !=:fdId"));
