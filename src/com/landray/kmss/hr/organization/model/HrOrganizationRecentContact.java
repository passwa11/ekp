...
import com.landray.kmss.hr.organization.forms.HrOrganizationRecentContactForm;
 ...
 */
public class HrOrganizationRecentContact extends BaseModel {
	 ...
	 * 联系人
	 */
	protected HrOrganizationElement fdContact;
	
	/**
	 * @return 联系人
	 */
	public HrOrganizationElement getFdContact() {
		return fdContact;
	}
	 ...
	 * @param fdContact 联系人
	 */
	public void setFdContact(HrOrganizationElement fdContact) {
		this.fdContact = fdContact;
	}
	
	@Override
    public Class getFormClass() {
		return HrOrganizationRecentContactForm.class;
	}
