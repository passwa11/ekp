...
public class SysFileStoreAddFileExtNamesService implements IXMLDataBean {
	...
	public List getDataList(RequestContext requestInfo) throws Exception {
		...
		String fileExtNames = requestInfo.getParameter("fileExtNames");
		...
		config.setFdValue(fileExtNames);
		getSysAppConfigService().update(config);
		result.add(fileExtNames);
		return result;
	}
