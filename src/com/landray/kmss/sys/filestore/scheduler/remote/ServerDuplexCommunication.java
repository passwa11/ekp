...
public class ServerDuplexCommunication implements IDuplexCommunication {

	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(ServerDuplexCommunication.class);

	public ServerDuplexCommunication(ISysFileConvertDataService dataService, int listenPort, int messageHandlerCode) {
	...
	private void initialNettyWorkers() {
		...
		nettyServer = new NettyRemotingServer("fileStore", serverConfig, new ServerChannelEventListener(dataService));
		...
		nettyClient = new NettyRemotingClient("fileStore");
	}
...
//			}
//		} else if (msgType.equals("amIRegistered")) {
