...
public class SysZoneTagByCategoryDatabean implements IXMLDataBean {
	...
	public List<Map<String, Object>> getList(RequestContext requestInfo)
		...
		if (!StringUtil.isNull(fdCategoryId)) {
			hqlInfo.setWhereBlock("sysTagTags.fdCategory.fdId = :fdCategoryId and sysTagTags.fdStatus = "
			...
			hqlInfo.setWhereBlock("sysTagTags.fdCategory.fdId is null and sysTagTags.fdStatus = "
					+ Constant.SYS_TAG_STATUS_INTEGER_TRUE
					+ " and sysTagTags.fdIsPrivate = "
					+ Constant.SYS_TAG_STRING_PERSON);
		}
