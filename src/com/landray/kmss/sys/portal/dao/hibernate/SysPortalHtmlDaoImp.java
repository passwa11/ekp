...
import com.landray.kmss.sys.portal.dao.ISysPortalHtmlDao;
 ...
 */
public class SysPortalHtmlDaoImp extends BaseDaoImp implements
		ISysPortalHtmlDao {
	@Override
    public String add(IBaseModel modelObj) throws Exception {
		SysPortalHtml xmodel = (SysPortalHtml) modelObj;
