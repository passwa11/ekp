 ...
 * 系统导航
 */
public class SysPortalNav extends BaseModel implements ISysAuthAreaModel, InterceptFieldEnabled {

	private static final long serialVersionUID = 1L;

	protected List<SysPortalMapTpl> fdPortalMapTpl;

	public List<SysPortalMapTpl> getFdPortalMapTpl() {
		return fdPortalMapTpl;
	}

	public void setFdPortalMapTpl(List<SysPortalMapTpl> fdPortalMapTpl) {
		this.fdPortalMapTpl = fdPortalMapTpl;
	}
    ...
    public ModelToFormPropertyMap getToFormPropertyMap() {
		if (toFormPropertyMap == null) {
			...
			toFormPropertyMap.put("fdEditors",
					new ModelConvertor_ModelListToString("fdEditorIds:fdEditorNames", "fdId:fdName"));
		}
