...
import com.landray.kmss.sys.webservice2.forms.SysWebserviceLogBackupForm;
 ...
 * @author Jeff
 */
public class SysWebserviceLogBackup extends BaseModel implements
    ...
    public Class getFormClass() {
		return SysWebserviceLogBackupForm.class;
	}
