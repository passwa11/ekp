...
public class SysOrgElementRangeForm extends ExtendForm {
	...
	public Class getModelClass() {
		return SysOrgElementRange.class;
	}
	...
	public boolean equals(Object o) {
		...
		SysOrgElementRangeForm form = (SysOrgElementRangeForm) o;
		boolean flag = true;
		...
		if(StringUtil.isNotNull(form.getFdViewSubType())){
			if(!form.getFdViewSubType().equals(this.getFdViewSubType())){
				flag = false;
			}
		}else{
			if(StringUtil.isNotNull(this.getFdViewSubType())){
				flag = false;
			}
		}
		if(StringUtil.isNotNull(form.getFdInviteUrl())){
			if(!form.getFdInviteUrl().equals(this.getFdInviteUrl())){
				flag = false;
			}
		}else{
			if(StringUtil.isNotNull(this.getFdInviteUrl())){
				flag = false;
			}
		}
