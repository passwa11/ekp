...
import com.landray.kmss.sys.restservice.server.model.SysRestserviceServerLogBackup;
 ...
 * @author  
 */
public class SysRestserviceServerLogBackupForm extends ExtendForm {
    ...
    public Class getModelClass() {
		return SysRestserviceServerLogBackup.class;
	}
