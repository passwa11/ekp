...
import com.landray.kmss.sys.restservice.server.forms.SysRestserviceServerLogForm;
...
public class SysRestserviceServerLog extends BaseModel implements
	...
	public void setFdErrorMsg(String fdErrorMsg) {
		this.fdErrorMsg = (String) writeLazyField("fdErrorMsg",
    ...
    public Class getFormClass() {
		return SysRestserviceServerLogForm.class;
	}
