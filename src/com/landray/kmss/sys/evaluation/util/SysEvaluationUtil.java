...
public class SysEvaluationUtil{
	...
	public static HSSFWorkbook exportWorkBook(String[] Headers, List list)
		...
		if (list != null) {
			for (Object data : list) {
				...
				buileOneNcCustomer(row, value, workbook);
			}
		}
		return workbook;
	}
	...
	private static void buileOneNcCustomer(HSSFRow row, List values, HSSFWorkbook workbook)
			throws Exception {
		// 155299，CSV漏洞
