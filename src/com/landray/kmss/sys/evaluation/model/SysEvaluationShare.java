...
/**
  * 分享
  */
public class SysEvaluationShare extends BaseModel {

    private static ModelToFormPropertyMap toFormPropertyMap;

    private Date fdShareTime;

    private String docSubject;

    private String fdShareReason;

    private Integer fdShareMode;
    ...
    @Override
    public Class<SysEvaluationShareForm> getFormClass() {
        return SysEvaluationShareForm.class;
    }
    ...
    public ModelToFormPropertyMap getToFormPropertyMap() {
        if (toFormPropertyMap == null) {
            ...
            toFormPropertyMap.put("fdShareTime", new ModelConvertor_Common("fdShareTime").setDateTimeType(DateUtil.TYPE_DATETIME));
     ...
     * 分享时间
     */
    public void setFdShareTime(Date fdShareTime) {
     ...
     * 分享模式
     */
    public void setFdShareMode(Integer fdShareMode) {
