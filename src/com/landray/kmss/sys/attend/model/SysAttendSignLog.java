...
import com.landray.kmss.sys.attend.forms.SysAttendSignLogForm;
...
/**
  * 签到记录
  */
public class SysAttendSignLog extends BaseModel  {
    ...
    @Override
    public Class<SysAttendSignLogForm> getFormClass() {
        return SysAttendSignLogForm.class;
    }
