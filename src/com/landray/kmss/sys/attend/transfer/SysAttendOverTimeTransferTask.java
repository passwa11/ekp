...
public class SysAttendOverTimeTransferTask
	...
	public SysAdminTransferResult
		...
		try {
			String sql = "update sys_attend_category_worktime  set fd_over_time_type=:overTimeType where fd_over_time_type is null";
			NativeQuery query = baseDao.getHibernateSession().createNativeQuery(sql);
			query.setParameter("overTimeType", 1);
			query.addSynchronizedQuerySpace("sys_attend_category_worktime");
			query.executeUpdate();
		} catch (Exception e) {
