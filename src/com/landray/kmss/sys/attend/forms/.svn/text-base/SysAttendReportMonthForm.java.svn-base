...
import com.landray.kmss.sys.attend.model.SysAttendReportMonth;
...
public class SysAttendReportMonthForm extends ExtendForm implements ISysAuthAreaForm {
	...
	public Class getModelClass() {
		return SysAttendReportMonth.class;
	}
