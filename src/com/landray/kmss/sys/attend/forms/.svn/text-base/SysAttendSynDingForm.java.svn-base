...
/**
  * 打卡原始记录
  */
public class SysAttendSynDingForm extends ExtendForm implements IAttachmentForm, ISysAuthAreaForm {
 ...
 // 所属场所ID
    ...
    @Override
    public Class<SysAttendSynDing> getModelClass() {
        return SysAttendSynDing.class;
    }
