 ...
 * @date 2022-01-18
 */
public class SysAttendBusinessStartListener extends SysAttendBusinessListener
        implements IEventListener {

    private static final Logger logger = org.slf4j.LoggerFactory.getLogger(SysAttendBusinessStartListener.class);
