...
public class AttendThreadPoolManager {

	private static AttendThreadPoolManager instance = null;
	...
	ThreadPoolExecutor getAttendThreadPoolExecutor() {
		return (ThreadPoolExecutor) executorService;
	}

	private AttendThreadPoolManager() {
	}
	 ...
	 * @return
	 */
	public static AttendThreadPoolManager getInstance() {
		if (instance == null) {
			createInstance();
		}
		return instance;
	...
	private synchronized static void createInstance() {
		if (instance == null) {
			instance = new AttendThreadPoolManager();
		}
	}
