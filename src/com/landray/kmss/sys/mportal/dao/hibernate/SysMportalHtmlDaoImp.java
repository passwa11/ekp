...
import com.landray.kmss.sys.mportal.dao.ISysMportalHtmlDao;
 ...
 * 
 */
public class SysMportalHtmlDaoImp extends BaseDaoImp implements
		ISysMportalHtmlDao {
	@Override
    public String add(IBaseModel modelObj) throws Exception {
		SysMportalHtml xmodel = (SysMportalHtml) modelObj;
