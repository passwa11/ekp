...
/**
  * 部门
  */
public class SysOmsDeptForm extends ExtendForm {
    ...
    @Override
    public Class<SysOmsDept> getModelClass() {
        return SysOmsDept.class;
    }
    ...
    public void setFdAuthAdmins(String fdAuthAdmins) {
        this.fdAuthAdmins = fdAuthAdmins;
    }
