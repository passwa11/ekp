 ...
 * @author 易荣烽
 */
public class SysTimeWorkDetailForm extends ExtendForm {
	 ...
	 * 班次设置
	 */
	private SysTimeCommonTimeForm sysTimeCommonTimeForm = null;
	private String fdCommonId = null;
	...
	public String getFdCommonId() {
		return fdCommonId;
	}

	public void setFdCommonId(String fdCommonId) {
		this.fdCommonId = fdCommonId;
	}
	...
	public Class getModelClass() {
		return SysTimeWorkDetail.class;
	}
