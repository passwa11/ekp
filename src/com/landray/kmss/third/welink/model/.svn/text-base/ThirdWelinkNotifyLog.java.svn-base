...
/**
  * 待办推送日志
  */
public class ThirdWelinkNotifyLog extends BaseModel implements InterceptFieldEnabled {
    ...
    private SysOrgElement fdUser;

    @Override
    public Class<ThirdWelinkNotifyLogForm> getFormClass() {
        return ThirdWelinkNotifyLogForm.class;
    }
