...
public class EkpClientTodoJob {
	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(EkpClientTodoJob.class);
	...
	public EkpClientTodoJob(int opt, Object todoContext, String serviceUrl,
	...
	public EkpClientTodoJob(int opt, Object todoContext, String notifyId)
			throws Exception {
