...
/**
  * 业务调用日志
  */
public class ThirdPaymentCallLog extends BaseModel implements InterceptFieldEnabled, IAttachment {
    ...
    @Override
    public Class<ThirdPaymentCallLogForm> getFormClass() {
        return ThirdPaymentCallLogForm.class;
    }
     ...
     * 请求结果
     */
    public Integer getFdCallResult() {
     ...
     * 请求结果
     */
    public void setFdCallResult(Integer fdCallResult) {
