...
public class WechatWebserviceServiceImp implements IWechatWebserviceService {

	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(WechatWebserviceServiceImp.class);
	...
	@Override
    public String addForum(WeChatParamterForm webParamForm) throws Exception {
	 ...
	 */
	@Override
    public String findSysNotifyTodo(WeChatNotifyParamterForm webForm)
			throws Exception {
		int pageno = 0;
	 ...
	 */
	@Override
    public String findSysNewsTodo(WeChatNotifyParamterForm webForm)
			throws Exception {
		String userId = webForm.getUserId();
	 ...
	 */
	@Override
    public String myReviewList(WeChatNotifyParamterForm webForm)
			throws Exception {
		String s_pageno = webForm.getPageno();
		String s_rowsize = webForm.getRowsize();
		String orderby = webForm.getOrderBy();
	 ...
	 */
	@Override
    public String findSysKnowledgeTodo(WeChatNotifyParamterForm webForm)
			throws Exception {
	 ...
	 */
	@Override
    public String search4Wechat(SearchParamForm searchParamForm)
			throws Exception {
	 ...
	 */
	@Override
    public String receiveMessage(WeChatNotifyForm weChatNotifyForm)
			throws Exception {
	 ...
	 */
	@Override
    public String addWechatConfig(String param) {
		String resultInfor = "";
	 ...
	 */
	@Override
    public String insertWeChatConfig(WeChatConfigParamterForm webForm)
			throws Exception {
		try {
			// 检查是否已经绑定过该系统
	 ...
	 */
	@Override
    public String insertWeChatConfigByWeiYun(WeChatConfigParamterForm webForm)
			throws Exception {
	...
	@Override
    public Object getAttachement(String fdId) throws Exception {
		// 进行Base64编码
