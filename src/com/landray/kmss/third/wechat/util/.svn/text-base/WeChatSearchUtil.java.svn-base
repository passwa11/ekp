...
public class WeChatSearchUtil {
	...
	public static void setParameters(Map<String, String> parameters,
			RequestContext request, String lang) throws Exception {
		
		parameters.put("queryString", replaceQueryString(request
				.getParameter("queryString")));// 关键字
		...
		String facetString = request.getParameter("facetString");
		...
		//??
		String isSearchByButton = request.getParameter("isSearchByButton");
