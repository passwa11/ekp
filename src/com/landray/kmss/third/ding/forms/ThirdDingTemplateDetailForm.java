...
/**
  * 表单字段
  */
public class ThirdDingTemplateDetailForm extends ExtendForm {
    ...
    @Override
    public Class<ThirdDingTemplateDetail> getModelClass() {
        return ThirdDingTemplateDetail.class;
    }
    ...
    public FormToModelPropertyMap getToModelPropertyMap() {
        if (toModelPropertyMap == null) {
            ...
            toModelPropertyMap.put("docMainId", new FormConvertor_IDToModel("docMain", ThirdDingDtemplate.class));
        }
