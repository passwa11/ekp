...
public class KmReviewParamterForm  implements java.io.Serializable {
    private com.landray.kmss.third.ding.webclient.AttachmentForm[] attachmentForms;
    ...
    public KmReviewParamterForm(
           com.landray.kmss.third.ding.webclient.AttachmentForm[] attachmentForms,
     ...
     */
    public com.landray.kmss.third.ding.webclient.AttachmentForm[] getAttachmentForms() {
        return attachmentForms;
    }
     ...
     */
    public void setAttachmentForms(com.landray.kmss.third.ding.webclient.AttachmentForm[] attachmentForms) {
        this.attachmentForms = attachmentForms;
    }

    public com.landray.kmss.third.ding.webclient.AttachmentForm getAttachmentForms(int i) {
        return this.attachmentForms[i];
    }

    public void setAttachmentForms(int i, com.landray.kmss.third.ding.webclient.AttachmentForm _value) {
