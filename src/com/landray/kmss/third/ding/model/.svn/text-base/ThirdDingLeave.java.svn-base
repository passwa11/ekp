...
import com.landray.kmss.third.ding.forms.ThirdDingLeaveForm;

/**
  * 请假明细
  */
public class ThirdDingLeave extends BaseModel {
    ...
    @Override
    public Class<ThirdDingLeaveForm> getFormClass() {
        return ThirdDingLeaveForm.class;
    }
