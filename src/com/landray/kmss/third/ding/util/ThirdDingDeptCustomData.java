...
public class ThirdDingDeptCustomData implements ICustomizeDataSource {

	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(ThirdDingDeptCustomData.class);
