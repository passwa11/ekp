...
public class DingTalkEncryptor {
    ...
    public Map<String,String> getEncryptedMap(String plaintext, Long timeStamp, String nonce) throws DingTalkEncryptException {
        ...
        // 加密
        String encrypt = encrypt(RandomUtils.getRandomStr(RANDOM_LENGTH), plaintext);
    ...
    public String getCallbackAppKey(String encryptMsg)throws DingTalkEncryptException {
        return  getAppKey(encryptMsg);
    }

    private String getAppKey(String text) throws DingTalkEncryptException {
        byte[] originalArr;
        try {
            // 设置解密模式为AES的CBC模式
        ...
        try {
            ...
            int plainTextLegth = RandomUtils.bytes2int(networkOrder);
    ...
    private String encrypt(String random, String plaintext) throws DingTalkEncryptException {
        try {
            ...
            byte[] lengthByte = RandomUtils.int2Bytes(plainTextBytes.length);
    ...
    private String decrypt(String text) throws DingTalkEncryptException {
        ...
        // corpid不相同的情况
        if (!fromCorpid.equals(corpId) && !fromCorpid.equals(DingConfig.newInstance().getAppKey())) {
