...
public class ThirdDingPersonCustomData implements ICustomizeDataSource {

	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(ThirdDingPersonCustomData.class);
