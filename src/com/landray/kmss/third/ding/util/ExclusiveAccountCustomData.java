...
public class ExclusiveAccountCustomData implements ICustomizeDataSource {

	private static final Logger logger = LoggerFactory.getLogger(ExclusiveAccountCustomData.class);
	...
	public Map<String, String> getOptions() {
		...
		returnMap.put("fdMobileNo", ResourceUtil.getStringValue("sysOrgPerson.fdMobileNo",
				"sys-organization",
				ResourceUtil.getLocaleByUser()));
		returnMap.put("fdEmail", ResourceUtil.getStringValue("sysOrgPerson.fdEmail",
				"sys-organization",
				ResourceUtil.getLocaleByUser()));
		returnMap.put("fdLoginName", ResourceUtil.getStringValue("sysOrgPerson.fdLoginName",
				"sys-organization",
				ResourceUtil.getLocaleByUser()));
		returnMap.put("fdNo", ResourceUtil.getStringValue("sysOrgPerson.fdNo",
				"sys-organization",
				ResourceUtil.getLocaleByUser()));
