...
public class BusinessDataAdapta extends SysFormRelationAdapta {
	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(BusinessDataAdapta.class);
	...
	protected File getTemplateFile(String key) {
		return new File(ConfigLocationsUtil
				.getWebContentPath()
				+ "/third/ding/template/cancel_business.xml");
	}
