...
public class OvertimeDataAdapta extends SysFormRelationAdapta {
	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(OvertimeDataAdapta.class);
	...
	protected File getTemplateFile(String key) {
		return new File(ConfigLocationsUtil
				.getWebContentPath()
				+ "/third/ding/template/cancel_overtime.xml");
	}
