...
public class CancelApprovalListener implements IEventListener {
	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(CancelApprovalListener.class);
	...
	public void handleEvent(EventExecutionContext execution, String parameter)
		...
		try {
			...
			// "fdCancelType");
			String fdCancelType = DING_LEAVE;
