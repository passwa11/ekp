...
/**
  * 会话内容
  */
public class ThirdWeixinChatDataMain extends BaseModel implements InterceptFieldEnabled, IAttachment {
    ...
    @Override
    public Class<ThirdWeixinChatDataMainForm> getFormClass() {
        return ThirdWeixinChatDataMainForm.class;
    }
    ...
    public List<ThirdWeixinChatDataFile> getInnerFiles() {
        return innerFiles;
    }

    public void setInnerFiles(List<ThirdWeixinChatDataFile> innerFiles) {
        this.innerFiles = innerFiles;
    }

    private List<ThirdWeixinChatDataFile> innerFiles = new ArrayList<>();
