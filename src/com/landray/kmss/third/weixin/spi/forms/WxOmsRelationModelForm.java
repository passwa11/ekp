package com.landray.kmss.third.weixin.spi.forms;
 ...
 */
public class WxOmsRelationModelForm extends ExtendForm {
	...
	@Override
    public Class<WxOmsRelationModel> getModelClass() {
		return WxOmsRelationModel.class;
	}
