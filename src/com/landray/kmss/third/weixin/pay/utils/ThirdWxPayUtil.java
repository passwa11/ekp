...
import com.landray.kmss.third.weixin.pay.sdk.*;
...
public class ThirdWxPayUtil {
     ...
     */
    public static String unifiedorder(String modelName, String modelId, String fdKey, String desc, Integer money, SysOrgPerson toUser) throws Exception {
        ...
        try {
            ...
            result = unifiedorder(modelName,modelId,fdKey,config,desc,money,openId);
     ...
     * @throws Exception
     */
    private static Map<String,String> unifiedorder(String modelName, String modelId, String fdKey, WeixinWorkConfig config,String desc, Integer money, String openId) throws Exception {
        ...
        try {
            ...
            WXPayConfig wxPayConfig = new WXPayConfigImp(config.getWxCorpid(), config.getWxPayMchID(), key, wxPayDomain, config.getWxPayCertFilePath());
            ...
            //下单成功则创建一个订单记录
            addThirdWeixinPayOrder(modelName,modelId,fdKey,config,reqData,resultMap);
            ...
            addThirdWeixinPayLog(thirdWeixinPayLog,config,reqData,resultMap,errorMsg);
        }
    }

    private static void addThirdWeixinPayLog(ThirdWeixinPayLog thirdWeixinPayLog,WeixinWorkConfig config,Map<String, String> reqData,Map<String, String> resultMap, String errorMsg) throws Exception {
        try {
            thirdWeixinPayLog.setFdAppId(config.getWxCorpid());
            thirdWeixinPayLog.setFdBody(reqData.get("body"));
            thirdWeixinPayLog.setFdMchId(config.getWxPayMchID());
     ...
     * @throws Exception
     */
    private static void addThirdWeixinPayOrder(String modelName, String modelId, String fdKey, WeixinWorkConfig config,Map<String, String> reqData, Map<String, String> result) throws Exception {
        ...
        order.setFdMchId(config.getWxPayMchID());
        ...
        order.setFdTradeType("JSAPI");
        order.setFdPrepayId(result.get("prepay_id"));
        getThirdWeixinPayOrderService().add(order);
    }
     ...
     * @throws Exception
     */
    public static void updateOrderPayData(String modelName,String modelId, String fdKey) throws Exception {
    ...
    public static Map<String,String> orderQuery(String modelName,String modelId, String fdKey) throws Exception {
        ...
        WXPayConfig config = new WXPayConfigImp(weixinWorkConfig.getWxCorpid(),weixinWorkConfig.getWxPayMchID(),key,wxPayDomain,null);
    ...
    private static void closeOrder(String modelName,String modelId,String fdKey) throws Exception {
        if(StringUtil.isNull(modelName)||StringUtil.isNull(modelId)){
            throw new Exception("modelName 和 modelId 不能为空");
        }
