package com.landray.kmss.third.weixin.pay.sdk;

import com.landray.kmss.third.weixin.model.ThirdWeixinPayLog;
import com.landray.kmss.third.weixin.pay.sdk.WXPayConstants.SignType;
...
public class WXPay {
    ...
    private ThirdWeixinPayLog thirdWeixinPayLog;
    ...
    public void setThirdWeixinPayLog(ThirdWeixinPayLog thirdWeixinPayLog){
        this.thirdWeixinPayLog = thirdWeixinPayLog;
    }
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
        ...
        setLogValue(start,reqBody,resp);
        return resp;
    }
    ...
    private void setLogValue(Date start, String reqData, String respData){
        if(thirdWeixinPayLog==null){
            return;
        }
        thirdWeixinPayLog.setFdReqDate(start);
        thirdWeixinPayLog.setFdReqData(reqData);
        thirdWeixinPayLog.setFdResData(respData);
        thirdWeixinPayLog.setFdResDate(new Date());
    }
