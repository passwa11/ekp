...
/**
  * 会话内容
  */
public class ThirdWeixinChatDataMainForm extends ExtendForm implements IAttachmentForm {
    ...
    @Override
    public Class<ThirdWeixinChatDataMain> getModelClass() {
        return ThirdWeixinChatDataMain.class;
    }
