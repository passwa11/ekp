...
/**
  * 待办推送失败队列
  */
public class ThirdWeixinNotifyQueErrForm extends ExtendForm implements IAttachmentForm {
    ...
    @Override
    public Class<ThirdWeixinNotifyQueErr> getModelClass() {
        return ThirdWeixinNotifyQueErr.class;
    }
