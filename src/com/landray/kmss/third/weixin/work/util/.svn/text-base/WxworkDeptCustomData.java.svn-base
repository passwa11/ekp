...
public class WxworkDeptCustomData implements ICustomizeDataSource {

	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(WxworkDeptCustomData.class);
