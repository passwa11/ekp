...
public class WxmutilOmsRelationServiceImp extends BaseServiceImp
		implements
        WxmutilConstant,
			IWxworkOmsRelationService {

	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(WxmutilOmsRelationServiceImp.class);
	...
	private WxUser getUser(SysOrgPerson element, Long pid, String fdWxKey)
		...
		String wxln = WeixinMutilConfig.newInstance(fdWxKey).getWxLoginName();
