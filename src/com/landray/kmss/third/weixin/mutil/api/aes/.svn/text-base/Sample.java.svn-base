package com.landray.kmss.third.weixin.mutil.api.aes;
...
public class Sample {
	...
	public static void main(String[] args) throws Exception {
		String sToken = "i7X5uXbfVAyyS99S";
		String sCorpID = "wwc21c247c9b2f867b";
		String sEncodingAESKey = "kHH4PHUiRnKbqgsbVAzTAWb2wdQJD9d6z6BMrfMCKbp";
	...
	/*
		...
		*/
		String sRespData = "<xml><ToUserName><![CDATA[mycreate]]></ToUserName><FromUserName><![CDATA[wx5823bf96d3bd56c7]]></FromUserName><CreateTime>1348831860</CreateTime><MsgType><![CDATA[text]]></MsgType><Content><![CDATA[thisis atest]]></Content><MsgId>1234567890123456</MsgId><AgentID>128</AgentID></xml>";
		try {
