...
public class ThirdWxworkOmsInitAction extends ExtendAction {
	protected IThirdWxworkOmsInitService thirdMutilWxworkOmsInitService;

	@Override
    protected IBaseService getServiceImp(HttpServletRequest request) {
		if (thirdMutilWxworkOmsInitService == null) {
			thirdMutilWxworkOmsInitService = (IThirdWxworkOmsInitService) getBean("thirdMutilWxworkOmsInitService");
		}
		return thirdMutilWxworkOmsInitService;
	}
    ...
    protected void changeFindPageHQLInfo(HttpServletRequest request,
		...
		String sql = "fdIsOrg=" + request.getParameter("fdIsOrg");
		if (StringUtil.isNotNull(fdWxKey)) {
			sql += " and fdWxKey='" + fdWxKey + "'";
		}
