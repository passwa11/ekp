package com.landray.kmss.third.feishu.datasource;
...
public class ThirdFeishuPersonCustomData implements ICustomizeDataSource {

	private static final Logger logger = LoggerFactory.getLogger(ThirdFeishuPersonCustomData.class);
