...
public class FsscFeeExpenseItemControl  implements ISysFormTemplateControl, FilterAction,ISysFormTemplateDetailsTableControl{
	...
	private void doParse(Node node, final StringBuilder jsp, String idPrefix)
		...
		if (node instanceof InputTag) {
			...
			jsp.append(ENTER).append(getElementTab()).append("<xformflag flagtype='expenseItem' flagid='"+id+"' _xform_type='expenseItem' property='extendDataFormInfo.value("+id+")' id='_xform_extendDataFormInfo.value("+id+")'>");
			...
			setAttribute(jsp, "dialogJs", "Designer_DialogSelect(false,'eop_basedata_expense_Item_selectExpenseItem','extendDataFormInfo.value("+id+")','extendDataFormInfo.value("+name+")',null,{fdTemplateId:$(\'[name=docTemplateId]\').val(),fdNotId:'fdNotId',fdCompanyId:'"+props.getString("companyId")+"'});");
			jsp.append(">");
			...
			jsp.append("<script>").append(ENTER).append("window.Designer_Control_Expense_Item_List=window.Designer_Control_Expense_Item_List||[];").append(ENTER);
			jsp.append("window.Designer_Control_Expense_Item_List.push('"+id+"')").append(ENTER);
			jsp.append("window.Designer_Control_Company_Event_List['"+props.getString("companyId")+"'].push(Designer_Control_Expense_Item_Load);").append(ENTER).append("</script>");
