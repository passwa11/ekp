...
public class FsscFeeMobileConfigAction extends ExtendAction {
    ...
    public void changeFindPageHQLInfo(HttpServletRequest request, HQLInfo hqlInfo) throws Exception {
        HQLHelper.by(request).buildHQLInfo(hqlInfo, FsscFeeMobileConfig.class);
        hqlInfo.setOrderBy(getFindPageOrderBy(request, hqlInfo.getOrderBy()));
        FsscFeeUtil.buildHqlInfoDate(hqlInfo, request, FsscFeeMobileConfig.class);
        FsscFeeUtil.buildHqlInfoModel(hqlInfo, request);
    }
