...
@Controller
@RequestMapping(value = "/api/fssc-config/sFiveWebserviceService", method = RequestMethod.POST)
...
public class SFiveWebserviceServiceImp implements ISFiveWebserviceService{
