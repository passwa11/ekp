...
public class FsscBudgetUtil{
	
	private static IEopBasedataExchangeRateService eopBasedataExchangeRateService;
	
	public static IEopBasedataExchangeRateService getEopBasedataExchangeRateService() {
	 ...
	 * @throws Exception
	 */
	public static Double getBudgetToBillRate(EopBasedataBudgetScheme scheme,String fdCurrencyId,String  fdCompanyId) throws Exception{
		Double budgetToBillRate=getEopBasedataExchangeRateService().getBudgetRate(fdCurrencyId, fdCompanyId);  //预算币种转换为单据公司预算币汇率
		return budgetToBillRate==null?0.0:budgetToBillRate;
	}
	 ...
	 * @throws Exception
	 */
	public static Double getBillToBudgetRate(EopBasedataBudgetScheme scheme,String fdCurrencyId,String  fdCompanyId) throws Exception{
		Double budgetToBillRate=budgetToBillRate=getEopBasedataExchangeRateService().getBudgetToRate(fdCurrencyId, fdCompanyId);  //预算币种转换为单据公司预算币汇率
		return budgetToBillRate==null?0.0:budgetToBillRate;
	}
}
