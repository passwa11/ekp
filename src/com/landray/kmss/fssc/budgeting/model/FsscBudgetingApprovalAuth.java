...
/**
  * 预算审批权限
  */
public class FsscBudgetingApprovalAuth extends BaseModel {
    ...
    @Override
    public Class<FsscBudgetingApprovalAuthForm> getFormClass() {
        return FsscBudgetingApprovalAuthForm.class;
    }
