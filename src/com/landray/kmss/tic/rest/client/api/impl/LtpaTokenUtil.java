...
public class LtpaTokenUtil{
	...
	public static void main(String[] args) throws Exception{
        String loginName="hejh";
        String cookieName="";
        String cookieSecret="";
        String url="";
		System.out.println(getCookies(loginName,cookieName,cookieSecret,url));
	}

	public static String getCookies(String loginName,String cookieName,String cookieSecret,String url)
			throws Exception {
		...
		String key = "123" + "-" + cookieName + "-" + cookieSecret + "-"
				+ loginName;
	...
	private static JSONArray genCookieArray(String key, String domain,
			String cookieName,
	...
	private static boolean checkExpire(JSONArray cookieArray, String cookieName) {
	...
	public static String generateTokenByUserName(String username, String securityKey) {
