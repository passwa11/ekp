...
function getFuncParamsToJson(){
	...
	function after_dialogSelect(rtn) {
		var funInParamText = "${lfn:message('tic-core-common:ticCoreTransSett.transFuncInParam')}";
		var funOutParamText = "${lfn:message('tic-core-common:ticCoreTransSett.transFuncOutParam')}";
		$("#table_paraOut").empty();
		$("#table_paraIn").empty();
		$("#table_paraOut")
				.append(
						"<tr><td class='td_normal_title' width='40%'>"+funInParamText+"</td><td class='td_normal_title' width='20%'>参数说明</td><td class='td_normal_title' width='20%'>表单映射字段</td><td class='td_normal_title' width='20%'><a href='javascript:void(0)' style='color:#47b5ea;' onclick='adapt();' title='自动匹配映射关系'>适配</a></td></tr>");
		$("#table_paraIn")
				.append(
						"<tr><td class='td_normal_title' width='40%'>"+funOutParamText+"</td><td class='td_normal_title' width='20%'>参数说明</td><td class='td_normal_title' width='20%'>映射名称</td><td class='td_normal_title' width='20%'><span style='color:#47b5ea' onclick='expand();'> 展开 </span></td></tr>");
