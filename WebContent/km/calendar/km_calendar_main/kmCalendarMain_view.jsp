           ...
           <div class="right">
          	  <ul class="shade_btn_box clrfix">
          			...
          			<li id="button_delete_event"><ui:button text="${lfn:message('button.delete')}"  styleClass="lui_toolbar_btn_gray"  onclick="delDoc('calendar_view','calendarViewForm');"/> </li>
           			<li id="button_view_detail"><ui:button text="${lfn:message('km-calendar:kmCalendarMain.moreSetting')}"   styleClass="lui_toolbar_btn_gray"  id="btn_Calendar_detail" onclick="eidtEventDetail();"/></li>
           		</ul>
           </div>
		 </div>
	</div>
