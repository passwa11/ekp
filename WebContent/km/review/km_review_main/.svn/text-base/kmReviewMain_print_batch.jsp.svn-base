...
function ShowPrintList() {
	...
	if (typeof(seajs) != 'undefined' && typeof( top['seajs'] ) != 'undefined' && Com_Parameter.dingXForm == "true") {
		Com_EventPreventDefault();
		top.Com_Parameter.Dialog = dialog;
		seajs.use('lui/dialog', function(dialog) {	
			var url = '/km/review/km_review_main/dingSuit/kmReviewMain_print_batch_config.jsp',
			fieldObjs = top.Com_Parameter.Dialog.fieldList;
			dialog.iframe(url,"打印设置",function(values){
