...
<div class="lui_review_card_list">
    <c:if test="${draftProcessList['draftInfo'] != null && draftProcessList['draftInfo'].size() > 0}">
        <c:forEach items="${draftProcessList['draftInfo']}" var="KmReviewInfo" varStatus="vstatus">
