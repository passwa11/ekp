...
<div class="lui_review_card_list">
    <c:if test="${reviewedProcessList['reviewedInfo'] != null && reviewedProcessList['reviewedInfo'].size() > 0}">
        <c:forEach items="${reviewedProcessList['reviewedInfo']}" var="KmReviewInfo" varStatus="vstatus">
