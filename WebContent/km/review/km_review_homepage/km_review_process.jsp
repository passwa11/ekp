...
<div class="lui_review_card_list">
    <c:if test="${reviewProcessList['processReviewInfo'] != null && reviewProcessList['processReviewInfo'].size() > 0}">
        <c:forEach items="${reviewProcessList['processReviewInfo']}" var="KmReviewInfo" varStatus="vstatus">
                            ...
                            <tr>
                                <td>
                                    <p>
                                        ...
                                        <span class="lui_review_card_list_content_detail"><c:out value="${KmReviewInfo.docCreateTime}"/></span>
                                    </p>
                                </td>
                                <td>
                                    <p>
                                ...
                                <c:forEach items="${KmReviewInfo.summaryInfo}" var="KmReviewSummary" varStatus="vstatus">
                                    <tr>
                                        <c:forEach items="${KmReviewSummary}" var="KmReviewInfo" varStatus="vstatus">
                                            <td>
                                                <p>
                                                    <i title="<c:out value='${KmReviewInfo.label}'/>" class="lui_review_card_list_content_item" style="max-width: 160px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;"><c:out value='${KmReviewInfo.label}'/></i>
