	...
	<template:replace name="content">
				...
				<div class="lui_list_operation_sort_toolbar">
					<ui:toolbar layout="sys.ui.toolbar.sort" style="float:left" >
						<list:sortgroup>
							...
							<list:sort property="docAlterTime" text="${lfn:message('km-review:kmReviewTemplate.docAlterTime') }" group="sort.list"></list:sort>
		...
		<list:listview>
			...
			<list:colTable isDefault="true" layout="sys.ui.listview.columntable"
				...
				<list:col-auto props="fdOrder,fdName,fdIsAvailable,docCreator.fdName,docCreateTime,docAlterTime,operations"></list:col-auto>
			</list:colTable>
