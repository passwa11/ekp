...
<template:include ref="default.simple">
    ...
    <template:replace name="head">
        <template:super/>
        <link type="text/css" rel="stylesheet" href="${LUI_ContextPath}/km/review/resource/style/doc/iconfont.css?s_cache=${LUI_Cache }"/>
        <style type="text/css">
            html,body {
                height: 100%;
            }
    ...
    <template:replace name="body">
        ...
        <div class="lui_iconList">
            ...
            <div class="lui_profile_iconSelect_list" id="sysMaterial">
