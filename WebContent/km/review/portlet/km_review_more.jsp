...
<script>
    ...
    if(mydoc!=null){
        if(mydoc =='reviewedProcessInfo'){
            window.location.href = "${LUI_ContextPath}/km/review/#j_path=/listApproved&mydoc=approved";
        }else if(mydoc =='reviewProcessInfo'){
            window.location.href = "${LUI_ContextPath}/km/review/#j_path=/listApproval&mydoc=approval";
        }else if(mydoc =='draftProcessInfo'){
            window.location.href = "${LUI_ContextPath}/km/review/#j_path=/listCreate&mydoc=create";
        }else{
            window.location.href = "${LUI_ContextPath}/km/review/#j_path=/listFollow&doctype=follow";
        }
