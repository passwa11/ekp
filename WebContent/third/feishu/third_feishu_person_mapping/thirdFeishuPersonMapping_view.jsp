    ...
    <template:include ref="default.view">
        ...
        <template:replace name="toolbar">
            ...
            <ui:toolbar id="toolbar" layout="sys.ui.toolbar.float" count="3">
                ...
                <!--edit-->
                <kmss:auth requestURL="/third/feishu/third_feishu_person_mapping/thirdFeishuPersonMapping.do?method=edit&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.edit')}" onclick="Com_OpenWindow('thirdFeishuPersonMapping.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
                </kmss:auth>
                <!--delete-->
                <kmss:auth requestURL="/third/feishu/third_feishu_person_mapping/thirdFeishuPersonMapping.do?method=delete&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.delete')}" onclick="deleteDoc('thirdFeishuPersonMapping.do?method=delete&fdId=${param.fdId}');" order="4" />
                </kmss:auth>
        ...
        <template:replace name="path">
            <ui:menu layout="sys.ui.menu.nav">
                ...
                <ui:menu-item text="${ lfn:message('third-feishu:table.thirdFeishuPersonMapping') }" href="/third/feishu/third_feishu_person_mapping/" target="_self" />
            </ui:menu>
        </template:replace>
            ...
            <ui:tabpage expand="false" var-navwidth="90%">
                <ui:content title="${ lfn:message('third-feishu:py.JiBenXinXi') }" expand="true">
                    ...
                    <table class="tb_normal" width="100%">
                        <tr>
                            ...
                            <td width="35%">
                                ...
                                <div id="_xform_fdEkpId" _xform_type="address">
                                    <xform:address propertyId="fdEkpId" propertyName="fdEkpName" orgType="ORG_TYPE_PERSON" showStatus="view" style="width:95%;" />
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('third-feishu:thirdFeishuPersonMapping.docAlterTime')}
                            </td>
                            <td width="35%">
                                <%-- 更新时间--%>
