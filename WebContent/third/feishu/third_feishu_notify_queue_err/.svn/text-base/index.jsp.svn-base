...
<template:include ref="default.list">
    <template:replace name="title">
        <c:out value="${ lfn:message('third-feishu:module.third.feishu') }-${ lfn:message('third-feishu:table.thirdFeishuNotifyQueueErr') }" />
    </template:replace>
    <template:replace name="path">
        <ui:menu layout="sys.ui.menu.nav">
            <ui:menu-item text="${ lfn:message('home.home') }" icon="lui_icon_s_home" href="/" target="_top" />
            <ui:menu-item text="${ lfn:message('third-feishu:table.thirdFeishuNotifyQueueErr') }" />
        </ui:menu>
    </template:replace>
    <template:replace name="nav">
        <ui:combin ref="menu.nav.create">
            <ui:varParam name="title" value="${ lfn:message('third-feishu:table.thirdFeishuNotifyQueueErr') }" />
            <ui:varParam name="button">
                [ {"text": "","href": "javascript:void(0);","icon": "/third/feishu/third_feishu_notify_queue_err/thirdFeishuNotifyQueueErr.do"} ]
            </ui:varParam>
        </ui:combin>
