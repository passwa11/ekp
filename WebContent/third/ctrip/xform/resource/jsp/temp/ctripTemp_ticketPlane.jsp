...
<script>
	var config = {};
	config.domNode = $("xformflag[flagtype='xform_ticket_plane'][id*='${param.controlId}']");
	config.ticketType = 'plane';
	<xform:editShow>
	...
	config.validateService.push(new CommonRequireService("fromCity_relationId"));
