...
seajs.use(['lui/framework/module', 'lui/jquery', 'lui/dialog', 'lui/topic', 'lang!third-wps', 'lui/util/env', 'lui/framework/router/router-utils'],
    function(Module, $, dialog, topic, lang, env, routerUtils) {

        var module = Module.find('thirdWps');
