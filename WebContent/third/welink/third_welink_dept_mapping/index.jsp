...
<template:include ref="default.list">
    <template:replace name="title">
        <c:out value="${ lfn:message('third-welink:module.third.welink') }-${ lfn:message('third-welink:table.thirdWelinkDeptMapping') }" />
    </template:replace>
    ...
    <template:replace name="nav">
        <ui:combin ref="menu.nav.create">
            <ui:varParam name="title" value="${ lfn:message('third-welink:table.thirdWelinkDeptMapping') }" />
            <ui:varParam name="button">
                [ {"text": "","href": "javascript:void(0);","icon": "/third/welink/third_welink_dept_mapping/thirdWelinkDeptMapping.do"} ]
            </ui:varParam>
        </ui:combin>
