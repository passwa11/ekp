    ...
    <template:replace name="content">
        <div style="margin:5px 10px;">
            ...
            <list:criteria id="criteria1">
                <list:cri-ref key="fdMerchName" ref="criterion.sys.docSubject" title="${lfn:message('third-payment:thirdPaymentMerchant.fdMerchName')}" />
                <list:cri-auto modelName="com.landray.kmss.third.payment.model.ThirdPaymentMerchant" property="fdMerchId" />
