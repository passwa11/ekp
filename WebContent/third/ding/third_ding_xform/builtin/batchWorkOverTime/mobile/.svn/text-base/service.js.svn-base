...
define(["dojo/_base/declare",
	   ...
	   // 业务逻辑
		var Service = declare("third.ding.third_ding_xform.builtin.batchWorkOverTime.mobile.service", null , {
	        // 下拉框的窗口关闭事件
...
/*            validate_fd_work_user_number : function(xformflagId,tr_table){
            ...
            save_hideInput_xxx : function (tr_table,result){
            	   if(result.isCanOvertime){
                       ...
                       window.Com_Parameter.event["submit"].push(function () {
                           let flag = true;
