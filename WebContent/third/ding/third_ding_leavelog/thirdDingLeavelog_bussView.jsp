...
<c:if test="${thirdDingLeavelogForm.fdTagName == '出差'}">
   <p class="txttitle">${ lfn:message('third-ding:thirdDingLeavelog.trip') }</p>
</c:if>
<c:if test="${thirdDingLeavelogForm.fdTagName == '外出'}">
				...
				<td colspan="3">
					<table class="tb_normal" width="100%"
						...
						<tr align="center" class="tr_normal_title">
						  ...
						  <c:if test="${thirdDingLeavelogForm.fdDurationUnit=='day' || thirdDingLeavelogForm.fdDurationUnit=='halfDay'}">
								...
								<td class="docList" align="center">
									...
									<div id="_xform_fdBussDetail_Form[${vstatus.index}].fdDate"
										...
										<xform:text
											...
											value="${fdBussDetail_FormItem.fdDate}"
								...
								<td class="docList" align="center">
									...
									<div
										...
										<xform:text
											...
											value="${fdBussDetail_FormItem.fdDuration}"
											showStatus="view" style="width:95%;" />
									</div>
								</td>
							</tr>
