...
<template:include ref="config.profile.edit" sidebar="no">
    ...
    <template:replace name="title">测试卡片功能</template:replace>
    <template:replace name="content">

        <h2 align="center" style="margin:10px 0">
            <span class="profile_config_title">测试卡片功能</span>
        </h2>
        <html:form action="/third/ding/third_ding_card_config/thirdDingCardConfig.do?method=testSendCard" method="post">
            <table id="dingBaseTable" class="tb_normal" width=100%>
                ...
                <tr>
                    <td class="td_normal_title" width="15%">接收人</td>
                    <td width="85%" colspan="3">
                        <xform:address propertyId="receivers" required="true"  propertyName="value(receiversName)"
                                       mulSelect="true" orgType="ORG_TYPE_PERSON" showStatus="edit" style="width:85%"
                                       subject="接收人" textarea="true"></xform:address>
                    </td>
                    <%--td class="td_normal_title" width="15%">审批人</td>
                    <td width="35%" >
                        <xform:address propertyId="approvers" propertyName="value(approversName)"
                                       mulSelect="true" orgType="ORG_TYPE_PERSON" showStatus="edit" style="width:85%"
                                       subject="审批人" textarea="true"></xform:address>
                    </td>--%>
                </tr>
                <tr>
