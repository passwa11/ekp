...
<%@page import="com.landray.kmss.third.ding.scenegroup.util.ThirdDingUtil" %>
    <template:include ref="default.list">
        <template:replace name="title">
            <c:out value="${ lfn:message('third-ding:module.third.ding') }-${ lfn:message('third-ding-scenegroup:table.thirdDingScenegroupMapp') }" />
        </template:replace>
        ...
        <template:replace name="nav">
            <ui:combin ref="menu.nav.create">
                <ui:varParam name="title" value="${ lfn:message('third-ding-scenegroup:table.thirdDingScenegroupMapp') }" />
                <ui:varParam name="button">
                    [ {"text": "","href": "javascript:void(0);","icon": "/third/ding/scenegroup/third_ding_scenegroup_mapp/thirdDingScenegroupMapp.do"} ]
                </ui:varParam>
            </ui:combin>
