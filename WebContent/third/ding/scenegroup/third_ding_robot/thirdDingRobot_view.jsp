    ...
    <template:include ref="default.view">
        ...
        <template:replace name="toolbar">
            ...
            <ui:toolbar id="toolbar" layout="sys.ui.toolbar.float" count="3">
                ...
                <!--edit-->
                <kmss:auth requestURL="/third/ding/scenegroup/third_ding_robot/thirdDingRobot.do?method=edit&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.edit')}" onclick="Com_OpenWindow('thirdDingRobot.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
                </kmss:auth>
                <!--delete-->
                <kmss:auth requestURL="/third/ding/scenegroup/third_ding_robot/thirdDingRobot.do?method=delete&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.delete')}" onclick="deleteDoc('thirdDingRobot.do?method=delete&fdId=${param.fdId}');" order="4" />
                </kmss:auth>
        ...
        <template:replace name="path">
            <ui:menu layout="sys.ui.menu.nav">
                ...
                <ui:menu-item text="${ lfn:message('third-ding-scenegroup:table.thirdDingRobot') }" href="/third/ding/scenegroup/third_ding_robot/" target="_self" />
            </ui:menu>
        </template:replace>
                        ...
                        <tr>
                            ...
                            <td width="35%">
                                ...
                                <div id="_xform_fdWebhook" _xform_type="text">
                                    <xform:text property="fdWebhook" showStatus="view" style="width:95%;" />
                                </div>
                            </td>
                            <td class="td_normal_title" width="15%">
                            ...
                            <td width="35%">
                                ...
                                <div id="_xform_fdSecurityKey" _xform_type="text">
                                    <xform:text property="fdSecurityKey" showStatus="view" style="width:95%;" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('third-ding-scenegroup:thirdDingRobot.docCreator')}
                            </td>
                            <td width="35%">
                                <%-- 创建人--%>
                                <div id="_xform_docCreatorId" _xform_type="address">
                                    <ui:person personId="${thirdDingRobotForm.docCreatorId}" personName="${thirdDingRobotForm.docCreatorName}" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('third-ding-scenegroup:thirdDingRobot.docCreateTime')}
                            </td>
                            <td width="35%">
                                <%-- 创建时间--%>
                            ...
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('third-ding-scenegroup:thirdDingRobot.docAlterTime')}
                            </td>
                            <td width="35%">
                                <%-- 更新时间--%>
