...
<script type="text/javascript">
    if("${thirdWeixinChatDataBakForm.fdMsgId}" != "") {
        window.document.title = "${thirdWeixinChatDataBakForm.fdMsgId} - ${ lfn:message('third-weixin:table.thirdWeixinChatDataBak') }";
    }
    Com_IncludeFile("swf_attachment.js", "${KMSS_Parameter_ContextPath}sys/attachment/js/", "js", true);
</script>
<div id="optBarDiv">

    <kmss:auth requestURL="/third/weixin/third_weixin_chat_data_bak/thirdWeixinChatDataBak.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('thirdWeixinChatDataBak.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/third/weixin/third_weixin_chat_data_bak/thirdWeixinChatDataBak.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('thirdWeixinChatDataBak.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
    <input type="button" value="${lfn:message('button.close')}" onclick="Com_CloseWindow();" />
</div>
<p class="txttitle">${ lfn:message('third-weixin:table.thirdWeixinChatDataBak') }</p>
<center>
        ...
        <table class="tb_normal" width="100%">
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdSeq')}
                </td>
                <td width="35%">
                    <%-- 序号--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdMsgId')}
                </td>
                <td width="35%">
                    <%-- 消息id--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdMsgType')}
                </td>
                <td width="35%">
                    <%-- 消息类型--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdMsgAction')}
                </td>
                <td width="35%">
                    <%-- 消息动作--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdFrom')}
                </td>
                <td width="35%">
                    <%-- 发送方id--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdRoomId')}
                </td>
                <td width="35%">
                    <%-- 群ID--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdMsgTime')}
                </td>
                <td width="35%">
                    <%-- 发送时间戳--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdFromEkpId')}
                </td>
                <td width="35%">
                    <%-- 发送方EKP ID--%>
                    <div id="_xform_fdFromEkpId" _xform_type="text">
                        <xform:text property="fdFromEkpId" showStatus="view" style="width:95%;" />
                    </div>
                </td>
            </tr>
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdToList')}
                </td>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdContent')}
                </td>
                <td colspan="3" width="85.0%">
                    <%-- 消息内容--%>
                    <div id="_xform_fdContent" _xform_type="rtf">
                        <xform:rtf property="fdContent" showStatus="view" width="95%" />
                    </div>
                </td>
            </tr>
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdExtendContent')}
                </td>
                <td colspan="3" width="85.0%">
                    <%-- 扩展信息--%>
                    <div id="_xform_fdExtendContent" _xform_type="rtf">
                        <xform:rtf property="fdExtendContent" showStatus="view" width="95%" />
                    </div>
                </td>
            </tr>
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdEncryType')}
                </td>
                <td width="35%">
                    <%-- 加密类型--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdFileId')}
                </td>
                <td width="35%">
                    <%-- 文件ID--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdFileMd5')}
                </td>
                <td width="35%">
                    <%-- 文件MD5--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdFileSize')}
                </td>
                <td width="35%">
                    <%-- 文件大小--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdPreMsgId')}
                </td>
                <td width="35%">
                    <%-- 撤回消息的ID--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdAgreeUserid')}
                </td>
                <td width="35%">
                    <%-- 同意会话用户ID--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdAgreeTime')}
                </td>
                <td width="35%">
                    <%-- 同意会话时间--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdPlayLength')}
                </td>
                <td width="35%">
                    <%-- 播放长度--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdCorpName')}
                </td>
                <td width="35%">
                    <%-- 企业名称--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdUserId')}
                </td>
                <td width="35%">
                    <%-- 用户ID--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdLongitude')}
                </td>
                <td width="35%">
                    <%-- 经度--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdLatitude')}
                </td>
                <td width="35%">
                    <%-- 纬度--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdAddress')}
                </td>
                <td width="35%">
                    <%-- 地址信息--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdTitle')}
                </td>
                <td width="35%">
                    <%-- 标题（名称）--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdZoom')}
                </td>
                <td width="35%">
                    <%-- 缩放比例--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdEmotionType')}
                </td>
                <td width="35%">
                    <%-- 表情类型--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdWidth')}
                </td>
                <td width="35%">
                    <%-- 宽度--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdHeight')}
                </td>
                <td width="35%">
                    <%-- 高度--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdTo')}
                </td>
                <td width="35%">
                    <%-- 接收方ID--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdFileExt')}
                </td>
                <td width="35%">
                    <%-- 文件类型后缀--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdLinkUrl')}
                </td>
                <td width="35%">
                    <%-- 链接--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdImageUrl')}
                </td>
                <td width="35%">
                    <%-- 链接图片--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdUsername')}
                </td>
                <td width="35%">
                    <%-- 用户名称--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdDisplayName')}
                </td>
                <td width="35%">
                    <%-- 小程序名称--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdVoteType')}
                </td>
                <td width="35%">
                    <%-- 投票类型--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdVoteId')}
                </td>
                <td width="35%">
                    <%-- 投票ID--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdMeetingId')}
                </td>
                <td width="35%">
                    <%-- 会议ID--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.docCreateTime')}
                </td>
                <td width="35%">
                    <%-- 创建时间--%>
            ...
            <tr>
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdCorpId')}
                </td>
                <td width="35%">
                    <%-- 组织ID--%>
                ...
                <td class="td_normal_title" width="15%">
                    ${lfn:message('third-weixin:thirdWeixinChatDataBak.fdToEkpId')}
                </td>
                <td width="35%">
                    <%-- 接收方EKP ID--%>
                    <div id="_xform_fdToEkpId" _xform_type="text">
                        <xform:text property="fdToEkpId" showStatus="view" style="width:95%;" />
                    </div>
                </td>
            </tr>
        </table>
    </div>
    <input type="hidden" name="fdId" value="${thirdWeixinChatDataBakForm.fdId}" />
</center>
<script>
    var formInitData = {
    ...
    var viewOption = {
        ...
        basePath: '/third/weixin/third_weixin_chat_data_bak/thirdWeixinChatDataBak.do',
        customOpts: {
