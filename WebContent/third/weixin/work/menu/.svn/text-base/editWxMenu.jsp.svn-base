...
<html:form action="/third/wxwork/menu/wxworkMenu.do" >
<div id="optBarDiv">
		...
		<input type=button value="自定义菜单"
			onclick="Com_OpenWindow('<c:url value="/third/wxwork/menu/wxworkMenuDefine.do" />?method=list');">
	<input type="button" value="<bean:message key="button.close"/>" onclick="Com_CloseWindow();">
</div>

<p class="txttitle"><bean:message bundle="third-weixin-work" key="third.wx.menu.title"/></p>
		...
		<td colspan="2">
			<table   class="tb_normal" width="100%">
				...
				<tr class="tr_normal_title">
					...
					<td><bean:message bundle="third-weixin-work" key="third.wx.menu.menu.1"/></td>
				...
				<tr class="tr_normal_title">
					<td><bean:message bundle="third-weixin-work" key="third.wx.menu.menu.2"/></td>
				...
				<tr class="tr_normal_title">
					<td><bean:message bundle="third-weixin-work" key="third.wx.menu.menu.3"/></td>
