...
<template:include ref="default.edit" width="95%" sidebar="no">
	...
	<template:replace name="content">
		...
		function selectModule(idn,nn){
			...
			Dialog_List(false, ide, nne, null, "wxworkPdaModelSelectDialog",afterModuleSelect,null,null,null,
		...
		function getByteLen(str) {
			var url = '<c:url value="/third/wxwork/menu/wxworkMenuDefine.do?method=checkLen" />';
			var len = 0;
			$.ajax({
			   type: "POST",
			   url: url,
			...
			<tr>
				...
				<td width="35%">
					<c:if test="${wxworkMenuForm.method_GET == 'add' }">
						<xform:text property="fdAgentId" showStatus="readOnly" subject="${lfn:message('third-weixin-work:third.wx.menu.agentId') }" required="true" style="width:85%" />
					</c:if>
					<c:if test="${wxworkMenuForm.method_GET != 'add' }">
				...
				<td width="35%">
					...
					<c:if test="${wxworkMenuForm.method_GET == 'add' }">
						...
						<select id="allAgents" name="allAgent" onchange="agentOnchange(this);" subject="${lfn:message('third-weixin-work:third.wx.menu.agentName') }"  validate="required" >
					...
					<!--xform:text property="fdAgentName" subject="${lfn:message('third-weixin-work:third.wx.menu.agentName') }"  required="true" style="width:85%" /-->
				</td> 
			</tr>
					...
					<td colspan="4">
						...
						<tr>
							...
							<tr>
								...
								<td width="35%">
									<input name="subm1Name" subject="${lfn:message('third-weixin-work:third.wx.menu.subm1.name') }" class="inputsgl" value="${subm1Name}" type="text"  style="width:85%" />
									<span id="_mHrefLink1">
								...
								%>
									<select name="subm1Type" onchange="doSwitchType('1')" subject="${lfn:message('third-weixin-work:third.wx.menu.subm1.type') }" >
										<option value="text" <%=("text".equals(subm1Type)?"selected":"")%>><bean:message bundle="third-weixin-work" key="third.wx.menu.subm.type.text"/></option>
										<option value="view" <%=("view".equals(subm1Type)?"selected":"")%>><bean:message bundle="third-weixin-work" key="third.wx.menu.subm.type.link"/></option>
									</select>
									<span class="txtstrong"><bean:message bundle="third-weixin-work" key="third.wx.menu.subm.type.note"/></span>
								</td> 
							</tr>
							<tr id="subm1linkTr" style="display:none">
								...
								<td width="85%" colspan="3">
									<input name="subm1Link" subject="${lfn:message('third-weixin-work:third.wx.menu.subm1.link') }" class="inputsgl" value="${subm1Link}" type="text"  style="width:85%" />
								</td> 
							</tr>
						</table>
						<table id="linksTable1" class="tb_normal" width="100%">
							...
							<tr style="display:none;" KMSS_IsReferRow="1">
								...
								<td>
									<input name="fdLinks1[!{index}].fdName" subject="${lfn:message('third-weixin-work:third.wx.menu.submenu.name') }" class="inputsgl" value="" type="text"  style="width:85%" />
									<a onclick="selectListModule(this.parentNode.parentNode,1);return false;" href=""><bean:message key="dialog.selectOther" /></a>
								</td>
								<td>
									<input name="fdLinks1[!{index}].fdUrl" subject="${lfn:message('third-weixin-work:third.wx.menu.submenu.url') }" flag='fdUrl' class="inputsgl" value="" type="text"  style="width:95%" />
								</td>
								<td>
							...
							<tr KMSS_IsContentRow="1">
								...
								<td>
									<input name="fdLinks1[${vstatus.index}].fdName" subject="${lfn:message('third-weixin-work:third.wx.menu.submenu.name') }" class="inputsgl" value="${link['name']}" type="text"  style="width:85%" />
									<a onclick="selectListModule(this.parentNode.parentNode,1);return false;" href=""><bean:message key="dialog.selectOther" /></a>
								</td>
								<td>
									<input name="fdLinks1[${vstatus.index}].fdUrl" subject="${lfn:message('third-weixin-work:third.wx.menu.submenu.url') }" flag='fdUrl' class="inputsgl" value="${link['url']}" type="text"  style="width:95%" />
								</td>
					...
					<td colspan="4">
						<table class="tb_normal" width="100%">
							<tr>
								...
								<td width="35%">
									<input name="subm2Name" subject="${lfn:message('third-weixin-work:third.wx.menu.subm2.name') }" class="inputsgl" value="${subm2Name}" type="text"  style="width:85%" />
									<span id="_mHrefLink2">
								...
								%>
									<select name="subm2Type" onchange="doSwitchType('2')" subject="${lfn:message('third-weixin-work:third.wx.menu.subm2.type') }" >
										<option value="text" <%=("text".equals(subm2Type)?"selected":"")%>><bean:message bundle="third-weixin-work" key="third.wx.menu.subm.type.text"/></option>
										<option value="view" <%=("view".equals(subm2Type)?"selected":"")%>><bean:message bundle="third-weixin-work" key="third.wx.menu.subm.type.link"/></option>
									</select>
									<span class="txtstrong"><bean:message bundle="third-weixin-work" key="third.wx.menu.subm.type.note"/></span>
								</td> 
							</tr>
						...
						<table id="linksTable2" class="tb_normal" width="100%">
							...
							<tr style="display:none;" KMSS_IsReferRow="1">
								...
								<td>
									<input name="fdLinks2[!{index}].fdName" subject="${lfn:message('third-weixin-work:third.wx.menu.submenu.name') }" class="inputsgl" value="" type="text"  style="width:85%" />
									<a onclick="selectListModule(this.parentNode.parentNode,2);return false;" href=""><bean:message key="dialog.selectOther" /></a>

								</td>
								<td>
									<input name="fdLinks2[!{index}].fdUrl" subject="${lfn:message('third-weixin-work:third.wx.menu.submenu.url') }" flag='fdUrl' class="inputsgl" value="" type="text"  style="width:95%" />
								</td>
								<td>
									<div style="text-align:center">
									<img src="../../../resource/style/default/icons/delete.gif" alt="del" onclick="DocList_DeleteRow(this.parentNode.parentNode.parentNode);" style="cursor:pointer">&nbsp;&nbsp;
							...
							<tr KMSS_IsContentRow="1">
								...
								<td>
									<input name="fdLinks2[${vstatus.index}].fdName" subject="${lfn:message('third-weixin-work:third.wx.menu.submenu.name') }" class="inputsgl" value="${link['name']}" type="text"  style="width:85%" />
									<a onclick="selectListModule(this.parentNode.parentNode,2);return false;" href=""><bean:message key="dialog.selectOther" /></a>

								</td>
								<td>
									<input name="fdLinks2[${vstatus.index}].fdUrl" subject="${lfn:message('third-weixin-work:third.wx.menu.submenu.url') }" flag='fdUrl' class="inputsgl" value="${link['url']}" type="text"  style="width:95%" />
								</td>
					...
					<td colspan="4">
						<table class="tb_normal" width="100%">
							<tr>
								...
								<td width="35%">
									<input name="subm3Name" subject="${lfn:message('third-weixin-work:third.wx.menu.subm3.name') }" class="inputsgl" value="${subm3Name}" type="text"  style="width:85%" />
									<span id="_mHrefLink3">
								...
								%>
									<select name="subm3Type" onchange="doSwitchType('3')" subject="${lfn:message('third-weixin-work:third.wx.menu.subm3.type') }" >
										<option value="text" <%=("text".equals(subm3Type)?"selected":"")%>><bean:message bundle="third-weixin-work" key="third.wx.menu.subm.type.text"/></option>
										<option value="view" <%=("view".equals(subm3Type)?"selected":"")%>><bean:message bundle="third-weixin-work" key="third.wx.menu.subm.type.link"/></option>
									</select>
									<span class="txtstrong"><bean:message bundle="third-weixin-work" key="third.wx.menu.subm.type.note"/></span>
								</td> 
							</tr>
							<tr id="subm3linkTr" style="display:none">
								...
								<td width="85%" colspan="3">
									<input name="subm3Link" subject="${lfn:message('third-weixin-work:third.wx.menu.subm3.link') }" class="inputsgl" value="${subm3Link}" type="text"  style="width:85%" />
								</td> 
							</tr>
						</table>
						<table id="linksTable3" class="tb_normal" width="100%">
							...
							<tr style="display:none;" KMSS_IsReferRow="1">
								...
								<td>
									<input name="fdLinks3[!{index}].fdName" subject="${lfn:message('third-weixin-work:third.wx.menu.submenu.name') }" class="inputsgl" value="" type="text"  style="width:85%" />
									<a onclick="selectListModule(this.parentNode.parentNode,3);return false;" href=""><bean:message key="dialog.selectOther" /></a>
								</td>
								<td>
									<input name="fdLinks3[!{index}].fdUrl" subject="${lfn:message('third-weixin-work:third.wx.menu.submenu.url') }" flag='fdUrl' class="inputsgl" value="" type="text"  style="width:95%" />
								</td>
								<td>
									<div style="text-align:center">
									<img src="../../../resource/style/default/icons/delete.gif" alt="del" onclick="DocList_DeleteRow(this.parentNode.parentNode.parentNode);" style="cursor:pointer">&nbsp;&nbsp;
							...
							<tr KMSS_IsContentRow="1">
								...
								<td>
									<input name="fdLinks3[${vstatus.index}].fdName" subject="${lfn:message('third-weixin-work:third.wx.menu.submenu.name') }" class="inputsgl" value="${link['name']}" type="text"  style="width:85%" />
									<a onclick="selectListModule(this.parentNode.parentNode,3);return false;" href=""><bean:message key="dialog.selectOther" /></a>

								</td>
								<td>
									<input name="fdLinks3[${vstatus.index}].fdUrl" subject="${lfn:message('third-weixin-work:third.wx.menu.submenu.url') }" flag='fdUrl' class="inputsgl" value="${link['url']}" type="text"  style="width:95%" />
								</td>
