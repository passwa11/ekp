...
<list:data>
    <list:data-columns var="thirdWxWorkConfig" list="${queryPage.list}" varIndex="status">
        ...
        <list:data-column col="fdName" title="${lfn:message('third-weixin-work:thirdWxWorkConfig.fdName')}" >
        	<c:out value="${thirdWxWorkConfig[1]}" />
        </list:data-column>
        <list:data-column col="fdKey" title="${lfn:message('third-weixin-work:thirdWxWorkConfig.fdKey')}">
