...
<html:form action="/third/weixin/work/spi/wxwork_oms_relation/wxworkOmsRelation.do" enctype="multipart/form-data">
 
<p class="txttitle"><bean:message bundle="third-weixin-work" key="wxOmsRelation.file.batch.upload"/></p>

<center>
<table class="tb_normal" width=95%> 
	<tr>
		<td class="td_normal_title" width=15%>
			<bean:message bundle="third-weixin-work" key="wxOmsRelation.file.upload"/>
...
function loadExcel(){
	...
	form.action="${KMSS_Parameter_ContextPath}third/weixin/work/spi/wxwork_oms_relation/wxworkOmsRelation.do?method=loadExcel";
...
function uploadSucess(){
	alert("${lfn:message('third-weixin-work:wxOmsRelation.file.upload.sucess')}");
}
//提交出错
function loadError(){
	alert("${lfn:message('third-weixin-work:wxOmsRelation.tip.upload.error')}");
}
