...
<script>
	...
	return del;
			...
			<kmss:auth requestURL="/third/weixin/work/spi/wxwork_oms_relation/wxworkOmsRelation.do?method=edit&fdId=${param.fdId}" requestMethod="GET">
			...
			<kmss:auth requestURL="/third/weixin/work/spi/wxwork_oms_relation/wxworkOmsRelation.do?method=delete&fdId=${param.fdId}" requestMethod="GET">
