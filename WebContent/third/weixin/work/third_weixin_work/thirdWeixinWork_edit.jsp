...
<html:form action="/third/weixin/work/third_weixin_work/thirdWeixinWork.do">
 
<p class="txttitle"><bean:message bundle="third-weixin-work" key="table.thirdWeixinWork"/></p>
<%
	String wxdomain= WeixinWorkConfig.newInstance().getWxDomain();
...
<center>
	...
	<%-- <tr>
		<td class="td_normal_title" width=15% colspan="4" align="center">
			...
			<div style="font-size: 10xp"><font color="red"><bean:message bundle="third-weixin-work" key="third.weixin.work.note"/></font></div>
		</td>
	</tr>
	<tr>
		<td class="td_normal_title" width=15%>
			...
			<input type="hidden" name="wxUrlSuffix" value="/resource/third/wxwork/cpEndpoint.do?method=service&agentId=">
	...
	<tr>
		<td class="td_normal_title" width=15%>
			...
			<ui:button text="${lfn:message('third-weixin-work:third.weixin.work.config.wxTokenBtn') }" onclick="window.random_token();" style="vertical-align: top;"></ui:button>
	...
	<tr>
		<td class="td_normal_title" width=15%>
			...
			<xform:text property="fdAeskey" subject='AESKey' required="false" style="width:85%" showStatus="edit"/>
			<ui:button text="${lfn:message('third-weixin-work:third.weixin.work.config.wxTokenBtn') }" onclick="window.random_AESKey();" style="vertical-align: top;"></ui:button>
...
<script>
	...
	function config_wx_callbackurl(){
		...
		if(fdAgentid!=""){
			...
			$('[name="fdCallbackUrl"]').val(wxDomain + wxUrlSuffix + fdAgentid);
		}
	}
