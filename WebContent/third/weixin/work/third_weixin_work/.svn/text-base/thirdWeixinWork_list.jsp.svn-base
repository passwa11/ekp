			...
			<ui:toolbar id="toolbar" layout="sys.ui.toolbar.float" var-navwidth="95%" count="5">
				<kmss:authShow roles="ROLE_THIRDWXWORK_ADMIN">
					...
					<ui:button text="${ lfn:message('third-weixin:url.code') }"
						onclick="Com_OpenWindow('${LUI_ContextPath}/third/weixin/work/urlCode.jsp','_self');">
					</ui:button>
				</kmss:authShow>
				
				<kmss:auth requestURL="/third/weixin/work/third_weixin_work/thirdWeixinWork.do?method=add">
					<ui:button text="${ lfn:message('button.add') }" 
						onclick="Com_OpenWindow('${LUI_ContextPath}/third/weixin/work/third_weixin_work/thirdWeixinWork.do?method=add');">
					</ui:button>
				</kmss:auth>
				<kmss:auth requestURL="/third/weixin/work/third_weixin_work/thirdWeixinWork.do?method=deleteall">
	...
	<table id="List_ViewTable">
		<tr>
			<sunbor:columnHead htmlTag="td">
				...
				<sunbor:column property="thirdWeixinWork.fdAgentid">
		...
		<c:forEach items="${queryPage.list}" var="thirdWeixinWork" varStatus="vstatus">
			<tr
				kmss_href="<c:url value="/third/weixin/work/third_weixin_work/thirdWeixinWork.do" />?method=view&fdId=${thirdWeixinWork.fdId}">
				<td>
