...
<template:replace name="head">
	...
	<link rel="stylesheet" href="${LUI_ContextPath}/third/wxwork/qa/qa.css"></link>
</template:replace>
<template:replace name="body">
	<div class="qaContainer">
		<h2 class="qaHeader">企业微信集成常见问题</h2>
		<div class="qaContent">
			<dl>
				<dt>1、部署企业微信集成模块后，启动EKP报“java.lang.NoSuchMethodError: org.apache.commons.codec.digest.DigestUtils.sha1Hex”错误</dt>
				<dd>
			...
			<dl>
				<dt>2、部署企业微信集成模块后，EKP报“Could not initialize class me.chanjar.weixin.cp.util.xml.XStreamTransformer”错误</dt>
				<dd>
					<p class="qaAnswerPart">
						解决方法如下:<br/> 
						1、在项目下找到/WebContent/WEB-INF/lib目录<br/>
			...
			<dl>
				<dt>3、企业微信配置回调模式时，出现“echostr校验错误”的提示</dt>
				<dd>
					<p class="qaAnswerPart">
			...
			<dl>
				<dt>4、企业微信在进行消息推送等功能时出现“60011  管理组权限不足，（user/department/agent）无权限”的提示</dt>
				<dd>
					<p class="qaAnswerPart">
						此问题是因为企业号应用没有赋予管理权限,解决方法是到企业微信后台通过设置->权利管理赋予相关权限。
					</p>
				</dd>
			</dl>
			...
			<dl>
				...
				<dd>
					<p class="qaAnswerPart">
						在与企业微信对接过程中不免会出现一些错误，所幸大部分操作均会得到一个全局返回码(来自钉钉),这里提供一份<a href="http://qydev.weixin.qq.com/wiki/index.php?title=%E5%85%A8%E5%B1%80%E8%BF%94%E5%9B%9E%E7%A0%81%E8%AF%B4%E6%98%8E" target="_blank">微信全局返回码</a>以便项目排查原因。
					</p>
				</dd>
			</dl>
		</div>
