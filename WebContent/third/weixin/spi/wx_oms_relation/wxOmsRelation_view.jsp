...
<script>
	...
	return del;
			...
			<kmss:auth requestURL="/third/weixin/spi/wx_oms_relation/wxOmsRelation.do?method=edit&fdId=${param.fdId}" requestMethod="GET">
				<ui:button text="${ lfn:message('button.edit') }" onclick="Com_OpenWindow('wxOmsRelation.do?method=edit&fdId=${param.fdId}&type=${param.type }','_self');">
				</ui:button>
			</kmss:auth>
			<kmss:auth requestURL="/third/weixin/spi/wx_oms_relation/wxOmsRelation.do?method=delete&fdId=${param.fdId}" requestMethod="GET">
				<ui:button text="${ lfn:message('button.delete') }" onclick="if(!confirmDelete())return;Com_OpenWindow('wxOmsRelation.do?method=delete&fdId=${param.fdId}','_self');">
				</ui:button>
			</kmss:auth>
