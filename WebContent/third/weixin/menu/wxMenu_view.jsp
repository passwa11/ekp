...
<div id="optBarDiv">
	...
	<input type="button"
		...
		onclick="Com_OpenWindow('wxMenuDefine.do?method=edit&fdId=${param.fdId}','_self');">

		<input type=button value="<bean:message bundle="third-weixin" key="third.wx.menu.btn.publish"/>"
			onclick="Com_OpenWindow('wxMenuDefine.do?method=publish&fdId=${param.fdId}','_self');">

	<input type="button"
		value="<bean:message key="button.delete"/>"
		onclick="if(!confirmDelete())return;Com_OpenWindow('wxMenuDefine.do?method=delete&fdId=${param.fdId}','_self');">
	</kmss:authShow>
	...
	<template:replace name="content">
		...
		<table class="tb_normal" width=95%>
			<tr>
				...
				<td width="35%">
					<c:out value="${wxMenuForm.fdAgentId}" />
				</td> 
				<td class="td_normal_title" width=15%>
					<bean:message bundle="third-weixin" key="third.wx.menu.agentName"/>
				</td>
				<td width="35%">
					<c:out value="${wxMenuForm.fdAgentName}" />
				</td> 
			</tr>
					...
					<td colspan="4">
						<table class="tb_normal" width="100%">
							<tr>
								...
								%>
								<bean:message bundle="third-weixin" key="third.wx.menu.subm.type.link"/>
								<%}else{%>
								<bean:message bundle="third-weixin" key="third.wx.menu.subm.type.text"/>
								<%}%>
								</td> 
							</tr>
