		...
		<form data-dojo-type="mui/view/DocScrollableView" data-dojo-mixins="mui/form/_ValidateMixin" Id="baseInfoForm">
			...
			<div class="file-view-content">
			    ...
			    <div class="ppc_c_list inputstring">
	       			<div class="ppc_c_list_head"><bean:message bundle="hr-staff" key="hrStaffPersonExperience.training.fdTrainingName"/></div>
	       			<div class="ppc_c_list_body">
						<xform:text property="fdTrainingName" required="true"  showStatus="${canEdit?'edit':'view'}"></xform:text>		       			
	       			</div>
	       		</div>
			    <div class="ppc_c_list inputstring">
	       			<div class="ppc_c_list_head"><bean:message bundle="hr-staff" key="hrStaffPersonExperience.training.fdTrainingUnit"/></div>
	       			<div class="ppc_c_list_body">
	       			<xform:text property="fdTrainingUnit"  showStatus="${canEdit?'edit':'view'}"></xform:text>
	       			</div>
	       		</div>
       	...
       	<c:import url="/hr/staff/mobile/personInfo/table/save.jsp">
       		...
       		<c:param name="url" value="/hr/staff/hr_staff_person_experience/training/hrStaffPersonExperienceTraining.do?method=${hrStaffPersonExperienceTrainingForm.method_GET eq 'add'?'save':'update'}&fdId=${param.fdId }"/>
       	</c:import>
