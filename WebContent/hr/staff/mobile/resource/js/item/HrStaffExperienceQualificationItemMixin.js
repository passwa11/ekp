define([
	...
	var item = declare("hr.staff.mobile.resource.js.item.HrStaffExperienceQualificationItemMixin", [ItemBase], {
		fdId: '',
		fdCertificateName: '',
		fdAwardUnit: '',
		fdBeginDate: '',
		...
		buildRendering:function(){
			...
			var span = domConstruct.create("span",{innerHTML:this.fdCertificateName},item);
			...
			domConstruct.create("div",{className:'ppc_c_list_head',innerHTML:Msg['hrStaffPersonExperience.qualification.fdCertificateName']},clist0);
			domConstruct.create("div",{className:'ppc_c_list_body',innerHTML:this.fdCertificateName},clist0);
			var clist1 = domConstruct.create("div",{className:'ppc_c_list'},content);
			domConstruct.create("div",{className:'ppc_c_list_head',innerHTML:Msg['hrStaffPersonExperience.qualification.fdAwardUnit']},clist1);
			domConstruct.create("div",{className:'ppc_c_list_body',innerHTML:this.fdAwardUnit},clist1);
			var clist2 = domConstruct.create("div",{className:'ppc_c_list'},content);
			domConstruct.create("div",{className:'ppc_c_list_head',innerHTML:Msg['hrStaffPersonExperience.qualification.fdBeginDate']},clist2);
			...
			domConstruct.create("div",{className:'ppc_c_list_head',innerHTML:Msg['hrStaffPersonExperience.qualification.fdEndDate']},clist3);
		...
		editTrackInfo:function(){
			var url = dojo.config.baseUrl+"hr/staff/hr_staff_person_experience/qualification/hrStaffPersonExperienceQualification.do?method=edit&&personInfoId="+this.personInfoId+"&fdId="+this.fdId;
