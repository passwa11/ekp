...
<template:include ref="default.view" sidebar="no">
	...
	<template:replace name="toolbar">
		...
		<ui:toolbar id="toolbar" layout="sys.ui.toolbar.float">
			<%--删除--%>
			<ui:button text="${lfn:message('button.delete') }" onclick="deleteDoc('hrStaffEkp_H14_S2.do?method=delete&fdId=${param.fdId}');" order="4">
			</ui:button>
			<%--关闭--%>
	...
	<template:replace name="content">
		<html:form action="/hr/staff/hr_staff_ekp_H14_S2/hrStaffEkp_H14_S2.do">		
			<html:hidden property="fdId" />
			<div class="lui_form_content_frame">
				<p class="lui_form_subject">
					<bean:message bundle="hr-staff" key="table.hrStaffEkp_H14_S2" />
				</p>
				...
				<tr>
					...
					<td width="35%">
						<bean:write name="hrStaffEkp_H14_S2Form" property="fdFirstLevelDepartment"  />
					</td>
				</tr>
				<tr>
