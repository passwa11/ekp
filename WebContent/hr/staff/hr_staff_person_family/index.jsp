...
<%-- 								{text:'${ lfn:message('hr-staff:hrStaffPersonInfo.fdStatus.dismissal') }',value:'dismissal'}, --%>
		...
		<list:listview id="listview">
			...
			<list:colTable isDefault="false" layout="sys.ui.listview.columntable" 
				...
				<list:col-auto props="fdStaffFdName,fdName,fdDeptName;fdOrgPostNames;fdOrgRank;fdAffiliatedCompany;fdFirstLevelDepartment;fdSecondLevelDepartment;fdThirdLevelDepartment;fdRelated,fdCompany,fdOccupation,operations"></list:col-auto>
			</list:colTable>
		</list:listview> 
