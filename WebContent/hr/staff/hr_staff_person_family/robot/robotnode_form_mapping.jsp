	...
	<template:replace name="body"> 
		...
		<script type="text/javascript">
			...
			function serializeObject(form) {
			    ...
			    var _s = new Array("fdApplicant","fdRelated","fdRelated1");
			...
			LUI.ready(function(){
				...
				createSelectElementHTML("fdRelated");
				createSelectElementHTML("fdRelated1");
		...
		<center>
			...
			<table width="100%" class="tb_normal">
				...
				<!-- 家庭人员 -->
					<td>
						${lfn:message('hr-staff:hrStaff.robot.familyPerson') }
					</td>
					<td id="fdApplicant">
					</td>
					<!-- 家庭关系 -->
					<td>
						${lfn:message('hr-staff:hrStaffSecurity.fdAccount') }
					</td>
					<td id="fdRelated">
					</td>
				</tr>
