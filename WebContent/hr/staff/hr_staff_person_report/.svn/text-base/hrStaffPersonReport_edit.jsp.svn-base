				...
				<div id="div_condtionArea">
					...
					<div id="div_condtionSection">
						...
						<table class="tb_simple" width="100%">
							...
							<%--组织部门 --%>
							<c:if test="${'reportPersonnelMonthlyReportStaffEntryAndExit' ne param.fdReportType}">
							<tr>
							...
							<c:if test="${'reportPersonnelMonthlyReportStaffEntryAndExit' eq param.fdReportType}">
							<tr>
								<td class="td_normal_title"><bean:message bundle="hr-staff" key="hrStaffPersonReport.reportPersonnelMonthlyReportStaffEntryAndExit.fdStaffType" /></td>
								<td>
									<xform:select property="fdStaffType" validators="required" showPleaseSelect="false">
										<xform:simpleDataSource value="海格正编">海格正编</xform:simpleDataSource>
										<xform:simpleDataSource value="派遣员工">派遣员工</xform:simpleDataSource>
										<xform:simpleDataSource value="实习生">实习生</xform:simpleDataSource>
									</xform:select>
									<span class="txtstrong">*</span>
								</td>
							</tr>
							<tr>
								<td class="td_normal_title"><bean:message bundle="hr-staff" key="hrStaffPersonReport.reportPersonnelMonthlyReportStaffEntryAndExit.fdMonth" /></td>
								<td>
									<xform:select property="fdMonth" validators="required" showPleaseSelect="false">
										<xform:simpleDataSource value="1">1月</xform:simpleDataSource>
										<xform:simpleDataSource value="2">2月</xform:simpleDataSource>
										<xform:simpleDataSource value="3">3月</xform:simpleDataSource>
										<xform:simpleDataSource value="4">4月</xform:simpleDataSource>
										<xform:simpleDataSource value="5">5月</xform:simpleDataSource>
										<xform:simpleDataSource value="6">6月</xform:simpleDataSource>
										<xform:simpleDataSource value="7">7月</xform:simpleDataSource>
										<xform:simpleDataSource value="8">8月</xform:simpleDataSource>
										<xform:simpleDataSource value="9">9月</xform:simpleDataSource>
										<xform:simpleDataSource value="10">10月</xform:simpleDataSource>
										<xform:simpleDataSource value="11">11月</xform:simpleDataSource>
										<xform:simpleDataSource value="12">12月</xform:simpleDataSource>
								</xform:select>
									<span class="txtstrong">*</span>
								</td>
							</tr>
