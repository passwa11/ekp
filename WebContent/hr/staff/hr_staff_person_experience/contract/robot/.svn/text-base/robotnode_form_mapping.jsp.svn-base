...
// 			    var _s = new Array("fdApplicant","fdLeaveDays","fdBeginDate","fdEndDate","fdLeaveType");
			    var _s = new Array("fdApplicant","fdName","fdBeginDate","fdEndDate","fdContType","fdSignType","fdHandleDate","autoHashMap","fdMemo","fdContractUnit","fdContractYear","fdContractMonth");
			...
			LUI.ready(function(){
				...
				createSelectElementHTML("fdContractUnit");
				createSelectElementHTML("fdContractYear");
				createSelectElementHTML("fdContractMonth");
				setLeaveType();
			});
		...
		<center>
			...
			<table width="100%" class="tb_normal">
				...
				<tr align="center">
					...
					<td>
						${lfn:message('hr-staff:hrStaffTrackRecord.fdContractUnit') }
					</td>
					<td id="fdContractUnit">
					</td>
				</tr>
				<tr align="center">
					<td>
						<bean:message key="resource.period.type.year.name"/>
					</td>
					<td id="fdContractYear">
					</td>
					<td>
						<bean:message key="resource.period.type.month.name"/>
					</td>
					<td id="fdContractMonth">
					</td>
				</tr>
			</table>
			</form>
