...
// 			    var _s = new Array("fdApplicant","fdLeaveDays","fdBeginDate","fdEndDate","fdLeaveType");
			    var _s = new Array("fdApplicant","fdTrainingName","fdBeginDate","fdEndDate","fdMemo","fdTrainingUnit","fdCertificate");
			...
			LUI.ready(function(){
				...
				createSelectElementHTML("fdCertificate");
		...
		<center>
			...
			<table width="100%" class="tb_normal">
				...
				<tr align="center">
					<td>
						${lfn:message('hr-staff:hrStaffPersonExperience.training.fdCertificate') }
					</td>
					<td id="fdCertificate">
					</td>
				</tr>
