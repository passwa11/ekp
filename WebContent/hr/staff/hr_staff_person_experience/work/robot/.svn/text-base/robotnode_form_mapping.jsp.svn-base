...
// 			    var _s = new Array("fdApplicant","fdLeaveDays","fdBeginDate","fdEndDate","fdLeaveType");
			    var _s = new Array("fdApplicant","fdCompany","fdPosition","fdBeginDate","fdEndDate","fdDescription","fdReasons");
			...
			LUI.ready(function(){
				...
				createSelectElementHTML("fdCompany");
				createSelectElementHTML("fdBeginDate");
				createSelectElementHTML("fdEndDate");
				createSelectElementHTML("fdPosition");
				createSelectElementHTML("fdDescription");
				createSelectElementHTML("fdReasons");
		...
		<center>
			...
			<table width="100%" class="tb_normal">
				<tr align="center">
					<td width="20%">
						${lfn:message('hr-staff:hrStaff.robot.worktAttribute') }
					</td>
					<td width="30%">
				...
				<tr align="center">
					<td>
						${lfn:message('hr-staff:hrStaff.robot.workPerson') }
					</td>
					<td id="fdApplicant">
					</td>
					<td>
