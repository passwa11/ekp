	...
	<template:replace name="body">
		...
		<list:listview id="listview">
			...
			<list:colTable isDefault="false" layout="sys.ui.listview.columntable" 
				...
				<list:col-auto props="nameAccount;fdDeptName;fdOrgPostNames;fdOrgRank;fdAffiliatedCompany;fdFirstLevelDepartment;fdSecondLevelDepartment;fdThirdLevelDepartment;fdBeginDate;fdEndDate;fdSchoolName;fdMajor;fdEducation;fdDegree;fdMemo;operations"></list:col-auto>
			</list:colTable>
		</list:listview> 
