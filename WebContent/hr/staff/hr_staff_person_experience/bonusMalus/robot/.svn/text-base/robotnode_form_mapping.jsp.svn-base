...
// 			    var _s = new Array("fdApplicant","fdLeaveDays","fdBeginDate","fdEndDate","fdLeaveType");
			    var _s = new Array("fdApplicant","fdBonusMalusName","fdBonusMalusDate","fdMemo","fdBonusMalusType");
			...
			LUI.ready(function(){
				...
				createSelectElementHTML("fdBonusMalusName");
				createSelectElementHTML("fdBonusMalusDate");
				createSelectElementHTML("fdMemo");
				createSelectElementHTML("fdBonusMalusType");
		...
		<center>
			...
			<table width="100%" class="tb_normal">
				<tr align="center">
					<td width="20%">
						${lfn:message('hr-staff:hrStaff.robot.bonusMalusAttribute') }
					</td>
					<td width="30%">
				...
				<!-- 奖惩人员 -->
					<td>
						${lfn:message('hr-staff:hrStaff.robot.bonusMalusPerson') }
					</td>
					<td id="fdApplicant">
					</td>
					<!-- 奖惩名称 -->
