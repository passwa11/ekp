...
// 			    var _s = new Array("fdApplicant","fdLeaveDays","fdBeginDate","fdEndDate","fdLeaveType");
			    var _s = new Array("fdApplicant","fdCertificateName","fdBeginDate","fdEndDate","fdAwardUnit");
			...
			LUI.ready(function(){
				...
				createSelectElementHTML("fdCertificateName");
				createSelectElementHTML("fdBeginDate");
				createSelectElementHTML("fdEndDate");
				createSelectElementHTML("fdAwardUnit");
		...
		<center>
			...
			<table width="100%" class="tb_normal">
				<tr align="center">
					<td width="20%">
						${lfn:message('hr-staff:hrStaff.robot.qualificationAttribute') }
					</td>
					<td width="30%">
				...
				<tr align="center">
					<td>
						${lfn:message('hr-staff:hrStaff.robot.qualificationPerson') }
					</td>
					<td id="fdApplicant">
					</td>
					<td>
