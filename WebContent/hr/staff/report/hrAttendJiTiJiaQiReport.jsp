...
<%@page
	import="com.landray.kmss.hr.staff.report.HrAttendJiTiJiaQiReport"%>
...
<script language="JavaScript">
    ...
    function exportResult() {
        let url = makeSrc('exportHrAttendJiTiJiaQiReport');
      //aalert(url)
        window.open(url);
    }
</script>
...
%>
<form action="hrAttendJiTiJiaQiReport.jsp" method="post"
...
<table class='hovertable' style="text-align: center; margin: auto;">
	...
	<%
	HrAttendJiTiJiaQiReport service = new HrAttendJiTiJiaQiReport();
	...
	<tr onmouseover="this.style.backgroundColor='#ffff66';"
		...
		<td>
			<!--请假名称--><%=map.get("fd_end_month_count")%></td>
		<td>
			<!--请假天数--><%=map.get("fd_new_month_count")%></td>
		<td>
			<!--备注--><%=map.get("fd_leave_month_count")%></td>
		<%
			}
		%>
	</tr>
