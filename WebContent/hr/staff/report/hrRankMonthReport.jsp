...
<%@page
	import="com.landray.kmss.hr.staff.report.PersonMonthReport"%>
...
%>
<form action="hrRankMonthReport.jsp" method="post"
...
<thead>
	<tr>
		...
		<th nowrap rowspan="2" id="aaa">部门名称</th>	
		
		<th nowrap colspan="10">M类</th>	
		<th nowrap colspan="10">S类</th>	
		<th nowrap colspan="10">P类</th>	
		<th nowrap colspan="10">O类</th>	
		<th nowrap colspan="10">小计</th>	
	</tr>
	<tr>
		<th nowrap >月初总数</th>
		<th nowrap >月末总数</th>
		<th nowrap >当月新进员工人数</th>
		<th nowrap >当月离职员工人数</th>
		<th nowrap >当月调入人数</th>
		<th nowrap >当月调出人数</th>
		<th nowrap >当月流动率%</th>
		<th nowrap >当月离职率%</th>
	...
	<tr onmouseover="this.style.backgroundColor='#ffff66';"
		...
		<td>
			<!--人数小计--><%=map.get("fd_begin_month_count")%></td>
		<td>
			<!--人数小计--><%=map.get("fd_end_month_count")%></td>
		<td>
			<!--人数小计--><%=map.get("fd_new_month_count")%></td>
		<td>
		...
		<td>
			<!--人数小计--><%=map.get("fd_begin_month_count4")%></td>
		<td>
			<!--人数小计--><%=map.get("fd_end_month_count4")%></td>
		<td>
			<!--人数小计--><%=map.get("fd_new_month_count4")%></td>
		<td>
			<!--人数小计--><%=map.get("fd_leave_month_count4")%></td>
		<td>
			<!--人数小计--><%=map.get("fd_in_month_count4")%></td>
		<td>
			<!--人数小计--><%=map.get("fd_out_month_count4")%></td>
		<td>
			<!--人数小计--><%=map.get("fd_flow_month_rate4")%>%</td>
		<td>
			<!--人数小计--><%=map.get("fd_leave_month_rate4")%>%</td>
		<td>
			<!--人数小计--><%=map.get("fd_leave_count4")%></td>
		<td>
			<!--人数小计--><%=map.get("fd_leave_rate4")%>%</td>
