...
<template:include ref="default.simple" spa="true">
	...
	<template:replace name="nav">
		<ui:combin ref="menu.nav.create">
			...
			<ui:varParam name="button">
				[
					{
						"text": "${ lfn:message('hr-staff:table.hrStaffAttendanceManageDetailed.overtime') }",
	...
	<script type="text/javascript">
		...
		<c:import url="/hr/staff/hr_staff_attendance_manage/manage_common_criterion.jsp" charEncoding="UTF-8">
			<c:param name="type" value="overtime" />
		</c:import>
		
		<!-- 列表 -->
		<list:listview id="listview">
			<ui:source type="AjaxJson">
				{url:'/sys/time/sys_time_leave_detail/sysTimeLeaveDetail.do?method=list&fromModule=hr&fdType=2'}
			</ui:source>
			<!-- 列表视图 -->	
			<list:colTable isDefault="false" layout="sys.ui.listview.columntable" name="columntable">
				<list:col-checkbox></list:col-checkbox>
				<list:col-serial></list:col-serial> 
				<list:col-auto props="fdPerson.fdName;fdLeaveName;fdStartTime;fdEndTime;fdLeaveTime;fdReview;fdOprDesc"></list:col-auto>
			</list:colTable>
		</list:listview> 
