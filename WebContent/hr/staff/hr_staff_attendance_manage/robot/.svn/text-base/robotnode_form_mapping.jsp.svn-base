	...
	<template:replace name="body"> 
		...
		<script type="text/javascript">
			...
			function setLeaveType() {
				...
				// 设置文本内容
				$.each($("#mainForm input"), function(i, n) {
					$(n).val(_allparams[$(n).attr("name")]);
				});
				// 设置下拉框内容
		...
		<center>
			...
			<table width="100%" class="tb_normal">
				<tr align="center">
					<td width="20%">
						${lfn:message('hr-staff:hrStaff.robot.attendanceAttribute') }
					</td>
					<td width="30%">
				...
				<tr align="center">
					<td>
						${lfn:message('hr-staff:hrStaff.robot.applicant') }
					</td>
					<td id="fdApplicant">
					</td>
					<td>
						${lfn:message('hr-staff:hrStaffAttendanceManageDetailed.fdLeaveDays') }
					</td>
					<td id="fdLeaveDays">
					</td>
				</tr>
				...
				<tr align="center">
					<td>
						${lfn:message('hr-staff:hrStaffAttendanceManageDetailed.fdLeaveType') }
					</td>
					<td id="fdLeaveType">
					</td>
					<td colspan="2">
						<table width="100%" class="tb_normal">
							<tr align="center">
								<td>
									${lfn:message('hr-staff:hrStaff.robot.optionValue.annualLeave') }
								</td>
								<td>
									<input type="text" name="fdDaysOfAnnualLeave" value="">
								</td>
							</tr>
							<tr align="center">
								<td>
									${lfn:message('hr-staff:hrStaff.robot.optionValue.takeWorking') }
								</td>
								<td>
									<input type="text" name="fdDaysOfTakeWorking" value="">
								</td>
							</tr>
							<tr align="center">
								<td>
									${lfn:message('hr-staff:hrStaff.robot.optionValue.sickLeave') }
								</td>
								<td>
									<input type="text" name="fdDaysOfSickLeave" value="">
								</td>
							</tr>
						</table>
					</td>
