...
<template:replace name="head">
	...
	<template:replace name="content">
		...
		<list:criteria id="criteria">
			<list:cri-auto modelName="com.landray.kmss.hr.staff.model.HrStaffEntry" property="fdPlanEntryTime" /></list:criteria>
		<!-- 列表 -->
		<list:listview id="listview">
			...
			<list:colTable isDefault="false" layout="sys.ui.listview.columntable" 
				...
				<list:col-auto props="fdName;fdMobileNo;fdPlanEntryTime;fdPlanEntryDept;fdDataFrom;fdLastModifiedTime;fdAlteror;fdStatus"></list:col-auto>
			</list:colTable>
		</list:listview> 
