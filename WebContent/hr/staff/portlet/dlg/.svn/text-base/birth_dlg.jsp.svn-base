...
<template:replace name="head">
	...
	<template:replace name="content">
		...
		<list:criteria id="criteria">
			<list:cri-ref key="fdBirthdayOfYear" ref="criterion.sys.Calendar_MothDay" title="${ lfn:message('hr-staff:hrStaffLastBirthday.birthday') }"></list:cri-ref>
		</list:criteria>
		<!-- 列表 -->
		<list:listview id="listview">
			...
			<list:colTable layout="sys.ui.listview.columntable"
				...
				<list:col-auto props="fdName;fdDeptName;fdOrgPostNames;fdDateOfBirth">
				</list:col-auto>
			</list:colTable>
		</list:listview>
