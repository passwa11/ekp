	...
	<template:replace name="content">
		...
		<list:listview id="listview">
			...
			<list:colTable isDefault="false" layout="sys.ui.listview.columntable" 
					...
					rowHref="/hr/staff/hr_staff_person_experience/contract/hrStaffPersonExperienceContract.do?method=view&fdId=!{fdId}"  name="columntable" >
				
				<list:col-auto props="fdPersonName;fdDeptName;fdOrgPostNames;fdBeginDate;fdEndDate;fdName"></list:col-auto>
			</list:colTable>
		</list:listview> 
