	...
	<template:replace name="content">
		...
		<list:listview id="listview">
			<ui:source type="AjaxJson">
				{url:'/hr/staff/hr_staff_person_info/hrStaffPersonInfo.do?method=list&searchType=annual&searchDate=${param.searchDate}'}
			</ui:source>
			<!-- 列表视图 -->
			<list:colTable layout="sys.ui.listview.columntable"
				...
				<list:col-auto props="fdName;fdDeptName;fdPosts;fdEntryTime">
				</list:col-auto>
			</list:colTable>
		</list:listview>
