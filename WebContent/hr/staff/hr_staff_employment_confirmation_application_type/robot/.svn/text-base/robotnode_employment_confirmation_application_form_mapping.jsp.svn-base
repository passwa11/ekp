	...
	<template:replace name="body">
		...
		<script type="text/javascript">
			...
			function serializeObject(form) {
				...
				var _s = new Array("fdApplicant","fdEmploymentConfirmation","fdStatus","fdCategory","fdOrgRank",
						"fdReportLeader","fdOfficeAreaProvinceId","fdOfficeAreaCityId",
			...
			LUI.ready(function(){
				...
				createSelectElementHTML("fdEmploymentConfirmation");
			...
			<form id="mainForm" action="">
				...
				<table width="100%" class="tb_normal">
					...
					<tr align="center">
						...
						<td>转正生效日期</td><td id="fdEmploymentConfirmation"></td>
					</tr>
					<tr align="center">
