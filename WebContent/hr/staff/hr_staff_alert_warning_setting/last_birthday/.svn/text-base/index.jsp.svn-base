...
<template:include ref="config.profile.edit" sidebar="no">
	...
	<template:replace name="content">
		...
		<h2 align="center" style="margin:10px 0">
			<span class="profile_config_title"><bean:message key="hr.staff.tree.birthday.reminder" bundle="hr-staff"/></span>
		</h2>
				...
				<table class="tb_normal" width=95%>
					<tr>
						<td class="td_normal_title" colspan="2">
							<b><label>${lfn:message('hr-staff:hr.staff.birthday.staff.reminder')}</label></b>
						</td>
					</tr>
					<tr>
					...
					<tr id="tr1">
					   <td class="td_normal_title" width="15%">${lfn:message('hr-staff:hr.staff.birthday.cycle.reminder')}</td>
					   <td >
			...
			<input type="hidden" name="modelName" value="com.landray.kmss.hr.staff.model.HrStaffAlertWarningBirthday" />
