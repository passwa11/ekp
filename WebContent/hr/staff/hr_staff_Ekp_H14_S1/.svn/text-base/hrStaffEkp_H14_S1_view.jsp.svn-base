...
<template:include ref="default.view" sidebar="no">
	...
	<template:replace name="toolbar">
		...
		<ui:toolbar id="toolbar" layout="sys.ui.toolbar.float">
			<%--删除--%>
			<ui:button text="${lfn:message('button.delete') }" onclick="deleteDoc('hrStaffEkp_H14_S1.do?method=delete&fdId=${param.fdId}');" order="4">
			</ui:button>
			<%--关闭--%>
	...
	<template:replace name="content">
		<html:form action="/hr/staff/hr_staff_ekp_H14_S1/hrStaffEkp_H14_S1.do">		
			<html:hidden property="fdId" />
			<div class="lui_form_content_frame">
				<p class="lui_form_subject">
					<bean:message bundle="hr-staff" key="table.hrStaffEkp_H14_S1" />
				</p>
				...
				<tr>
					...
					<td width="35%">
						<c:choose>
							<c:when test="${ hrStaffEkp_H14_S1Form.method_GET == 'add' }">
								<xform:address propertyId="fdOrgPersonId" idValue="${ hrStaffEkp_H14_S1Form.fdPersonInfoId }" 
								propertyName="fdOrgPersonName" nameValue="${ hrStaffEkp_H14_S1Form.fdPersonInfoName }" 
					...
					<!-- 工资账户名 -->
					<td width="15%" class="td_normal_title">
						<bean:message bundle="hr-staff" key="hrStaffEkp_H14_S1.fdFirstLevelDepartment" />
					</td>
					<td width="35%">
						<bean:write name="hrStaffEkp_H14_S1Form" property="fdFirstLevelDepartment"  />
					</td>
				</tr>
				<tr>
					...
					<td width="15%" class="td_normal_title">
						<bean:message bundle="hr-staff" key="hrStaffEkp_H14_S1.fdSecondLevelDepartment" />
					</td>
					<td width="35%">
					...
					<!-- 公积金账户 -->
					<td width="15%" class="td_normal_title">
						<bean:message bundle="hr-staff" key="hrStaffEkp_H14_S1.fdThirdLevelDepartment" />
					</td>
					<td width="35%">
				...
				<tr>
					<!-- 公积金账户 -->
					<td width="15%" class="td_normal_title">
						<bean:message bundle="hr-staff" key="hrStaffEkp_H14_S1.fdExpiryDate" />
					</td>
					<td width="35%">
					...
					<!-- 公积金账户 -->
					<td width="15%" class="td_normal_title">
						<bean:message bundle="hr-staff" key="hrStaffEkp_H14_S1.fdEvaluationDimension" />
					</td>
					<td width="35%">
				...
				<tr>
					<!-- 公积金账户 -->
					<td width="15%" class="td_normal_title">
						<bean:message bundle="hr-staff" key="hrStaffEkp_H14_S1.fdEvaluationIndex" />
					</td>
					<td width="35%">
					...
					<!-- 公积金账户 -->
					<td width="15%" class="td_normal_title">
						<bean:message bundle="hr-staff" key="hrStaffEkp_H14_S1.fdTargetValue" />
					</td>
					<td width="35%">
				...
				<tr>
					<!-- 公积金账户 -->
					<td width="15%" class="td_normal_title">
						<bean:message bundle="hr-staff" key="hrStaffEkp_H14_S1.fdWeight" />
					</td>
					<td width="35%">
					...
					<!-- 公积金账户 -->
					<td width="15%" class="td_normal_title">
						<bean:message bundle="hr-staff" key="hrStaffEkp_H14_S1.fdBeginDate" />
					</td>
					<td width="35%">
				...
				<tr>
					<!-- 公积金账户 -->
					<td width="15%" class="td_normal_title">
						<bean:message bundle="hr-staff" key="hrStaffEkp_H14_S1.fdJobNature" />
					</td>
					<td width="35%">
