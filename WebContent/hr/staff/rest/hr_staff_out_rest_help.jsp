...
<table border="0" width="95%">
	...
	<tr>
		<td style="cursor: pointer;font-size: 15px;" onclick="expandMethod(this);">&nbsp;&nbsp;1.1&nbsp;&nbsp;获取所有人事档案基本信息（/api/hr-staff/hrStaffWebService/getHrStaffElements）
		...
		<td>
			<table class="tb_normal" cellpadding="0" cellspacing="0"  style="width: 85%;margin-left: 40px;">
				<tr>
					...
					<td style="padding: 0px;"><div style="margin: 8px;">&nbsp;&nbsp;人事档案基本信息接出body数据（JSON对象），详细说明如下:</div>
...
{
  "count": "10",
  "beginTimeStamp": "2020-12-26 11:34:49"
}
									</pre>
								</td>
							</tr>
