...
<template:include ref="default.view" sidebar="no">
	...
	<template:replace name="toolbar">
		...
		<ui:toolbar id="toolbar" layout="sys.ui.toolbar.float">
			<%--删除--%>
			<ui:button text="${lfn:message('button.delete') }" onclick="deleteDoc('hrStaffPerformanceContractImport.do?method=delete&fdId=${param.fdId}');" order="4">
			</ui:button>
			<%--关闭--%>
		...
		<html:form action="/hr/staff/hr_staff_performance_contract_import/hrStaffPerformanceContractImport.do">		
			...
			<div class="lui_form_content_frame">
				<p class="lui_form_subject">
					<bean:message bundle="hr-staff" key="table.hrStaffPerformanceContractImport" />
				</p>
				...
				<tr>
					...
					<td width="35%">
						<bean:write name="hrStaffPerformanceContractImportForm" property="fdFirstLevelDepartment"  />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="35%">
						<xform:text property="fdExpiryDate"  style="width:95%;" className="inputsgl" />
					</td>
