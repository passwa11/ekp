...
<template:include ref="default.simple">
	...
	<template:replace name="body">
   		...
   		<html:form action="/hr/organization/hr_organization_post/hrOrganizationPost.do?method=importOrgPost"  enctype="multipart/form-data" styleClass="lui_hr_import_form">
