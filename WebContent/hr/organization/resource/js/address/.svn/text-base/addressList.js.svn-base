...
define(function(require, exports, module) {
	...
	var constant = require('hr/organization/resource/js/address/addressConstant');
	
	var AddressSelectedArea = require('hr/organization/resource/js/address/component/selectedAreaComponent');//已选区域组件
	var AddressButtons = require('hr/organization/resource/js/address/component/buttonComponent');//底部按钮栏组件
