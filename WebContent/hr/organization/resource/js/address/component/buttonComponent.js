...
define(function(require, exports, module) {
	...
	var ButtonComponent =  base.Container.extend({
		...
		handleElementSave : function(){
			...
			kmssData.SendToUrl(Com_Parameter.ContextPath+'hr/organization/hr_organization_recent_contact/hrOrganizationRecentContact.do?method=addContacts',function(){
				if(self.callback){
