...
<template:include ref="default.dialog">
	...
	<template:replace name="content">
		...
		<div class="hr_contract_sign_wrap">
			<html:form action="/hr/organization/hr_organization_dept/hrOrganizationDept.do">
				<div class="lui_hr_tb_simple_wrap">
					<table class="tb_simple lui_hr_tb_simple">
						...
						<tr>
							...
							<td>
								<xform:select property="fdOrgType" showStatus="readOnly" value="4" style="width:95%">
							...
							<td>
								<xform:address propertyId="fdParentId" propertyName="fdParentName" orgType="ORG_TYPE_POST" showStatus="edit" style="width:95%;" isHrAddress="true"/>
							</td>
						</tr>
						<tr>
							<td class="tr_normal_title">
							...
							<td>
								<xform:address propertyId="fdThisLeaderId" propertyName="fdThisLeaderName" orgType="ORG_TYPE_PERSON" showStatus="edit" style="width:95%;" isHrAddress="false"/>
							</td>
							<td class="tr_normal_title">
								<bean:message bundle="hr-organization" key="hrOrganizationElement.fdBranLeader"/>
							</td>
							<td>
								<xform:address propertyId="fdBranLeaderId" propertyName="fdBranLeaderName" orgType="ORG_TYPE_PERSON" showStatus="edit" style="width:95%;" isHrAddress="true"/>
							</td>
						</tr>
						<tr>
							<td class="tr_normal_title">
...
<script>
	...
	Com_IncludeFile("form_option.js", "${LUI_ContextPath}/hr/organization/hr_organization_dept/", 'js', true);
	...
	seajs.use(['lui/dialog','lui/jquery'], function(dialog,$) {
		window._submit = function(){
			if ($KMSSValidation().validate()) {
				var url = '${LUI_ContextPath}/hr/organization/hr_organization_dept/hrOrganizationDept.do?method=save';
				$.post(url, $(document.hrOrganizationDeptForm).serialize(),function(data){
				   if(data!=""){
