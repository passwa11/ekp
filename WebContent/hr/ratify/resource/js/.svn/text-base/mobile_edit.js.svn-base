Com_IncludeFile("lang.jsp", Com_Parameter.ContextPath + "hr/ratify/resource/js/", null, true);
require(['dojo/ready', "dojo/parser", 'dojo/dom', 'dojo/dom-construct', 'mui/util', 'dijit/registry', 'dojo/topic',
         'dojo/query', 'dojo/dom-style',"dojo/dom-attr","dojo/dom-class" ,'mui/dialog/Confirm','dojo/NodeList-manipulate', 'dojo/NodeList-traverse','mui/form',], 
		function(ready, parser, dom, domConstruct, util, registry, topic, query,domStyle,domAttr,domClass,Confirm) {
	ready(function() {
	...
	window.submitFormValidate2=function(method){
		var validorObj=registry.byId('scrollView');
		if(validorObj.validate()){
