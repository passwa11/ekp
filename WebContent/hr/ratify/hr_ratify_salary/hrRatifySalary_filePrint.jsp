...
<form name="hrRatifySalaryForm" method="post" action="<c:url value="/hr/ratify/hr_ratify_salary/hrRatifySalary.do"/>">
<center>
<div class="print_title_header">
<p id="title" class="print_txttitle">
	<bean:write name="hrRatifySalaryForm" property="docSubject" />
</p>
<div class="printDate">
...
<div>
	...
	<table class="tb_normal" width=100%>
		...
		<tr>
			...
			<td colspan=3>
				<bean:write name="hrRatifySalaryForm" property="docSubject" /></td>
		</tr>
		<!--模板名称-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td colspan=3>
				<bean:write name="hrRatifySalaryForm" property="docTemplateName" /></td>
		</tr>
		<!--申请人-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td width=35%>
				<html:hidden name="hrRatifySalaryForm" property="docCreatorId" /> 
				<bean:write name="hrRatifySalaryForm" property="docCreatorName" /></td>
			<td class="td_normal_title" width=15%>
				<bean:message bundle="hr-ratify" key="hrRatifyMain.docNumber" /></td>
			<td width=35%>
				<bean:write name="hrRatifySalaryForm" property="docNumber" /></td>
		</tr>
		<!--部门-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td>
				<bean:write name="hrRatifySalaryForm" property="fdDepartmentName"/></td>
			<td class="td_normal_title" width=15%>
				<bean:message bundle="hr-ratify" key="hrRatifyMain.docCreateTime" /></td>
			<td width=35%>
				<bean:write name="hrRatifySalaryForm" property="docCreateTime" /></td>
		</tr>
		<!--实施反馈人-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td colspan=3>
				<bean:write name="hrRatifySalaryForm" property="fdFeedbackNames" /></td>
		</tr>
		<!--关键字-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td colspan=3>
				<bean:write name="hrRatifySalaryForm" property="fdKeywordNames" /></td>
		</tr>
	</table>
</div>
