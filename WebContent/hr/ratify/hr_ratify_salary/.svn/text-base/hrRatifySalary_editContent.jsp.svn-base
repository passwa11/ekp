				...
				<tr>
					...
					<td style="border-left: 0px !important;">
						<div id="_xform_docSubject" _xform_type="text">
							<c:if
								test="${hrRatifySalaryForm.titleRegulation==null || hrRatifySalaryForm.titleRegulation=='' }">
				...
				<tr>
					...
					<td width="35%">
						...
						<div id="_xform_docNumber" _xform_type="text">
							<c:if test="${not empty hrRatifySalaryForm.docNumber}">
								<xform:text property="docNumber" showStatus="readOnly"
									style="width:95%;" />
							</c:if>
							<c:if test="${empty hrRatifySalaryForm.docNumber}">
