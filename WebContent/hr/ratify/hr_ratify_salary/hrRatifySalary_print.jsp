...
<div class="print_title_header" id="subjectDiv">
	<p id="title" class="print_txttitle"><bean:write name="hrRatifySalaryForm" property="docSubject" /></p>
	<div class="printDate">
...
<div id="baseDiv">
	...
	<table class="tb_normal" width=100%>
		...
		<tr>
			...
			<td colspan=3><bean:write name="hrRatifySalaryForm"
		...
		<tr>
			...
			<td width=35%><html:hidden name="hrRatifySalaryForm"
				property="docCreatorId" /> <bean:write name="hrRatifySalaryForm"
				property="docCreatorName" /></td>
			<td class="td_normal_title" width=15%><bean:message
				bundle="hr-ratify" key="hrRatifyMain.docNumber" /></td>
			<td width=35%><bean:write name="hrRatifySalaryForm"
		...
		<tr>
			...
			<td><bean:write name="hrRatifySalaryForm" property="fdDepartmentName"/></td>
			<td class="td_normal_title" width=15%><bean:message
