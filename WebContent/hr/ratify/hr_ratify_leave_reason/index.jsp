...
<template:replace name="content">
		...
		<list:criteria id="criteria">
		     <list:cri-ref key="fdName" ref="criterion.sys.docSubject" title="${lfn:message('hr-ratify:hrRatifyLeaveReason.fdName') }">
			</list:cri-ref>
		</list:criteria>
		<!-- 操作栏 -->
			...
			<div class="lui_list_operation_sort_btn">
				...
				<div class="lui_list_operation_sort_toolbar">
					<ui:toolbar layout="sys.ui.toolbar.sort" style="float:left" >
						...
						<list:sort property="fdName" text="${lfn:message('hr-ratify:hrRatifyLeaveReason.fdName') }" group="sort.list"></list:sort>
						</list:sortgroup>
					</ui:toolbar>
				</div>
			</div>
		...
		<list:listview>
			<ui:source type="AjaxJson">
					{url:'/hr/ratify/hr_ratify_leave_reason/hrRatifyLeaveReason.do?method=list'}
			</ui:source>
	 	...
	 	<script type="text/javascript">
		 	seajs.use(['lui/jquery', 'lui/dialog', 'lui/topic'], function($, dialog, topic) {
				...
				topic.subscribe('successReloadPage', function() {
			 	...
			 	// 增加
		 		window.add = function() {
		 			Com_OpenWindow('<c:url value="/hr/ratify/hr_ratify_leave_reason/hrRatifyLeaveReason.do" />?method=add');
		 		};
		 		// 编辑
