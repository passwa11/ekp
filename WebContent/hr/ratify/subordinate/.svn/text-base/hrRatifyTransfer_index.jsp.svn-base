	        ...
	        <div style="float:right">
	            <div style="display: inline-block;vertical-align: middle;">
	                <ui:toolbar count="3">
	                    ...
	                    <kmss:auth requestURL="/hr/ratify/hr_ratify_entry/hrRatifyTransfer.do?method=deleteall">
...
<list:listview id="listview">
	<ui:source type="AjaxJson">
		{url:'/sys/subordinate/sysSubordinate.do?method=list&modelName=com.landray.kmss.hr.ratify.model.HrRatifyTransfer&orgId=${JsParam.orgId}'}
	</ui:source>
	<list:colTable url="${LUI_ContextPath }/sys/profile/listShow/sys_listShow/sysListShow.do?method=getSort&modelName=com.landray.kmss.hr.ratify.model.HrRatifyTransfer" 
		isDefault="true" layout="sys.ui.listview.columntable" 
		rowHref="/sys/subordinate/sysSubordinate.do?method=view&modelId=!{fdId}&modelName=com.landray.kmss.hr.ratify.model.HrRatifyTransfer&orgId=${JsParam.orgId}">
