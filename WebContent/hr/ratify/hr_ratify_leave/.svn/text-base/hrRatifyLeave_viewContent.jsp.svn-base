...
<c:choose>
	                ...
	                <tr>
	                    ...
	                    <td colspan="3">
	                        ...
	                        <div id="_xform_docTemplateId" _xform_type="dialog">
	                            <c:out value="${ hrRatifyLeaveForm.docTemplateName}"/>
	                        </div>
	                    </td>
	                </tr>
	                <tr>
	                    ...
	                    <td width="35%">
	                        ...
	                        <div id="_xform_docCreatorId" _xform_type="address">
	                            <ui:person personId="${hrRatifyLeaveForm.docCreatorId}" personName="${hrRatifyLeaveForm.docCreatorName}" />
	                        </div>
	                    </td>
	                    <td class="td_normal_title" width="15%">
	...
	<c:when test="${param.contentType eq 'other'}">
		<c:if test="${param.approveModel ne 'right'}">
			<c:choose>
	            <c:when test="${hrRatifyLeaveForm.docUseXform == 'true' || empty hrRatifyLeaveForm.docUseXform}">
        ...
        <%-- 发起沟通 --%>
		<c:if test="${hrRatifyLeaveForm.docStatus!='10'}">
