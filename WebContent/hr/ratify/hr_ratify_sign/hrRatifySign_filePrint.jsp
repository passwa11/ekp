...
<p id="title" class="print_txttitle">
	<bean:write name="hrRatifySignForm" property="docSubject" />
</p>
<div class="printDate">
...
<div>
	...
	<table class="tb_normal" width=100%>
		...
		<tr>
			...
			<td colspan=3>
				<bean:write name="hrRatifySignForm" property="docSubject" /></td>
		</tr>
		<!--模板名称-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td colspan=3>
				<bean:write name="hrRatifySignForm" property="docTemplateName" /></td>
		</tr>
		<!--申请人-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td width=35%>
				<html:hidden name="hrRatifySignForm" property="docCreatorId" /> 
				<bean:write name="hrRatifySignForm" property="docCreatorName" /></td>
			<td class="td_normal_title" width=15%>
				<bean:message bundle="hr-ratify" key="hrRatifyMain.docNumber" /></td>
			<td width=35%>
				<bean:write name="hrRatifySignForm" property="docNumber" /></td>
		</tr>
		<!--部门-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td>
				<bean:write name="hrRatifySignForm" property="fdDepartmentName"/></td>
			<td class="td_normal_title" width=15%>
				<bean:message bundle="hr-ratify" key="hrRatifyMain.docCreateTime" /></td>
			<td width=35%>
				<bean:write name="hrRatifySignForm" property="docCreateTime" /></td>
		</tr>
		<!--实施反馈人-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td colspan=3>
				<bean:write name="hrRatifySignForm" property="fdFeedbackNames" /></td>
		</tr>
		<!--关键字-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td colspan=3>
				<bean:write name="hrRatifySignForm" property="fdKeywordNames" /></td>
		</tr>
	</table>
</div>
...
<div>
	...
	<c:if test="${hrRatifySignForm.docUseXform == 'false' }">
		<table id="info_content" class="tb_normal" width=100% >
			<tr>
                <td colspan="4">${hrRatifySignForm.docXform}</td>
            </tr>
		</table>
	</c:if>
	...
	<table class="tb_normal" width=100%>
		<tr>
      		<td align="left" class="td_normal_title" width=15.5%>
      			<bean:message bundle="hr-ratify" key="hrRatifySign.attHrRatifySign" />
      		</td>
         	<td>
