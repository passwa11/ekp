...
<c:choose>
        	...
        	<table class="tb_normal" width=100%>
            	...
            	<html:hidden property="fdSignEnable" />
			 	<c:if test="${hrRatifySignForm.fdSignEnable}">
						<tr>
		             		<td align="left" class="td_normal_title"width=15.5%>${ lfn:message('hr-ratify:hrRatifyMain.yqqSignFile') }</td>
		                   	<td>
		            	...
		            	<tr>
		             		<td align="left" class="td_normal_title"width=15.5%>${ lfn:message('hr-ratify:hrRatifyMain.fdSignFile') }</td>
		                   	<td>
								<c:import url="/sys/attachment/sys_att_main/sysAttMain_view.jsp"
								charEncoding="UTF-8">
								<c:param name="formBeanName" value="hrRatifySignForm" />
	                ...
	                <tr>
	                    ...
	                    <td width="35%">
	                        ...
	                        <div id="_xform_docCreatorId" _xform_type="address">
	                            <ui:person personId="${hrRatifySignForm.docCreatorId}" personName="${hrRatifySignForm.docCreatorName}" />
	                        </div>
	                    </td>
	                    <td class="td_normal_title" width="15%">
	...
	<c:when test="${param.contentType eq 'other'}">
        ...
        <%-- 发起沟通 --%>
		<c:if test="${hrRatifySignForm.docStatus!='10'}">
