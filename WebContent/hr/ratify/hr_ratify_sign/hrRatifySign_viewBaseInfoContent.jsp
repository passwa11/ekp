...
<ui:content title="基本信息" titleicon="lui-fm-icon-2">
	...
	<table class="tb_normal lui-fm-noneBorderTable" width="100%">
        ...
        <tr>
        	...
        	<td>
        		<c:out value="${hrRatifySignForm.fdKeywordNames }"></c:out>
        	</td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
        ...
        <tr>
            ...
            <td>
                <%-- 创建人--%>
                <c:out value="${hrRatifySignForm.docCreatorName }"></c:out>
            </td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 编号--%>
                <c:out value="${hrRatifySignForm.docNumber }"></c:out>
            </td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 部门--%>
                <c:out value="${hrRatifySignForm.fdDepartmentName }"></c:out>
            </td>
        </tr>
        <tr>   
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 创建时间--%>
                <c:out value="${hrRatifySignForm.docCreateTime }"></c:out>
            </td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 结束时间--%>
                <c:out value="${hrRatifySignForm.docPublishTime }"></c:out>
            </td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 实施反馈人--%>
                <c:out value="${hrRatifySignForm.fdFeedbackNames }"></c:out>
            </td>
        </tr>
	</table>
</ui:content>