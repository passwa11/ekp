...
<ui:content title="基本信息" titleicon="lui-fm-icon-2">
		...
		<script>
			LUI.ready(function(){
                ...
                var interval = setInterval(function(){
                    timesRun += 1;
                    if(timesRun == 20 || $("i.lui-fm-icon-2").closest(".lui_tabpanel_vertical_icon_navs_item_l").length>0){
                        console.log("lui-timesRun:"+timesRun);
                        $("i.lui-fm-icon-2").closest(".lui_tabpanel_vertical_icon_navs_item_l").click();
	...
	<table class="tb_normal lui-fm-noneBorderTable" width="100%">
        ...
        <tr>
        	...
        	<td>
        		<c:out value="${hrRatifyEntryForm.fdKeywordNames }"></c:out>
        	</td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
        ...
        <tr>
            ...
            <td>
                <%-- 创建人--%>
                <c:out value="${hrRatifyEntryForm.docCreatorName }"></c:out>
            </td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 编号--%>
                <c:out value="${hrRatifyEntryForm.docNumber }"></c:out>
            </td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 部门--%>
                <c:out value="${hrRatifyEntryForm.fdDepartmentName }"></c:out>
            </td>
        </tr>
        <tr>   
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 创建时间--%>
                <c:out value="${hrRatifyEntryForm.docCreateTime }"></c:out>
            </td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 结束时间--%>
                <c:out value="${hrRatifyEntryForm.docPublishTime }"></c:out>
            </td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 实施反馈人--%>
                <c:out value="${hrRatifyEntryForm.fdFeedbackNames }"></c:out>
            </td>
        </tr>
    </table>
</ui:content>