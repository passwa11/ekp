...
<template:include ref="default.dialog">
	<template:replace name="head">
    	...
    	<script>
    		seajs.use('hr/ratify/hr_staff_concern/js/editHrStaffTrackRecord.js');
    	</script>
	</template:replace>
	<template:replace name="content" >
			...
			<html:form action="/hr/staff/hr_staff_person_track_record/hrStaffTrackRecord.do" styleId="hrStaffTrackRecordForm" styleClass="hr_leave_deal_form">
				<div class="hr_leave_deal_wrap">
			        ...
			        <table class="tb_simple lui_hr_tb_simple">
				        <tr>
				          <td class="tr_normal_title" width="43%">部门</td>
				          <td><span class="lui_hr_secondary_txt">${personInfo.fdOrgParent.fdName }</span></td>
				        </tr>
				        <tr>
				          <td class="tr_normal_title" width="43%">岗位</td>
				          <td>
				     ...
				     <!-- 分割线 -->
      				...
      				<html:hidden property="afterEffectTime" value="${afterEffectTime}"/>
			        ...
			        <div class="lui_hr_tb_simple_wrap">
			            <table class="tb_simple lui_hr_tb_simple">
			            	<tr>
								...
								<td width=57%>
									<xform:datetime property="fdEntranceBeginDate" dateTimeType="date" required="true" showStatus="edit"></xform:datetime>
								</td>
							</tr>
							<tr>
								<td class="tr_normal_title">
								...
								<td width=57%>
									<xform:datetime property="fdEntranceEndDate" dateTimeType="date" validators="compareEnd" showStatus="edit"></xform:datetime>
								</td>
							</tr>
			                <tr>
			                    <td class="tr_normal_title">
			                    ...
			                    <td>
			                   		<xform:address propertyId="fdRatifyDeptId" propertyName="fdRatifyDeptName" showStatus="edit" orgType="ORG_TYPE_DEPT" style="width:40%"></xform:address>
			                    </td>
			                </tr>
			                <tr>
			                    <td class="tr_normal_title">
			                    ...
			                    <td>
			                    	<xform:address propertyId="fdOrgPostsIds" propertyName="fdOrgPostsNames" showStatus="edit" orgType="ORG_TYPE_POST" required="true" subject="异动后岗位" style="width:40%"></xform:address>
			                    </td>
			                </tr>
			                <tr>
			                    <td class="tr_normal_title">
			                    ...
			                    <td width=57%>
			                        <xform:datetime property="fdTransDate" dateTimeType="date" showStatus="edit" required="true"/>
			                    </td>
			                </tr>
		...
		<script>
			...
			seajs.use(['lui/jquery','lui/dialog','lui/topic'], function($, dialog , topic) {
				...
				function submit(){
					var url = '<c:url value="/hr/staff/hr_staff_person_track_record/hrStaffTrackRecord.do?method=updateHrStaffTrackRecord"/>';
					$.ajax({
						url : url,
						type : 'POST',
