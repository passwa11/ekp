...
<template:include ref="default.dialog">
	...
	<template:replace name="content">
				...
				<div class="lui_hr_tb_simple_wrap">
					<table class="tb_simple lui_hr_tb_simple">
						...
						<tr>
							...
							<td>
								<xform:checkbox property="fdIsLongtermContract" onValueChange="cancelEndDate" value="${hrStaffPersonExperienceContractForm.fdIsLongtermContract}" showStatus="edit">
		...
		<div class="lui_hr_footer_btnGroup">
            <ui:button text="${lfn:message('hr-ratify:hrRatify.concern.sign.ok') }" onclick="_submit();"></ui:button>
