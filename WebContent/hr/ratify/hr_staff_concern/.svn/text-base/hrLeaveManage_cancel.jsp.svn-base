...
<template:include ref="default.dialog">
	...
	<template:replace name="content" >
		<script type="text/javascript">Com_IncludeFile("validation.jsp|validation.js|plugin.js|eventbus.js|xform.js|dialog.js", null, "js");</script>
			<html:form action="/hr/ratify/hr_ratify_leave_dr/hrRatifyLeaveDR.do" styleClass="hr_leave_cancel_form">
				<div class="hr_leave_cancel_wrap">
					<div class="lui_hr_criteria_wrap">
		                <em class="lui_text_primary">${ lfn:message('hr-staff:hrStaffEntry.already.choose') }：</em>
		                <ul class="lui_hr_criteria_wrap_list">
		             		<li class="lui_hr_status_selected ">
	             				<a href="javascript:void(0);" class="lui_text_primary">
	             					<span class="lui_hr_name">${param.fdUserName }</span>
	             				</a>
	             			</li>
		                </ul>
		            </div>
