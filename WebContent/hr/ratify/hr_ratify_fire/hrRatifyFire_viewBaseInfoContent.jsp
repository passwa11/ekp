...
<ui:content title="基本信息" titleicon="lui-fm-icon-2">
	<!-- 草稿状态的文档默认选中基本信息页签 -->
	<c:if test="${hrRatifyFireForm.docStatus=='10'}">
		<script>
			LUI.ready(function(){
				setTimeout(function(){
	...
	<table class="tb_normal lui-fm-noneBorderTable" width="100%">
        ...
        <tr>
        	...
        	<td>
        		<c:out value="${hrRatifyFireForm.fdKeywordNames }"></c:out>
        	</td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
        ...
        <tr>
            ...
            <td>
                <%-- 创建人--%>
                <c:out value="${hrRatifyFireForm.docCreatorName }"></c:out>
            </td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 编号--%>
                <c:out value="${hrRatifyFireForm.docNumber }"></c:out>
            </td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 部门--%>
                <c:out value="${hrRatifyFireForm.fdDepartmentName }"></c:out>
            </td>
        </tr>
        <tr>   
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 创建时间--%>
                <c:out value="${hrRatifyFireForm.docCreateTime }"></c:out>
            </td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 结束时间--%>
                <c:out value="${hrRatifyFireForm.docPublishTime }"></c:out>
            </td>
        </tr>
        <tr>
            <td class="tr_normal_title" width="30%">
            ...
            <td>
                <%-- 实施反馈人--%>
                <c:out value="${hrRatifyFireForm.fdFeedbackNames }"></c:out>
            </td>
        </tr>
    </table>
</ui:content>