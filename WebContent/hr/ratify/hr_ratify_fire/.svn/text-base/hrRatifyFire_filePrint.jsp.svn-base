...
<form name="hrRatifyFireForm" method="post" action="<c:url value="/hr/ratify/hr_ratify_fire/hrRatifyFire.do"/>">
<center>
<div class="print_title_header">
<p id="title" class="print_txttitle">
	<bean:write name="hrRatifyFireForm" property="docSubject" />
</p>
<div class="printDate">
...
<div>
	...
	<table class="tb_normal" width=100%>
		...
		<tr>
			...
			<td colspan=3>
				<bean:write name="hrRatifyFireForm" property="docSubject" /></td>
		</tr>
		<!--模板名称-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td colspan=3>
				<bean:write name="hrRatifyFireForm" property="docTemplateName" /></td>
		</tr>
		<!--申请人-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td width=35%>
				<html:hidden name="hrRatifyFireForm" property="docCreatorId" /> 
				<bean:write name="hrRatifyFireForm" property="docCreatorName" /></td>
			<td class="td_normal_title" width=15%>
				<bean:message bundle="hr-ratify" key="hrRatifyMain.docNumber" /></td>
			<td width=35%>
				<bean:write name="hrRatifyFireForm" property="docNumber" /></td>
		</tr>
		<!--部门-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td>
				<bean:write name="hrRatifyFireForm" property="fdDepartmentName"/></td>
			<td class="td_normal_title" width=15%>
				<bean:message bundle="hr-ratify" key="hrRatifyMain.docCreateTime" /></td>
			<td width=35%>
				<bean:write name="hrRatifyFireForm" property="docCreateTime" /></td>
		</tr>
		<!--实施反馈人-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td colspan=3>
				<bean:write name="hrRatifyFireForm" property="fdFeedbackNames" /></td>
		</tr>
		<!--关键字-->
		<tr>
			<td class="td_normal_title" width=15%>
			...
			<td colspan=3>
				<bean:write name="hrRatifyFireForm" property="fdKeywordNames" /></td>
		</tr>
	</table>
</div>
...
<div>
	...
	<c:if test="${hrRatifyFireForm.docUseXform == 'false' }">
		<table id="info_content" class="tb_normal" width=100% >
			<tr>
                <td colspan="4">${hrRatifyFireForm.docXform}</td>
            </tr>
		</table>
	</c:if>
