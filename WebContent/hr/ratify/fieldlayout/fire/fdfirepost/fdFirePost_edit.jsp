...
<div id="_fdFirePost" valField="fdFirePostId" xform_type="address">
  <xform:address 
            isLoadDataDict="false"
            showStatus="edit"
            mobile="${param.mobile eq 'true'? 'true':'false'}"
			required="<%=required %>" style="<%=parse.getStyle()%>"
			subject="${lfn:message('hr-ratify:hrRatifyFire.fdFirePost')}"
			propertyId="fdFirePostId" propertyName="fdFirePostName"
