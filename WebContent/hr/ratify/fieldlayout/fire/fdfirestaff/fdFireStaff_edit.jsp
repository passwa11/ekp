...
<div id="_fdFireStaff" valField="fdFireStaffId" xform_type="address">
  <xform:address 
			...
			subject="${lfn:message('hr-ratify:hrRatifyFire.fdFireStaff')}"
			propertyId="fdFireStaffId" propertyName="fdFireStaffName"
