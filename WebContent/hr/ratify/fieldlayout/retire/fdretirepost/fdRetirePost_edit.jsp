...
<div id="_fdRetirePost" valField="fdRetirePostId" xform_type="address">
  <xform:address 
            isLoadDataDict="false"
            showStatus="edit"
            mobile="${param.mobile eq 'true'? 'true':'false'}"
			required="<%=required %>" style="<%=parse.getStyle()%>"
			subject="${lfn:message('hr-ratify:hrRatifyRetire.fdRetirePost')}"
			propertyId="fdRetirePostId" propertyName="fdRetirePostName"
