...
<div id="_fdChangeStaff" valField="fdChangeStaffId"  xform_type="address">
  <xform:address 
			...
			subject="${lfn:message('hr-ratify:hrRatifyChange.fdChangeStaff')}"
			propertyId="fdChangeStaffId" propertyName="fdChangeStaffName"
