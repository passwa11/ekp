...
<div id="_fdTransferEnterDept" valField="fdTransferEnterDeptId" xform_type="address">
  <xform:address 
			...
			subject="${lfn:message('hr-ratify:hrRatifyTransfer.fdTransferEnterDept')}"
			propertyId="fdTransferEnterDeptId" propertyName="fdTransferEnterDeptName"
