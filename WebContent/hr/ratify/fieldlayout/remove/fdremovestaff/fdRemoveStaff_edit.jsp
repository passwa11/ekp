...
<div id="_fdRemoveStaff" valField="fdRemoveStaffId" xform_type="address">
  <xform:address 
			...
			subject="${lfn:message('hr-ratify:hrRatifyRemove.fdRemoveStaff')}"
			propertyId="fdRemoveStaffId" propertyName="fdRemoveStaffName"
