...
<template:include ref="mobile.view" compatibleMode="true" >
	...
	<%-- 		<c:import url="/sys/agenda/mobile/edit_hidden.jsp" charEncoding="UTF-8">
			...
			<template:include file="/sys/lbpmservice/mobile/import/tarbar.jsp" 
							editUrl="/hr/ratify/hr_ratify_positive/hrRatifyPositive.do?method=edit&fdId=${param.fdId }"
	...
	<%-- <c:if test="${'true' eq hrRatifyPositiveForm.fdIsMobileView}"> --%>
		...
		<kmss:ifModuleExist path="/third/ywork/">
			 <c:import url="/third/ywork/ywork_share/yworkDoc_mobile_share.jsp"
				...
				<c:param name="modelName" value="com.landray.kmss.hr.ratify.model.HrRatifyPositive" />
				<c:param name="templateId" value="${ hrRatifyPositiveForm.docTemplateId}" />
				<c:param name="allPath" value="${ hrRatifyPositiveForm.docTemplateName}" />
			</c:import>
		</kmss:ifModuleExist>
	<%-- </c:if> --%>
