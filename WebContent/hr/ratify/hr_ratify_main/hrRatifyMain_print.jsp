...
<template:replace name="title">
	<c:out value="${hrRatifyMainForm.docSubject }"></c:out>
</template:replace>
...
<form name="hrRatifyMainForm" method="post" action="<c:url value="/hr/ratify/hr_ratify_main/hrRatifyMain.do"/>">
<center>
...
<div class="print_title_header" id="subjectDiv">
	<p id="title" class="print_txttitle"><bean:write name="hrRatifyMainForm" property="docSubject" /></p>
	<div class="printDate">
...
<div id="baseDiv">
	...
	<table class="tb_normal" width=100%>
		...
		<tr>
			...
			<td colspan=3><bean:write name="hrRatifyMainForm"
		...
		<tr>
			...
			<td width=35%><html:hidden name="hrRatifyMainForm"
				property="docCreatorId" /> <bean:write name="hrRatifyMainForm"
				property="docCreatorName" /></td>
			<td class="td_normal_title" width=15%><bean:message
				bundle="hr-ratify" key="hrRatifyMain.docNumber" /></td>
			<td width=35%><bean:write name="hrRatifyMainForm"
		...
		<tr>
			...
			<td><bean:write name="hrRatifyMainForm" property="fdDepartmentName"/></td>
			<td class="td_normal_title" width=15%><bean:message
			...
			<tr>
				...
				<td colspan=3>
					<c:import url="/sys/attachment/sys_att_main/sysAttMain_view.jsp" charEncoding="UTF-8">
						...
						<c:param name="formBeanName" value="hrRatifyMainForm" />
