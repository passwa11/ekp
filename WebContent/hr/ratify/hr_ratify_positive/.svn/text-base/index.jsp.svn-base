...
<template:include ref="default.simple" spa="true">
    <template:replace name="body">
	    ...
	    <list:criteria id="criteria2">
		     ...
		     <list:cri-auto modelName="com.landray.kmss.hr.ratify.model.HrRatifyPositive" property="docNumber" />
		     <list:cri-auto modelName="com.landray.kmss.hr.ratify.model.HrRatifyPositive" property="docCreator" />
		     <list:cri-auto modelName="com.landray.kmss.hr.ratify.model.HrRatifyPositive" property="docCreateTime" />
		     <list:cri-auto modelName="com.landray.kmss.hr.ratify.model.HrRatifyPositive" property="docPublishTime" />
	  	</list:criteria>
	  	<!-- 操作 -->
	        ...
	        <div class="lui_list_operation_sort_btn">
				...
				<div class="lui_list_operation_sort_toolbar">
	                <ui:toolbar layout="sys.ui.toolbar.sort" style="float:left">
	                    <list:sort property="hrRatifyPositive.docCreateTime" text="${lfn:message('hr-ratify:hrRatifyMain.docCreateTime')}" group="sort.list" />
	                    <list:sort property="hrRatifyPositive.docPublishTime" text="${lfn:message('hr-ratify:hrRatifyMain.docPublishTime')}" group="sort.list" />
	                </ui:toolbar>
	            </div>
	        </div>
	        ...
	        <div style="float:right">
	            <div style="display: inline-block;vertical-align: middle;">
	                <ui:toolbar count="3">
	                    ...
	                    <kmss:auth requestURL="/hr/ratify/hr_ratify_positive/hrRatifyPositive.do?method=deleteall">
	    ...
	    <list:listview id="listview">
	        <ui:source type="AjaxJson">
	            {url:'/hr/ratify/hr_ratify_positive/hrRatifyPositive.do?method=data'}
	        </ui:source>
	        <!-- 列表视图 -->
	        <list:colTable isDefault="false" rowHref="/hr/ratify/hr_ratify_positive/hrRatifyPositive.do?method=view&fdId=!{fdId}" name="columntable">
	            <list:col-checkbox />
	            <list:col-serial/>
	    ...
	    <script>
	    	var listOption = {
                ...
                jPath: 'positive',
                modelName: 'com.landray.kmss.hr.ratify.model.HrRatifyPositive',
		    ...
		    seajs.use(['lui/jquery', 'lui/dialog', 'lui/topic'],function($, dialog, topic){
					...
					dialog.category('com.landray.kmss.hr.ratify.model.HrRatifyTemplate','docTemplateId','docTemplateName',false,function(rtn){
						if(rtn != false&&rtn != null){
							...
							if(tempId !=null && tempId != ''){
								var url = Com_Parameter.ContextPath+"hr/ratify/hr_ratify_positive/hrRatifyPositive.do?method=add&i.docTemplate="+tempId;
	    		...
	    		window.delDoc = function(draft){
	    			...
	    			var url = Com_Parameter.ContextPath + 'hr/ratify/hr_ratify_positive/hrRatifyPositive.do?method=deleteall';
	    			url = Com_SetUrlParameter(url, 'categoryId', cateId);
	    			url = Com_SetUrlParameter(url, 'nodeType', nodeType); 
	    			if(draft == '0'){
	    				url = Com_Parameter.ContextPath + 'hr/ratify/hr_ratify_positive/hrRatifyPositive.do?method=deleteall&status=10';
	    			}
	    			var config = {
	    				url : url, // 删除数据的URL
	    				data : $.param({"List_Selected":values},true), // 要删除的数据
	    				modelName : "com.landray.kmss.hr.ratify.model.HrRatifyPositive" // 主要是判断此文档是否有部署软删除
	    			};
	    			// 通用删除方法
