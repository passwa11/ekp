...
<div class="print_title_header" id="subjectDiv">
	<p id="title" class="print_txttitle"><bean:write name="hrRatifyPositiveForm" property="docSubject" /></p>
	<div class="printDate">
...
<div id="baseDiv">
	...
	<table class="tb_normal" width=100%>
		...
		<tr>
			...
			<td colspan=3><bean:write name="hrRatifyPositiveForm"
		...
		<tr>
			...
			<td width=35%><html:hidden name="hrRatifyPositiveForm"
				property="docCreatorId" /> <bean:write name="hrRatifyPositiveForm"
				property="docCreatorName" /></td>
			<td class="td_normal_title" width=15%><bean:message
				bundle="hr-ratify" key="hrRatifyMain.docNumber" /></td>
			<td width=35%><bean:write name="hrRatifyPositiveForm"
		...
		<tr>
			...
			<td><bean:write name="hrRatifyPositiveForm" property="fdDepartmentName"/></td>
			<td class="td_normal_title" width=15%><bean:message
...
<div id="infoDiv">
	...
	<c:if test="${hrRatifyPositiveForm.docUseXform == 'false'}">
		<table id="info_content" class="tb_normal" width=100% >
			<tr>
				<td colspan="4">
					${hrRatifyPositiveForm.docContent}
				</td>
			</tr>
			<tr>
