           		...
           		<tr>
                    ...
                    <td width="35%">
                        ...
                        <div id="_xform_docCreatorId" _xform_type="address">
                            <ui:person personId="${hrRatifyPositiveForm.docCreatorId}" personName="${hrRatifyPositiveForm.docCreatorName}" />
                        </div>
                    </td>
                    <td class="td_normal_title" width="15%">
                    ...
                    <td width="35%">
                        ...
                        <div id="_xform_docNumber" _xform_type="text">
                            <c:if test="${not empty hrRatifyPositiveForm.docNumber}">
								<xform:text property="docNumber" showStatus="readOnly" style="width:95%;" />
							</c:if>	
							<c:if test="${empty hrRatifyPositiveForm.docNumber}">
