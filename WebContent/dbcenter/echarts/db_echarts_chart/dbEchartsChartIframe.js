define(["mui/util"],function(util){
	function portletLoad(params,load){
		...
		var html = '<div data-dojo-type="sys/mportal/mobile/extend/Mpiframe" '+
				   "data-dojo-props=\"url:'/dbcenter/echarts/db_echarts_chart/dbEchartsChart.do?method=view&fdId=!{fdId}&showButton=0&scroll=1&LUIID=!{lui.element.id}',name:\'!{name}\',height:\'!{height}\'\"></div>"
