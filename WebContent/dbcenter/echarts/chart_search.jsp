	...
	<template:replace name="content">
		...
		<div style="margin-top:10px">
			<list:criteria id="criteria1">
				...
				<list:cri-auto modelName="com.landray.kmss.dbcenter.echarts.model.DbEchartsChart" 
			...
			<div style="float:left">
				<div style="display: inline-block;vertical-align: middle;">
					<ui:toolbar layout="sys.ui.toolbar.sort" style="float:left" >
					   <list:sort property="docCreateTime" text="${lfn:message('dbcenter-echarts:dbEchartsChart.docCreateTime') }" group="sort.list"></list:sort>
					</ui:toolbar>
				</div>
			</div>
			<div style="float:left;">	
		...
		<list:listview id="listview">
			<ui:source type="AjaxJson">
				{url:'/dbcenter/echarts/db_echarts_chart/dbEchartsChart.do?method=list'}
			</ui:source>
			<%--列表视图--%>
	 	...
	 	<script type="text/javascript">
		 	seajs.use(['lui/jquery', 'lui/dialog', 'lui/topic'], function($, dialog, topic) {
		 		window.addChart = function(fdType){
		 			var url = "/dbcenter/echarts/db_echarts_chart/dbEchartsChart_mode.jsp?fdTemplateId=${JsParam.categoryId}";
					var height = "455";
					var width = "600";
		 		...
		 		window.edit = function(id){
					if(id){
						Com_OpenWindow('db_echarts_chart/dbEchartsChart.do?method=edit&fdId='+id);
					}
			 	};
