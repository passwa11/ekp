...
<c:choose>
	<c:when test="${lbpmApproveModel eq 'right'}">
		<c:import
			url="/kms/knowledge/kms_knowledge_borrow/att_auth/kmsKnowledgeBorrowAttAuth_edit_right.jsp"
			charEncoding="UTF-8">
		</c:import>
	</c:when>
	...
	<c:otherwise>
		<template:include ref="default.edit" sidebar="auto" showQrcode="false">
			...
			<template:replace name="content">
				<html:form action="/kms/knowledge/kms_knowledge_borrow/kmsKnowledgeBorrowAttAuth.do">
								...
								<tr>
									...
									<td  width="85%" colspan="3" id="fdDuration_td">
										...
										<xform:checkbox property="fdDurationLimit" value="${fdDurationLimit}"  onValueChange="fdDurationLimitChange" htmlElementProperties="data-cate='select'" subject="<bean:message bundle='kms-knowledge-borrow' key='kmsKnowledgeBorrow.fdStatus.forever'/>" >
											<xform:simpleDataSource value="true"><bean:message bundle="kms-knowledge-borrow" key="kmsKnowledgeBorrowAttAuth.fdStatus.forever"/></xform:simpleDataSource>
										</xform:checkbox>
