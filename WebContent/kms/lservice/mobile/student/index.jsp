...
<template:include ref="mobile.list">
	<template:replace name="title">
		...
		<c:if test="${param.moduleName==null || param.moduleName==''}">
			${lfn:message('kms-lservice:lservice.index') }-${lfn:message('kms-lservice:lservice.student') }
		</c:if>
	...
	<template:replace name="content">
		...
		<%
			request.setAttribute("jsondatas", UrlsUtil.getMobileUrls(UrlsUtil.getStudentUrls()));
		%>
		...
		<div data-dojo-type="kms/lservice/mobile/js/Role"
			data-dojo-props="role:'student'"></div>
