...
seajs.use(['lui/jquery','lui/dialog','lui/topic','lui/toolbar','lui/util/env','kms/lservice/index/student/calendar/dateUtil'], function($,dialog , topic ,toolbar,env,kmcalendarDateUtil) {
	...
	window.setColor=function(schedule){
		...
		var training="#4285F4";
		var after="#22B77D";
		if(schedule.trainType=="0"){// 未开始
			schedule.color=before;
		}else if(schedule.trainType=="1"){// 进行中
...
<ui:calendar id="calendar" showStatus="view" mode="default" layout="kms.lservice.student.calendar.default">
		<ui:dataformat>
			<ui:source type="AjaxJson">
					{url:'/kms/train/kms_train_main/kmsTrainMain.do?method=getTrainCalendar'}
			</ui:source>
...
<%@ include file="/kms/lservice/index/teacher/calendar/kmsLserviceCalendar_view.jsp"%>
<%@ include file="/kms/lservice/index/teacher/calendar/kmsLserviceCalendar_search.jsp"%>