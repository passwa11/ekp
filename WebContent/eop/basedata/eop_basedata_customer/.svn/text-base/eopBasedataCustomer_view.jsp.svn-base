...
<script type="text/javascript">
    if("${eopBasedataCustomerForm.fdName}" != "") {
        window.document.title = "${eopBasedataCustomerForm.fdName} - ${ lfn:message('eop-basedata:table.eopBasedataCustomer') }";
    }
    Com_IncludeFile("swf_attachment.js", "${KMSS_Parameter_ContextPath}sys/attachment/js/", "js", true);
</script>
<div id="optBarDiv">

    <kmss:auth requestURL="/eop/basedata/eop_basedata_customer/eopBasedataCustomer.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('eopBasedataCustomer.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/eop/basedata/eop_basedata_customer/eopBasedataCustomer.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('eopBasedataCustomer.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
        ...
        <table class="tb_normal" width="100%">
            <tr>
                ...
                <td width="85.0%" colspan="3">
                    ...
                    <div id="_xform_fdCompanyList" _xform_type="dialog">
                        <xform:dialog propertyId="fdCompanyListIds" propertyName="fdCompanyListNames" subject="${lfn:message('eop-basedata:eopBasedataCustomer.fdCompanyList')}" showStatus="view" style="width:95%;">
            ...
            <tr>
                ...
                <td width="35%">
                    ...
                    <div id="_xform_fdChargeId" _xform_type="address">
                        <xform:address propertyId="fdChargeId" propertyName="fdChargeName" orgType="ORG_TYPE_PERSON" showStatus="view" style="width:95%;" />
                    </div>
                </td>
                <td class="td_normal_title" width="15%">
                ...
                <td width="35%">
                    ...
                    <div id="_xform_fdTel" _xform_type="text">
                        <xform:text property="fdTel" showStatus="view" style="width:95%;" />
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="4" width="85.0%">
                    <c:import url="/eop/basedata/eop_basedata_customer_account/eopBasedataCustomerAccount_view.jsp" charEncoding="UTF-8"></c:import>
                </td>
            </tr>
            <tr>
                <td class="td_normal_title" width="15%">
