...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/eop/basedata/eop_basedata_budget_item/eopBasedataBudgetItem.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('eopBasedataBudgetItem.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/eop/basedata/eop_basedata_budget_item/eopBasedataBudgetItem.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('eopBasedataBudgetItem.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
                ...
                <td colspan="3" width="85.0%">
                    <div id="_xform_fdParentId" _xform_type="dialog">
                        <xform:dialog propertyId="fdParentId" propertyName="fdParentName" showStatus="view" style="width:95%;">
                            dialogSelect(false,'eop_basedata_budget_item_com_fdParent','fdParentId','fdParentName');
                        </xform:dialog>
                    </div>
                </td>
            </tr>
