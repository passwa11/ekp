        ...
        <tr KMSS_IsContentRow="1">
            ...
            <td align="center">
                ...
                <div id="_xform_fdAccountList_Form[${vstatus.index}].fdAccountName" _xform_type="text">
                    <xform:text property="fdAccountList_Form[${vstatus.index}].fdAccountName"  required="true" subject="${lfn:message('eop-basedata:eopBasedataCustomerAccount.fdAccountName')}" validators=" maxLength(200)" style="width:85%;" />
                </div>
            </td>
            <td align="center">
                <%-- 开户行--%>
                <div id="_xform_fdAccountList_Form[${vstatus.index}].fdBankName" _xform_type="text">
                    <xform:text property="fdAccountList_Form[${vstatus.index}].fdBankName"  required="true" subject="${lfn:message('eop-basedata:eopBasedataCustomerAccount.fdBankName')}" validators=" maxLength(300)" style="width:85%;" />
                </div>
            </td>
            <td align="center">
                <%-- 联行号--%>
                <div id="_xform_fdAccountList_Form[${vstatus.index}].fdBankNo" _xform_type="text">
                    <xform:text property="fdAccountList_Form[${vstatus.index}].fdBankNo"  subject="${lfn:message('eop-basedata:eopBasedataCustomerAccount.fdBankNo')}" validators=" maxLength(20)" style="width:85%;" />
                </div>
            </td>
            <td align="center">
                <%-- 账号--%>
                <div id="_xform_fdAccountList_Form[${vstatus.index}].fdBankAccount" _xform_type="text">
                    <xform:text property="fdAccountList_Form[${vstatus.index}].fdBankAccount"  required="true" subject="${lfn:message('eop-basedata:eopBasedataCustomerAccount.fdBankAccount')}" validators=" maxLength(200)" style="width:85%;" />
                </div>
            </td>
            ...
            <td align="center">
                ...
                <div id="_xform_fdAccountList_Form[${vstatus.index}].fdBankSwift" _xform_type="text">
                    <xform:text property="fdAccountList_Form[${vstatus.index}].fdBankSwift"  subject="${lfn:message('eop-basedata:eopBasedataCustomerAccount.fdBankSwift')}" validators=" maxLength(50)" style="width:85%;" />
            ...
            <td align="center">
                ...
                <div id="_xform_fdAccountList_Form[${vstatus.index}].fdReceiveCompany" _xform_type="text">
                    <xform:text property="fdAccountList_Form[${vstatus.index}].fdReceiveCompany"  subject="${lfn:message('eop-basedata:eopBasedataCustomerAccount.fdReceiveCompany')}" validators=" maxLength(200)" style="width:85%;" />
                    <span class="txtstrong" style="display:none;">*</span>
                </div>
            </td>
            <td align="center">
                ...
                <div id="_xform_fdAccountList_Form[${vstatus.index}].fdReceiveBankName" _xform_type="text">
                    <xform:text property="fdAccountList_Form[${vstatus.index}].fdReceiveBankName"  subject="${lfn:message('eop-basedata:eopBasedataCustomerAccount.fdReceiveBankName')}" validators=" maxLength(200)" style="width:85%;" />
                    <span class="txtstrong" style="display:none;">*</span>
                </div>
            </td>
            <td align="center">
                ...
                <div id="_xform_fdAccountList_Form[${vstatus.index}].fdReceiveBankAddress" _xform_type="text">
                    <xform:text property="fdAccountList_Form[${vstatus.index}].fdReceiveBankAddress"  subject="${lfn:message('eop-basedata:eopBasedataCustomerAccount.fdReceiveBankAddress')}" validators=" maxLength(200)" style="width:85%;" />
                    <span class="txtstrong" style="display:none;">*</span>
                </div>
            </td>
            <td align="center">
                ...
                <div id="_xform_fdAccountList_Form[${vstatus.index}].fdInfo" _xform_type="text">
                    <xform:text property="fdAccountList_Form[${vstatus.index}].fdInfo"  subject="${lfn:message('eop-basedata:eopBasedataCustomerAccount.fdInfo')}" validators=" maxLength(200)" style="width:85%;" />
                </div>
            </td>
        </tr>
    </c:forEach>
