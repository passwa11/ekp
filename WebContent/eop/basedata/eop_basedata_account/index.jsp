...
<template:include ref="default.simple4list">
    <template:replace name="title">
        <c:out value="${ lfn:message('eop-basedata:table.eopBasedataAccount') }" />
    </template:replace>
    <template:replace name="content">
        <ui:tabpanel id="eopBasedataAccountPanel" layout="sys.ui.tabpanel.list" cfg-router="true">
        <ui:content id="eopBasedataAccountContent" title="${ lfn:message('eop-basedata:table.eopBasedataAccount') }">
