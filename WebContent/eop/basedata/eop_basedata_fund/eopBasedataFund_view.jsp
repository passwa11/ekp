...
<script type="text/javascript">
    if("${eopBasedataFundForm.fdName}" != "") {
        window.document.title = "${eopBasedataFundForm.fdName} - ${ lfn:message('eop-basedata:table.eopBasedataFund') }";
    }
    Com_IncludeFile("swf_attachment.js", "${KMSS_Parameter_ContextPath}sys/attachment/js/", "js", true);
</script>
<div id="optBarDiv">

    <kmss:auth requestURL="/eop/basedata/eop_basedata_fund/eopBasedataFund.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('eopBasedataFund.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/eop/basedata/eop_basedata_fund/eopBasedataFund.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('eopBasedataFund.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
...
<center>
            ...
            <tr>
                ...
                <td width="35%">
                    ...
                    <div id="_xform_fdAccountingName" _xform_type="text">
                        <xform:text property="fdAccountingName" showStatus="view" style="width:95%;" />
                    </div>
                </td>
                <td class="td_normal_title" width="15%">
                ...
                <td width="35%">
                    ...
                    <div id="_xform_fdAccountingCode" _xform_type="text">
                        <xform:text property="fdAccountingCode" showStatus="view" style="width:95%;" />
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <input type="hidden" name="fdId" value="${eopBasedataFundForm.fdId}" />
</center>
<script>
    var formInitData = {
