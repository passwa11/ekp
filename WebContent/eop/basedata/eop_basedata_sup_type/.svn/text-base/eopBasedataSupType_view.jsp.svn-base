...
<script type="text/javascript">
    if("${eopBasedataSupTypeForm.fdName}" != "") {
        window.document.title = "${eopBasedataSupTypeForm.fdName} - ${ lfn:message('eop-basedata:table.eopBasedataSupType') }";
    }
    Com_IncludeFile("swf_attachment.js", "${KMSS_Parameter_ContextPath}sys/attachment/js/", "js", true);
</script>
<div id="optBarDiv">

    <kmss:auth requestURL="/eop/basedata/eop_basedata_sup_type/eopBasedataSupType.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('eopBasedataSupType.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/eop/basedata/eop_basedata_sup_type/eopBasedataSupType.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('eopBasedataSupType.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
