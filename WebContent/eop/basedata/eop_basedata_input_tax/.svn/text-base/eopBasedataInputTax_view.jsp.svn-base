...
<script type="text/javascript">
        window.document.title = "${ lfn:message('eop-basedata:table.eopBasedataInputTax') }";
    Com_IncludeFile("swf_attachment.js", "${KMSS_Parameter_ContextPath}sys/attachment/js/", "js", true);
</script>
<div id="optBarDiv">

    <kmss:auth requestURL="/eop/basedata/eop_basedata_input_tax/eopBasedataInputTax.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('eopBasedataInputTax.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/eop/basedata/eop_basedata_input_tax/eopBasedataInputTax.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('eopBasedataInputTax.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
            ...
            <tr>
                ...
                <td width="35%">
                    ...
                    <div id="_xform_fdCompanyId" _xform_type="dialog">
                        <xform:dialog propertyId="fdCompanyListIds" propertyName="fdCompanyListNames" subject="${lfn:message('eop-basedata:eopBasedataInputTax.fdCompanyList')}" showStatus="view" style="width:95%;">
