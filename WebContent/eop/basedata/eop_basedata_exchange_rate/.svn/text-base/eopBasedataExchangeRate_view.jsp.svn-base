...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/eop/basedata/eop_basedata_exchange_rate/eopBasedataExchangeRate.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('eopBasedataExchangeRate.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/eop/basedata/eop_basedata_exchange_rate/eopBasedataExchangeRate.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('eopBasedataExchangeRate.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
        	...
        	<tr>
                ...
                <td colspan="3" width="85.0%">
                    <div id="_xform_fdCompanyId" _xform_type="dialog">
                    	<xform:dialog propertyId="fdCompanyListIds" propertyName="fdCompanyListNames" subject="${lfn:message('eop-basedata:eopBasedataExchangeRate.fdCompanyList')}" showStatus="view" style="width:95%;">
                            dialogSelect(false,'eop_basedata_company_fdCompany','fdCompanyListIds','fdCompanyListNames');
                        </xform:dialog>
                    </div>
                    </a>
                </td>
            ...
            <tr>
                ...
                <td colspan="3" width="85.0%">
                    <div id="_xform_fdRate" _xform_type="text">
                    	<kmss:showNumber value="${eopBasedataExchangeRateForm.fdRate }" pattern="0.0#####"></kmss:showNumber>
                    </div>
                </td>
            </tr>
            <tr>
