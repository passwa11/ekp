...
<script type="text/javascript">
    if("${eopBasedataSupplierForm.method_GET}" == 'edit') {
        window.document.title = "${ lfn:message('button.edit') } - ${ lfn:message('eop-basedata:table.eopBasedataSupplier') }";
    }
    if("${eopBasedataSupplierForm.method_GET}" == 'add') {
        window.document.title = "${ lfn:message('button.add') } - ${ lfn:message('eop-basedata:table.eopBasedataSupplier') }";
    }
    var formInitData = {
    ...
    var messageInfo = {
        ...
        'fdContactPerson': '${lfn:escapeJs(lfn:message("eop-basedata:table.eopBasedataContact"))}'
    };
    var initData = {
    ...
    Com_IncludeFile("form_option.js", "${LUI_ContextPath}/eop/basedata/eop_basedata_supplier/", 'js', true);
    Com_IncludeFile("config_fssc_edit.js", "${LUI_ContextPath}/eop/basedata/resource/js/", 'js', true);
    Com_IncludeFile("swf_attachment.js", "${KMSS_Parameter_ContextPath}sys/attachment/js/", "js", true);
    Com_IncludeFile("eopBasedataSupplier.js", "${LUI_ContextPath}/eop/basedata/eop_basedata_supplier/", "js", true);

    //移植自/resource/jsp/edit_top.jsp，注释该jsp
...
<html:form action="/eop/basedata/eop_basedata_supplier/eopBasedataSupplier.do">
    <div id="optBarDiv">
        <c:choose>
            <c:when test="${eopBasedataSupplierForm.method_GET=='edit'}">
                <input type="button" value="${ lfn:message('button.update') }" onclick="if(validateDetail()){Com_Submit(document.eopBasedataSupplierForm, 'update');}">
            </c:when>
            <c:when test="${eopBasedataSupplierForm.method_GET=='add'}">
                <input type="button" value="${ lfn:message('button.save') }" onclick="if(validateDetail()){Com_Submit(document.eopBasedataSupplierForm, 'save');}">
            </c:when>
        </c:choose>
                ...
                <tr>
                    ...
                    <td width="85.0%" colspan="3">
                        ...
                        <div id="_xform_fdCompanyList" _xform_type="dialog">
                            <xform:dialog propertyId="fdCompanyListIds" propertyName="fdCompanyListNames" subject="${lfn:message('eop-basedata:eopBasedataSupplier.fdCompanyList')}" showStatus="edit" style="width:95%;">
                ...
                <tr>
                    ...
                    <td width="35%">
                        ...
                        <div id="_xform_fdCreditCode" _xform_type="text">
                            <xform:text property="fdCreditCode" validators="checkFdCreditCode" showStatus="edit" style="width:95%;" />
                        </div>
                    </td>
                    <td class="td_normal_title" width="15%">
                    ...
                    <td width="35%">
                        ...
                        <div id="_xform_fdCodeValidityPeriod" _xform_type="datetime">
                            <xform:datetime property="fdCodeValidityPeriod" showStatus="edit" required="true" subject="${lfn:message('eop-basedata:eopBasedataSupplier.fdCodeValidityPeriod')}" dateTimeType="date" style="width:95%;" />
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="35%">
                        ...
                        <div id="_xform_fdEstablishDate" _xform_type="datetime">
                            <xform:datetime property="fdEstablishDate" showStatus="edit" subject="${lfn:message('eop-basedata:eopBasedataSupplier.fdEstablishDate')}" dateTimeType="date" style="width:95%;" />
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            <table class="tb_normal" width="100%">
                <tr>
                    ...
                    <td width="35%">
                        ...
                        <div id="_xform_fdBankAccountName" _xform_type="text">
                            <xform:text property="fdBankAccountName" showStatus="edit" style="width:95%;" />
                        </div>
                    </td>
                    <td class="td_normal_title" width="15%">
                ...
                <tr>
                    <td colspan="4" width="85.0%">
                        <c:import url="/eop/basedata/eop_basedata_supplier_account/eopBasedataSupplierAccount_edit.jsp" charEncoding="UTF-8"></c:import>
                    </td>
                </tr>
            </table>
            <div class="lui_paragraph_title">
    ...
    <script>
        ...
        _validation.addValidator("checkFdCreditCode", "该统一社会信用代码已存在！", function (v, e, o) {
            var flag = false;
            var data = {
                fdId: '${param.fdId}',
                fdCreditCode: $('[name=fdCreditCode]').val()
            };
            $.ajax({
                url: '${LUI_ContextPath}/eop/basedata/eop_basedata_supplier/eopBasedataSupplier.do?method=checkFdCreditCode',
                data: data,
                dataType: 'json',
                type: 'POST',
                async: false,
