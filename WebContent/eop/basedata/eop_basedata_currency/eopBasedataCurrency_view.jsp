...
<script type="text/javascript">
    if("${eopBasedataCurrencyForm.fdName}" != "") {
        window.document.title = "${eopBasedataCurrencyForm.fdName} - ${ lfn:message('eop-basedata:table.eopBasedataCurrency') }";
    }
    Com_IncludeFile("swf_attachment.js", "${KMSS_Parameter_ContextPath}sys/attachment/js/", "js", true);
</script>
<div id="optBarDiv">

    <kmss:auth requestURL="/eop/basedata/eop_basedata_currency/eopBasedataCurrency.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('eopBasedataCurrency.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/eop/basedata/eop_basedata_currency/eopBasedataCurrency.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('eopBasedataCurrency.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
            ...
            <tr>
                ...
                <td width="35%">
                    ...
                    <div id="_xform_fdEnglishName" _xform_type="text">
                        <xform:text property="fdEnglishName" showStatus="view" style="width:95%;" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td width="35%">
                    ...
                    <div id="_xform_fdSymbol" _xform_type="radio">
                        <xform:text property="fdSymbol" validators="maxLen(20)" showStatus="view" />
                    </div>
                </td>
            </tr>
             <tr>
