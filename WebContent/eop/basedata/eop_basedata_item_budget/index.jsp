    ...
    <template:replace name="content">
        <div style="margin:5px 10px;">
            ...
            <list:criteria id="criteria1">
                <list:cri-criterion title="${lfn:message('eop-basedata:eopBasedataItemBudget.fdCompanyList')}" key="fdCompanyName"  expand="true"  multi="false">
					<list:box-select>
		                <list:item-select type="lui/criteria/criterion_input!TextInput">
		                    <ui:source type="Static">
		                        [{placeholder:'${lfn:message('eop-basedata:eopBasedataItemBudget.fdCompanyList')}'}]
		                    </ui:source>
		                </list:item-select>
		            </list:box-select>
				</list:cri-criterion>
				<list:cri-criterion title="${lfn:message('eop-basedata:eopBasedataItemBudget.fdIsAvailable')}" key="fdIsAvailable">
					<list:box-select>
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:'/eop/basedata/eop_basedata_item_budget/eopBasedataItemBudget.do?method=data&fdCompanyId=${param.fdCompanyId }'}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable isDefault="false" rowHref="/eop/basedata/eop_basedata_item_budget/eopBasedataItemBudget.do?method=view&fdId=!{fdId}" name="columntable">
                    <list:col-checkbox />
                    <list:col-serial/>
                    <list:col-auto props="fdCompanyName;fdItems;fdCategory;fdOrgs;fdIsAvailable.name;operations" /></list:colTable>
            </list:listview>
            <!-- 翻页 -->
            <list:paging />
        </div>
