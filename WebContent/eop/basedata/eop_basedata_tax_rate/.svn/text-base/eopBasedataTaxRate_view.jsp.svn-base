...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/eop/basedata/eop_basedata_tax_rate/eopBasedataTaxRate.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('eopBasedataTaxRate.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/eop/basedata/eop_basedata_tax_rate/eopBasedataTaxRate.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('eopBasedataTaxRate.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
