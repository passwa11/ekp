...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/eop/basedata/eop_basedata_accounts/eopBasedataAccounts.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('eopBasedataAccounts.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <%-- 是否开启下发  选择否 --%>
    <fssc:switchOff property="fdIsOpenIssued">
    <kmss:auth requestURL="/eop/basedata/eop_basedata_accounts/eopBasedataAccounts.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('eopBasedataAccounts.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
    </fssc:switchOff>
            ...
            <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        <div id="_xform_fdCompanyId" _xform_type="dialog">
                        	<xform:dialog propertyId="fdCompanyListIds" propertyName="fdCompanyListNames" subject="${lfn:message('eop-basedata:eopBasedataAccounts.fdCompanyList')}"  showStatus="view" style="width:95%;">
                ...
                <td colspan="3" width="85.0%">
                    <div id="_xform_fdParentId" _xform_type="dialog">
                        <xform:dialog propertyId="fdParentId" propertyName="fdParentName" showStatus="view" style="width:95%;">
                            dialogSelect(false,'eop_basedata_accounts_fdAccount','fdParentId','fdParentName');
                        </xform:dialog>
                    </div>
                </td>
            </tr>
