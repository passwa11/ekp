...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/eop/basedata/eop_basedata_level/eopBasedataLevel.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('eopBasedataLevel.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/eop/basedata/eop_basedata_level/eopBasedataLevel.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('eopBasedataLevel.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
        ...
        <table class="tb_normal" width="100%">
            <tr>
                ...
                <td colspan="3" width="85.0%">
                    <xform:dialog propertyId="fdCompanyListIds" propertyName="fdCompanyListNames" subject="${lfn:message('eop-basedata:eopBasedataLevel.fdCompany')}" showStatus="view" style="width:95%;">
                        dialogSelect(true,'eop_basedata_company_fdCompany','fdCompanyListIds','fdCompanyListIds');
                    </xform:dialog>
                </td>
            </tr>
            <tr>
