...
<script type="text/javascript">
    if("${eopBasedataCountryForm.fdName}" != "") {
        window.document.title = "${eopBasedataCountryForm.fdName} - ${ lfn:message('eop-basedata:table.eopBasedataCountry') }";
    }
    Com_IncludeFile("swf_attachment.js", "${KMSS_Parameter_ContextPath}sys/attachment/js/", "js", true);
</script>
<div id="optBarDiv">

    <kmss:auth requestURL="/eop/basedata/eop_basedata_country/eopBasedataCountry.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('eopBasedataCountry.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/eop/basedata/eop_basedata_country/eopBasedataCountry.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('eopBasedataCountry.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
...
<center>
        ...
        <table class="tb_normal" width="100%">
            <tr>
                ...
                <td colspan="3" width="85.0%">
                    <%-- 所属公司--%>
                    <div id="_xform_fdCompanyIds" _xform_type="dialog">
    ...
    <input type="hidden" name="fdId" value="${eopBasedataCountryForm.fdId}" />
</center>
<script>
    var formInitData = {
