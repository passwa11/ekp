...
<list:data>
    <list:data-columns var="eopBasedataExpenseItem" list="${queryPage.list}" varIndex="status">
        ...
        <list:data-column property="fdName" title="${lfn:message('eop-basedata:eopBasedataExpenseItem.fdName')}"  escape="false"/>
        <list:data-column property="fdCode" title="${lfn:message('eop-basedata:eopBasedataExpenseItem.fdCode')}"  escape="false"/>
        <list:data-column col="fdDayCalType">
            <c:out value="${eopBasedataExpenseItem.fdDayCalType}" />
        </list:data-column>
