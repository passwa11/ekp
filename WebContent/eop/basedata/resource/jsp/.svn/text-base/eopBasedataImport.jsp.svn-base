...
<template:include ref="default.dialog" sidebar="auto">
	<template:replace name="content">
		<html:form action="/eop/basedata/eop_basedata_business/eopBasedataBusiness.do" method="post" enctype="multipart/form-data">
		<script>
		</script>
		...
		<script>
			seajs.use(['lui/dialog'],function(dialog){
				...
				window.download = function(){
					window.open('${LUI_ContextPath}/eop/basedata/eop_basedata_business/eopBasedataBusiness.do?method=downloadTemplate&modelName=${param.modelName}');
				}
			});
		</script>
		</html:form>
