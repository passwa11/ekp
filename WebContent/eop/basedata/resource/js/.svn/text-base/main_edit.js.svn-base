Com_AddEventListener(window,'load',function(){
	seajs.use(['lui/jquery','lui/dialog','lui/dialog_common','lui/util/str',initData.contextPath+'/eop/basedata/resource/js/dialog_common'], function($, dialog, dialogCommon,strutil,dialogCommonEopBasedata){
		...
		window.dialogSelect=function(mul, key, idField, nameField,targetWin,extendParam,action){
			...
			if(idField.indexOf('.')>-1 && window.DocListFunc_GetParentByTagName){
	    		...
	    		if(dialogCfg){
					...
					dialogCommonEopBasedata.dialogSelect(dialogCfg.modelName,
