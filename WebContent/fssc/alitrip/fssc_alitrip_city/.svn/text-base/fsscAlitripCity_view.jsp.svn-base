...
<script type="text/javascript">
    if("${fsscAlitripCityForm.fdName}" != "") {
        window.document.title = "${fsscAlitripCityForm.fdName} - ${ lfn:message('fssc-alitrip:table.fsscAlitripCity') }";
    }
    Com_IncludeFile("swf_attachment.js", "${KMSS_Parameter_ContextPath}sys/attachment/js/", "js", true);
</script>
<div id="optBarDiv">

    <kmss:auth requestURL="/fssc/alitrip/fssc_alitrip_city/fsscAlitripCity.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('fsscAlitripCity.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/fssc/alitrip/fssc_alitrip_city/fsscAlitripCity.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('fsscAlitripCity.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
            ...
            <tr>
                ...
                <td width="85%">
                    ...
                    <div id="_xform_fdOwer" _xform_type="select">
                        <xform:select property="fdOwer" htmlElementProperties="id='fdOwer'" showStatus="view">
