...
<%@ include file="/fssc/alitrip/resource/jsp/jshead.jsp"%>
...
<script type="text/javascript">
    if("${fsscAlitripMappingForm.method_GET}" == 'edit') {
        window.document.title = "${ lfn:message('button.edit') } - ${ lfn:message('fssc-alitrip:table.fsscAlitripMapping') }";
    }
    if("${fsscAlitripMappingForm.method_GET}" == 'add') {
        window.document.title = "${ lfn:message('button.add') } - ${ lfn:message('fssc-alitrip:table.fsscAlitripMapping') }";
    }
    ...
    Com_IncludeFile("form_option.js", "${LUI_ContextPath}/fssc/alitrip/fssc_alitrip_mapping/", 'js', true);
    Com_IncludeFile("config_edit.js", "${LUI_ContextPath}/fssc/alitrip/resource/js/", 'js', true);
    Com_IncludeFile("swf_attachment.js", "${KMSS_Parameter_ContextPath}sys/attachment/js/", "js", true);
	Com_IncludeFile("calendar.js");
	Com_IncludeFile("docutil.js|dialog.js|data.js");
    ...
    function selectFormula(id,name){
		var tempId = $("input[name='fdCateId']").val();
		if(typeof tempId=="undefined" ||null==tempId||""==tempId){
            ...
            Formula_Dialog(id, name, Formula_GetVarInfoByModelName_New($("input[name='fdModelName']").val(),tempId),'String');
		}
	}
	...
	function Formula_GetVarInfoByModelName_New(modelName,tempId){
		...
		var fdModelCate = $("input[name='fdModelCate']").val();
		var sysObj = new KMSSData().AddBeanData("sysFormulaDictVarTree&authCurrent=true&modelName="+modelName).GetHashMapArray();
		var extObj = new KMSSData().AddBeanData("fsscAlitripDictExtendModelService&authCurrent=true&tempType=template&tempId="+tempId+"&fdKey="+fdKey+"&fdModelName="+fdModelCate).GetHashMapArray();
...
<div id="optBarDiv">
        <c:choose>
            <c:when test="${fsscAlitripMappingForm.method_GET=='edit'}">
                <input type="button" value="${ lfn:message('button.update') }" onclick="Com_Submit(document.fsscAlitripMappingForm, 'update');">
            </c:when>
            <c:when test="${fsscAlitripMappingForm.method_GET=='add'}">
                <input type="button" value="${ lfn:message('button.save') }" onclick="Com_Submit(document.fsscAlitripMappingForm, 'save');">
            </c:when>
        </c:choose>
        <input type="button" value="${ lfn:message('button.close') }" onclick="Com_CloseWindow();">
    </div>
<html:form action="/fssc/alitrip/fssc_alitrip_mapping/fsscAlitripMapping.do">
	            ...
	            <tr>
	                    ...
	                    <td width="85%">
	                        ...
	                        <div id="_xform_fdModelIdId" _xform_type="dialog">
	                            <xform:dialog propertyId="fdModelIdId" propertyName="fdModelIdName" showStatus="edit" required="true" subject="${lfn:message('fssc-alitrip:fsscAlitripMapping.fdModelId')}" style="width:95%;">
	                 ...
	                 <tr>
	                    ...
	                    <td width="85%">
	                        ...
	                        <div id="_xform_fdCateId" style="display: none;" _xform_type="dialog">
	                            ...
	                            <xform:dialog propertyId="fdCateId" propertyName="fdCateName" showStatus="edit" style="width:95%;">
	                ...
	                <tr>
	                    ...
	                    <td width="85%">
	                        ...
	                        <div id="_xform_fdCompanyIdText" _xform_type="text">
	                            <xform:dialog propertyId="fdCompanyId" propertyName="fdCompanyIdText" idValue="${fsscAlitripMappingForm.fdCompanyId}" nameValue="${fsscAlitripMappingForm.fdCompanyIdText}" required="true" showStatus="edit" style="width:95%;">
	                    ...
	                    <td width="85%">
	                        <%-- 企业名称--%>
	                         <div id="_xform_corpName" _xform_type="text">
	                            <xform:dialog propertyId="corpName" propertyName="corpNameText" idValue="${fsscAlitripMappingForm.corpName}" nameValue="${fsscAlitripMappingForm.corpNameText}"  showStatus="edit" style="width:95%;">
	                ...
	                <tr>
	                    ...
	                    <td width="85%">
	                        ...
	                        <div id="_xform_tripTitle" _xform_type="text">
	                            <xform:dialog propertyId="tripTitle" propertyName="tripTitleText" idValue="${fsscAlitripMappingForm.tripTitle}" nameValue="${fsscAlitripMappingForm.tripTitleText}" required="true" showStatus="edit" style="width:95%;">
	                ...
	                <tr>
	                    ...
	                    <td width="85%">
	                        ...
	                        <div id="_xform_applyId" _xform_type="text">
	                            <xform:dialog propertyId="applyId" propertyName="applyIdText" idValue="${fsscAlitripMappingForm.applyId}" nameValue="${fsscAlitripMappingForm.applyIdText}" required="true" showStatus="edit" style="width:95%;">
	                ...
	                <tr>
	                    ...
	                    <td width="85%">
	                        ...
	                        <div id="_xform_tripDay" _xform_type="text">
	                            <xform:dialog propertyId="tripDay" propertyName="tripDayText" idValue="${fsscAlitripMappingForm.tripDay}" nameValue="${fsscAlitripMappingForm.tripDayText}" required="true" showStatus="edit" style="width:95%;">
	                    ...
	                    <td width="85%">
	                        <%-- 用户id--%>
	                         <div id="_xform_userId" _xform_type="text">
	                            <xform:dialog propertyId="userIsd" propertyName="userIsdText" idValue="${fsscAlitripMappingForm.userIsd}" nameValue="${fsscAlitripMappingForm.userIsdText}" required="true" showStatus="edit" style="width:95%;">
	                    ...
	                    <td width="85%">
	                        <%-- 用户名称--%>
	                         <div id="_xform_userName" _xform_type="text">
	                            <xform:dialog propertyId="userName" propertyName="userNameText" idValue="${fsscAlitripMappingForm.userName}" nameValue="${fsscAlitripMappingForm.userNameText}"  showStatus="edit" style="width:95%;">
	                    ...
	                    <td width="85%">
	                        <%-- 部门id--%>
	                         <div id="_xform_departId" _xform_type="text">
	                            <xform:dialog propertyId="departIsd" propertyName="departIsdText" idValue="${fsscAlitripMappingForm.departIsd}" nameValue="${fsscAlitripMappingForm.departIsdText}" required="true" showStatus="edit" style="width:95%;">
	                ...
	                <tr>
	                    ...
	                    <td width="85%">
	                        ...
	                        <div id="_xform_departName" _xform_type="text">
	                            <xform:dialog propertyId="departName" propertyName="departNameText" idValue="${fsscAlitripMappingForm.departName}" nameValue="${fsscAlitripMappingForm.departNameText}" showStatus="edit" style="width:95%;">
	                    ...
	                    <td width="85%">
	                        <%-- 出差理由--%>
	                         <div id="_xform_tripCause" _xform_type="text">
	                            <xform:dialog propertyId="tripCause" propertyName="tripCauseText" idValue="${fsscAlitripMappingForm.tripCause}" nameValue="${fsscAlitripMappingForm.tripCauseText}" required="true" showStatus="edit" style="width:95%;">
	                ...
	                <tr>
	                    ...
	                    <td width="85%">
	                        ...
	                        <div id="_xform_status" _xform_type="text">
	                            <xform:dialog propertyId="status" propertyName="statusText" idValue="${fsscAlitripMappingForm.status}" nameValue="${fsscAlitripMappingForm.statusText}" required="true" showStatus="edit" style="width:95%;">
	                    ...
	                    <td width="85%">
	                        报表展示用的审批单id
	                         <div id="_xform_applyShowId" _xform_type="text">
	                            <xform:dialog propertyId="applyShowId" propertyName="applyShowIdText" idValue="${fsscAlitripMappingForm.applyShowId}" nameValue="${fsscAlitripMappingForm.applyShowIdText}"  showStatus="edit" style="width:95%;">
	                    ...
	                    <td width="85%">
	                        <%-- 出行人列表--%>
	                         <div id="_xform_travelerList" _xform_type="text">
	                            <xform:dialog propertyId="travelerList" propertyName="travelerListText" idValue="${fsscAlitripMappingForm.travelerList}" nameValue="${fsscAlitripMappingForm.travelerListText}"  showStatus="edit" style="width:95%;">
          		 	 ...
          		 	 <table class="tb_normal" width="100%">
		                    ...
		                    <td width="85%">
		                        ...
		                        <div id="_xform_fdIsTrue" _xform_type="text">
		                            <xform:dialog propertyId="fdIsTrue" propertyName="fdIsTrueText" idValue="${fsscAlitripMappingForm.fdIsTrue}" nameValue="${fsscAlitripMappingForm.fdIsTrueText}" required="true" showStatus="edit" style="width:95%;">
		                ...
		                <tr>
		                    ...
		                    <td width="85%">
		                        ...
		                        <div id="_xform_fdListItem" _xform_type="text">
		                            <xform:dialog propertyId="fdListItem" propertyName="fdListItemText" idValue="${fsscAlitripMappingForm.fdListItem}" nameValue="${fsscAlitripMappingForm.fdListItemText}" required="true" showStatus="edit" style="width:95%;">
		                ...
		                <%-- <tr>
		                    ...
		                    <td width="85%">
		                        ...
		                        <div id="_xform_fdItemList" _xform_type="text">
		                            <xform:dialog propertyId="fdItemList" propertyName="fdItemListText" idValue="${fsscAlitripMappingForm.fdItemList}" nameValue="${fsscAlitripMappingForm.fdItemListText}" required="true" showStatus="edit" style="width:95%;">
		                ...
		                <tr>
		                    ...
		                    <td width="85%">
		                        ...
		                        <div id="_xform_arrCity" _xform_type="text">
		                            <xform:dialog propertyId="arrCity" propertyName="arrCityText" idValue="${fsscAlitripMappingForm.arrCity}" nameValue="${fsscAlitripMappingForm.arrCityText}" required="true" showStatus="edit" style="width:95%;">
		                    ...
		                    <td width="85%">
		                        <%-- 出发城市--%>
		                         <div id="_xform_depCity" _xform_type="text">
		                            <xform:dialog propertyId="depCity" propertyName="depCityText" idValue="${fsscAlitripMappingForm.depCity}" nameValue="${fsscAlitripMappingForm.depCityText}" required="true" showStatus="edit" style="width:95%;">
		                    ...
		                    <td width="85%">
		                        <%-- 交通方式--%>
		                         <div id="_xform_trafficType" _xform_type="text">
		                            <xform:dialog propertyId="trafficType" propertyName="trafficTypeText" idValue="${fsscAlitripMappingForm.trafficType}" nameValue="${fsscAlitripMappingForm.trafficTypeText}" required="true" showStatus="edit" style="width:95%;">
		                ...
		                <%-- <tr>
		                    ...
		                    <td width="85%">
		                        ...
		                        <div id="_xform_itineraryId" _xform_type="text">
		                            <xform:dialog propertyId="itineraryId" propertyName="itineraryIdText" idValue="${fsscAlitripMappingForm.itineraryId}" nameValue="${fsscAlitripMappingForm.itineraryIdText}" required="true" showStatus="edit" style="width:95%;">
		                    ...
		                    <td width="85%">
		                        <%-- 行程类型--%>
		                         <div id="_xform_tripWay" _xform_type="text">
		                            <xform:dialog propertyId="tripWay" propertyName="tripWayText" idValue="${fsscAlitripMappingForm.tripWay}" nameValue="${fsscAlitripMappingForm.tripWayText}" required="true" showStatus="edit" style="width:95%;">
		                    ...
		                    <td width="85%">
		                        <%-- 到达日期--%>
		                         <div id="_xform_arrDate" _xform_type="text">
		                            <xform:dialog propertyId="arrDate" propertyName="arrDateText" idValue="${fsscAlitripMappingForm.arrDate}" nameValue="${fsscAlitripMappingForm.arrDateText}" required="true" showStatus="edit" style="width:95%;">
		                    ...
		                    <td width="85%">
		                        <%-- 出发日期--%>
		                         <div id="_xform_depDate" _xform_type="text">
		                            <xform:dialog propertyId="depDate" propertyName="depDateText" idValue="${fsscAlitripMappingForm.depDate}" nameValue="${fsscAlitripMappingForm.depDateText}" required="true" showStatus="edit" style="width:95%;">
		                    ...
		                    <td width="85%">
		                       <%--  发票id --%>
		                        <div id="_xform_invoiceId" _xform_type="text">
		                            <xform:dialog propertyId="invoiceIsd" propertyName="invoiceIsdText" idValue="${fsscAlitripMappingForm.invoiceIsd}" nameValue="${fsscAlitripMappingForm.invoiceIsdText}" required="true" showStatus="edit" style="width:95%;">
		                    ...
		                    <td width="85%">
		                       <%--  商旅成本中心id --%>
		                         <div id="_xform_costCenterId" _xform_type="text">
		                            <xform:dialog propertyId="costCenterIsd" propertyName="costCenterIsdText" idValue="${fsscAlitripMappingForm.costCenterIsd}" nameValue="${fsscAlitripMappingForm.costCenterIsdText}"  showStatus="edit" style="width:95%;">
		                    ...
		                    <td width="85%">
		                        出发城市编码
		                         <div id="_xform_depCityCode" _xform_type="text">
		                            <xform:dialog propertyId="depCityCode" propertyName="depCityCodeText" idValue="${fsscAlitripMappingForm.depCityCode}" nameValue="${fsscAlitripMappingForm.depCityCodeText}"  showStatus="edit" style="width:95%;">
		                    ...
		                    <td width="85%">
		                        到达城市编码
		                         <div id="_xform_arrCityCode" _xform_type="text">
		                            <xform:dialog propertyId="arrCityCode" propertyName="arrCityCodeText" idValue="${fsscAlitripMappingForm.arrCityCode}" nameValue="${fsscAlitripMappingForm.arrCityCodeText}"  showStatus="edit" style="width:95%;">
		                ...
		                <%-- <tr>
		                    ...
		                    <td width="85%">
		                        ...
		                        <div id="_xform_thirdpartCostCenterId" _xform_type="text">
		                            <xform:dialog propertyId="thirdpartCostCenterId" propertyName="thirdpartCostCenterIdText" idValue="${fsscAlitripMappingForm.thirdpartCostCenterId}" nameValue="${fsscAlitripMappingForm.thirdpartCostCenterIdText}"  showStatus="edit" style="width:95%;">
		                ...
		                <tr>
		                    ...
		                    <td width="85%">
		                        ...
		                        <div id="_xform_projectCode" _xform_type="text">
		                            <xform:dialog propertyId="projectCode" propertyName="projectCodeText" idValue="${fsscAlitripMappingForm.projectCode}" nameValue="${fsscAlitripMappingForm.projectCodeText}"  showStatus="edit" style="width:95%;">
		                ...
		                <tr>
		                    ...
		                    <td width="85%">
		                        ...
		                        <div id="_xform_projectTitle" _xform_type="text">
		                            <xform:dialog propertyId="projectTitle" propertyName="projectTitleText" idValue="${fsscAlitripMappingForm.projectTitle}" nameValue="${fsscAlitripMappingForm.projectTitleText}"  showStatus="edit" style="width:95%;">
    ...
    <script>
        ...
        window.onload=function(){
		        var fdModelCate ="${fsscAlitripMappingForm.fdCateName}";
