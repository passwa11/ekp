...
<div data-dojo-type="mui/table/ScrollableHContainer" >
	<div data-dojo-type="mui/table/ScrollableHView" style="margin-top:20px;" id="dt_wrap_trandata_hview">
		<table class="muiNormal" id="TABLE_DocList_fdTranDataList_Form" width="100%" border="0" cellspacing="0" cellpadding="0">
