    ...
    <template:include ref="default.view">
        ...
        <template:replace name="toolbar">
            ...
            <ui:toolbar id="toolbar" layout="sys.ui.toolbar.float" count="3">
                ...
                <!--edit-->
                <kmss:auth requestURL="/fssc/asset/fssc_asset_goods/fsscAssetGoods.do?method=edit&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.edit')}" onclick="Com_OpenWindow('fsscAssetGoods.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
                </kmss:auth>
                <!--delete-->
                <kmss:auth requestURL="/fssc/asset/fssc_asset_goods/fsscAssetGoods.do?method=delete&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.delete')}" onclick="deleteDoc('fsscAssetGoods.do?method=delete&fdId=${param.fdId}');" order="4" />
                </kmss:auth>
        ...
        <template:replace name="path">
            <ui:menu layout="sys.ui.menu.nav">
                ...
                <ui:menu-item text="${ lfn:message('fssc-asset:table.fsscAssetGoods') }" href="/fssc/asset/fssc_asset_goods/" target="_self" />
            </ui:menu>
        </template:replace>
                        ...
                        <tr>
                            ...
                            <td width="35%">
                                ...
                                <div id="_xform_fdNum" _xform_type="text">
                                    <xform:text property="fdNum" showStatus="view" style="width:95%;" />
                                </div>
                            </td>
                            <td class="td_normal_title" width="15%">
                            ...
                            <td width="35%">
                                ...
                                <div id="_xform_fdAssetName" _xform_type="text">
                                    <xform:text property="fdAssetName" showStatus="view" style="width:95%;" />
                                </div>
                            </td>
                        </tr>
                        <tr>
