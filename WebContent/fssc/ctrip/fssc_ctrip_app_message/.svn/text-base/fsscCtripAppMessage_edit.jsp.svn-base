...
<script type="text/javascript">
    if("${fsscCtripAppMessageForm.method_GET}" == 'edit') {
        window.document.title = "${ lfn:message('button.edit') } - ${ lfn:message('fssc-ctrip:table.fsscCtripAppMessage') }";
    }
    if("${fsscCtripAppMessageForm.method_GET}" == 'add') {
        window.document.title = "${ lfn:message('button.add') } - ${ lfn:message('fssc-ctrip:table.fsscCtripAppMessage') }";
    }
    var formInitData = {
...
<html:form action="/fssc/ctrip/fssc_ctrip_app_message/fsscCtripAppMessage.do">
    <div id="optBarDiv">
        <c:choose>
            <c:when test="${fsscCtripAppMessageForm.method_GET=='edit'}">
                <input type="button" value="${ lfn:message('button.update') }" onclick="if(validateDetail()){Com_Submit(document.fsscCtripAppMessageForm, 'update');}">
            </c:when>
            <c:when test="${fsscCtripAppMessageForm.method_GET=='add'}">
                <input type="button" value="${ lfn:message('button.save') }" onclick="if(validateDetail()){Com_Submit(document.fsscCtripAppMessageForm, 'save');}">
            </c:when>
        </c:choose>
                ...
                <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        ...
                        <div id="_xform_fdAppKey" _xform_type="text">
                            <xform:text property="fdAppKey" showStatus="edit" style="width:85%;" />
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        ...
                        <div id="_xform_fdAppSecurity" _xform_type="text">
                            <xform:text property="fdAppSecurity" showStatus="edit" style="width:85%;" />
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        ...
                        <div id="_xform_fdCorpId" _xform_type="text">
                            <xform:text property="fdCorpId" showStatus="edit" style="width:85%;" />
                            <div style="color:red;">${lfn:message('fssc-ctrip:fssc.ctrip.corpid.tips')}</div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        <%-- 公司id--%>
                        <div id="_xform_fdSubAccountName" _xform_type="text">
                            <xform:text property="fdSubAccountName" showStatus="edit" style="width:85%;" />
                ...
                <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        ...
                        <div id="_xform_fdCompanyId" _xform_type="text">
                            <xform:text property="fdCompanyId" showStatus="edit" style="width:85%;" />
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" width="85.0%">
                        ...
                        <div id="_xform_fdCompanyName" _xform_type="text">
                            <xform:text property="fdCompanyName" showStatus="edit" style="width:85%;" />
                        </div>
                    </td>
                </tr>
                <tr>
