...
<template:include ref="default.simple4list">
    <template:replace name="title">
        <c:out value="${ lfn:message('fssc-ctrip:module.fssc.ctrip') }-${ lfn:message('fssc-ctrip:table.fsscCtripOrderHotelInfo') }" />
    </template:replace>
    <template:replace name="path">
        <ui:menu layout="sys.ui.menu.nav">
            <ui:menu-item text="${ lfn:message('home.home') }" icon="lui_icon_s_home" href="/" target="_top" />
            <ui:menu-item text="${ lfn:message('fssc-ctrip:table.fsscCtripOrderHotelInfo') }" />
        </ui:menu>
    </template:replace>
    <template:replace name="nav">
        <ui:combin ref="menu.nav.create">
            <ui:varParam name="title" value="${ lfn:message('fssc-ctrip:table.fsscCtripOrderHotelInfo') }" />
            <ui:varParam name="button">
                [ {"text": "","href": "javascript:void(0);","icon": "/fssc/ctrip/fssc_ctrip_order_hotel_info/fsscCtripOrderHotelInfo.do"} ]
            </ui:varParam>
        </ui:combin>
            ...
            <ui:accordionpanel>
                ...
                <ui:content title="${ lfn:message('list.otherOpt') }">
                    <ul class='lui_list_nav_list'>
                        ...
                        <li><a href="${LUI_ContextPath}/fssc/ctrip/fssc_ctrip_payment_mapping/index.jsp${j_iframe}">${lfn:message('fssc-ctrip:table.fsscCtripPaymentMapping')}</a>
                        </li>
                        <li><a href="${LUI_ContextPath}/fssc/ctrip/fssc_ctrip_country/index.jsp${j_iframe}">${lfn:message('fssc-ctrip:table.fsscCtripCountry')}</a>
                        </li>
    ...
    <template:replace name="content">
        <div style="margin:5px 10px;">
                ...
                <div style="float:right">
                    <div style="display: inline-block;vertical-align: middle;">
                        <ui:toolbar count="3">
                            ...
                            <kmss:auth requestURL="/fssc/ctrip/fssc_ctrip_order_hotel_info/fsscCtripOrderHotelInfo.do?method=deleteall">
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:appendQueryParameter('/fssc/ctrip/fssc_ctrip_order_hotel_info/fsscCtripOrderHotelInfo.do?method=data')}
                </ui:source>
                <!-- 列表视图 -->
                <list:colTable isDefault="false" rowHref="/fssc/ctrip/fssc_ctrip_order_hotel_info/fsscCtripOrderHotelInfo.do?method=view&fdId=!{fdId}" name="columntable">
                    <list:col-checkbox />
                    <list:col-serial/>
                    <list:col-auto props="fdOrderId;fdJourneyNo;fdTripId;fdUid;fdEmployeeId;fdEmployeeName" url="" /></list:colTable>
            </list:listview>
            <!-- 翻页 -->
            <list:paging />
        </div>
        <script>
            var listOption = {
                ...
                jPath: 'hotelOrder',
                modelName: 'com.landray.kmss.fssc.ctrip.model.FsscCtripOrderHotelInfo',
                templateName: '',
