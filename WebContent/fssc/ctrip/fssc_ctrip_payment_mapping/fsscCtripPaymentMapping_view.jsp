...
<div id="optBarDiv">
    ...
    <kmss:auth requestURL="/fssc/ctrip/fssc_ctrip_payment_mapping/fsscCtripPaymentMapping.do?method=edit&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.edit')}" onclick="Com_OpenWindow('fsscCtripPaymentMapping.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
    </kmss:auth>
    <kmss:auth requestURL="/fssc/ctrip/fssc_ctrip_payment_mapping/fsscCtripPaymentMapping.do?method=delete&fdId=${param.fdId}">
        <input type="button" value="${lfn:message('button.delete')}" onclick="if(!confirmDelete())return;Com_OpenWindow('fsscCtripPaymentMapping.do?method=delete&fdId=${param.fdId}','_self');" />
    </kmss:auth>
