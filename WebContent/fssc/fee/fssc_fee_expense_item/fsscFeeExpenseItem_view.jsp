        	...
        	<tr>
                ...
                <td colspan="3" width="85.0%">
                    ...
                    <div id="_xform_fdCompanyId" _xform_type="dialog">
                        <xform:dialog propertyId="fdCompanyId" propertyName="fdCompanyName" showStatus="view" required="true" subject="${lfn:message('fssc-fee:fsscFeeExpenseItem.fdCompany')}" style="width:95%;">
