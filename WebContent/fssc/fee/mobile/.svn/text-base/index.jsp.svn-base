...
<template:include ref="mobile.list">
	...
	<template:replace name="head">
        ...
        <script type="text/javascript" src="${LUI_ContextPath}/fssc/fee/resource/js/mobile_list.js?s_cache=${MUI_Cache}"></script>
    </template:replace>
