<template>
  <div class="fs-expense-add-account">
    <group gutter="0">
      <!-- <x-input title="收款金额" v-model="fdPayName" ></x-input> -->
      <x-input title="收款金额" v-model="fdPayment" ></x-input>
      <x-input title="收款人账户名" v-model="fdAccountName" ></x-input>
      <x-input title="收款人账号" v-model="fdBankAccount"></x-input>
      <x-input title="收款人开户行" v-model="fdBank" ></x-input>
    </group>
