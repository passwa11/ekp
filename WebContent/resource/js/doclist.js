...
function DocList_XformHandleControl(type,xformFlag){
	if(type){
		...
		var selectedControls = ['xform_relation_select'];//兼容动态下拉
		//地址本
		...
		}else if(type == 'xform_select'){
			var optionsel = xformFlag.find('.fs-option.selected');
			control.value = $(optionsel).find('.fs-option-label').text();
