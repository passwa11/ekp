...
CKEDITOR.dialog.add("smiley", function(f) {
	for (var e = f.config, a = f.lang.smiley, h = e.smiley_images, g = e.smiley_columns
		...
		var finalPath = e.smiley_path;
		if(a<49){ //凌凌表情强制设置成60:60
			imgStyle = '<img style="width:60px;height:60px" class="cke_hand" title="';
			finalPath = e.lingling_path;
		}
		...
		d
				.push(
						...
						'" cke_src="',
						CKEDITOR.tools.htmlEncode(finalPath + h[a]),
						'" alt="',
						e.smiley_descriptions[a],
						'"',
						' src="',
