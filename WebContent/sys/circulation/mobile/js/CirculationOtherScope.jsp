...
<div id="defaultView_{categroy.key}" class="muiAddressView" data-dojo-type="dojox/mobile/View">
	<div id="allCateScrollableView_{categroy.key}" 
		...
		<div id="allCateView_{categroy.key}" data-dojo-type="dojox/mobile/View" >
			...
			<ul data-dojo-type="sys/circulation/mobile/js/CirculationOtherScopeAddressList"
				data-dojo-mixins="mui/address/AddressItemListMixin"
				data-dojo-props="dataUrl:'{categroy.dataUrl}',orgIds:'{categroy.orgIds}',deptLimit:'{categroy.deptLimit}',isMul:{categroy.isMul},key:'{categroy.key}',channel:'all',curIds:'{categroy.curIds}',curNames:'{categroy.curNames}',selType:{categroy.type},exceptValue:'{categroy.exceptValue}',scope:'{categroy.scope}',maxPageSize:{categroy.maxPageSize}">
			</ul>
		</div>
...
<div id="searchView_{categroy.key}"
	...
	<ul data-dojo-type="sys/circulation/mobile/js/CirculationOtherScopeAddressList"
		...
		data-dojo-props="history:true,dataUrl:'{categroy.dataUrl}',searchUrl:'{categroy.searchUrl}',orgIds:'{categroy.orgIds}',deptLimit:'{categroy.deptLimit}',isMul:{categroy.isMul},key:'{categroy.key}',channel:'search',curIds:'{categroy.curIds}',curNames:'{categroy.curNames}',selType:{categroy.type},exceptValue:'{categroy.exceptValue}',scope:'{categroy.scope}'">
	</ul>
</div>
