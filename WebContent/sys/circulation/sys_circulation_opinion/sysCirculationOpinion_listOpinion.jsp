...
<list:data>
	<list:data-columns var="sysCirculationOpinion" list="${queryPage.list }">
		...
		<list:data-column style="width:60px;" property="fdOrder" title="${ lfn:message('page.serial') }" >
		</list:data-column>
		...
		<list:data-column style="width:60px;" col="docStatus" title="${ lfn:message('page.state') }" escape="false">
			<sunbor:enumsShow value="${sysCirculationOpinion.docStatus}" enumsType="sysCirculationOpinion_docStatus" bundle="sys-circulation" />
		</list:data-column>
		<list:data-column style="width:140px;" property="fdReadTime" title="${ lfn:message('sys-circulation:sysCirculationMain.readTime') }" >
			<kmss:showDate value="${sysCirculationOpinion.fdReadTime}" type="datetime" />
		</list:data-column>
		<list:data-column  style="width:140px;" property="fdWriteTime" title="${ lfn:message('sys-circulation:sysCirculationMain.fillTime') }" >
