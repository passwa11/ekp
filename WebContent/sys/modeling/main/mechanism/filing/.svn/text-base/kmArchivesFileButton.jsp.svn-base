						...
						$.ajax({
							...
							success: function(data){
								...
								if(data.hasTmp == 'true') {
								    ...
								    var userSettingUrl = '/sys/modeling/main/modelingAppView.do?method=archivesFileUserSetting&fdMainModelName=${JsParam.fdModelName}&fdMainModelId='+id+'&serviceName='+serviceName+'&cateName=${JsParam.cateName}'+"&xformId="+'${xformId}'+"&modelId="+'${JsParam.modelId}'+"&isFlow="+'${param.isFlow}';
