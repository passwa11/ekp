...
<template:include ref="default.edit" sidebar="auto">
	...
	<template:replace name="content">
		...
		<div class="print_title_header" id="subjectDiv">
			<p id="title" class="print_txttitle">${modelingAppSimpleMainForm.fdModelName}</p>
			<div class="printDate">
		...
		%>
		<div id="qrcodexDiv">
			<c:set var="modelViewUrl" value="sys/modeling/main/modelingAppSimpleMain.do?method=view&fdId=${param.fdId }"/>
