...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'4.4rem'" class="muiHeaderNav">
	<div data-dojo-type="sys/modeling/main/resources/js/mobile/listView/ModelingExternalQueryNavBar"
		 data-dojo-props="fdModelId:'${param.fdModelId}'">
	</div>
...
<div data-dojo-type="mui/list/NavView" style="background: #ffffff" class="modelListView">
	<%--  默认列表模板   --%>
	<ul data-dojo-type="sys/modeling/main/resources/js/mobile/listView/ExternalQueryJsonStoreList"
		data-dojo-mixins="sys/modeling/main/resources/js/mobile/listView/ExternalQueryDocItemListMixin">
	</ul>
</div>
<script>
</script>