define([
	...
	"sys/modeling/main/resources/js/mobile/business/calendar/item/GroupItemMixin","mui/dialog/Tip","dojo/topic"
	], function(declare,domClass,domStyle, _TemplateItemListMixin, ItemMixin,Tip,topic) {
	
	return declare("sys.modeling.main.calendar.GroupItemListMixin", [_TemplateItemListMixin], {
		...
		onCalendarloaded:function(evt){
			if(this==evt){
				...
				topic.publish("/sys/modeling/calendar/list/load",evt);
			}
		}
	});
});