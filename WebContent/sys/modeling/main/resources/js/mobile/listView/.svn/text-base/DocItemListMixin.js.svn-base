define([
	...
	"sys/modeling/main/resources/js/mobile/listView/DocItemMixin"
	], function(declare, viewRegistry, _TemplateItemListMixin, DocItemMixin) {
	
	return declare("sys.modeling.main.resources.js.mobile.listView.DocItemListMixin", [_TemplateItemListMixin], {
		...
		createListItem: function(/*Object*/item){
			if(item.fdType && item.fdType === "calendar"){
				return;
			}
