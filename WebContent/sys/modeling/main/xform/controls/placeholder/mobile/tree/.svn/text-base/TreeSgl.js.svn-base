define(["sys/modeling/main/xform/controls/placeholder/mobile/tree/TreeCommon"], function(common) {
  function tmplLoad(params, load) {
    ...
    html +=
      ...
      "data-dojo-props=\"controlId:'{categroy.controlId}',appModelId:'{categroy.appModelId}',required:{categroy.required},fdTmepKey:'{fdTmepKey}',key:'{categroy.key}',curIds:'{categroy.curIds}',curNames:'{categroy.curNames}',modelName:'{categroy.modelName}',isMul:{categroy.isMul},beforeSelectCateHistoryId:'{categroy.beforeSelectCateHistoryId}'\" fixed=\"bottom\">" +
      "</div>"
