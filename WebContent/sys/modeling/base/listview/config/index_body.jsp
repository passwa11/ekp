...
<template:include ref="config.profile.list">
		...
		<div class="lui_list_operation_sort_btn">
			...
			<div class="lui_list_operation_sort_toolbar">
				<ui:toolbar layout="sys.ui.toolbar.sort" style="float:left" >
					<list:sort property="fdName" text="${lfn:message('sys-modeling-base:modelingAppListview.fdName') }" group="sort.list" value="up"></list:sort>
				</ui:toolbar>
			</div>
		</div>
		<!-- 分页 -->
		...
		<div style="float:right">
			<div style="display: inline-block;vertical-align: middle;">
				<ui:toolbar id="Btntoolbar">
					<kmss:auth requestURL="/sys/modeling/base/modelingAppListview.do?method=add&fdModelId=${param.fdModelId}">
						<!-- 增加 -->
					...
					<kmss:auth requestURL="/sys/modeling/base/modelingAppListview.do?method=deleteall&fdModelId=${param.fdModelId}">
						<!-- 删除 -->
	...
	<list:listview>
		<ui:source type="AjaxJson">
			{url:'/sys/modeling/base/modelingAppListview.do?method=list&fdModelId=${param.fdModelId}'}
		</ui:source>
		<list:colTable isDefault="true" layout="sys.ui.listview.columntable" onRowClick="edit('!{fdId}')" >
			<list:col-checkbox></list:col-checkbox>
			<list:col-auto props="fdOrder,fdName,docCreator,docCreateTime"></list:col-auto>
		</list:colTable>
	...
	<!-- 分页 -->
 	...
 	<script type="text/javascript">
    	var listOption = {
            ...
            modelName: 'com.landray.kmss.sys.modeling.base.model.ModelingAppListview',
            templateName: '',
            basePath: '/sys/modeling/base/modelingAppListview.do',
            canDelete: '${canDelete}',
            mode: '',
            templateService: '',
	 	...
	 	seajs.use(['lui/jquery', 'lui/dialog', 'lui/topic'], function($, dialog, topic) {
			...
			// 增加
	 		window.addListview = function() {
		 		var url = '${LUI_ContextPath}/sys/modeling/base/modelingAppListview.do?method=add&fdModelId=' + listOption.param.fdAppModelId + '&fdMobile=' + listOption.param.fdMobile; 
	 		...
	 		window.edit = function(id) {
		 		if(id){
		 			var url = '${LUI_ContextPath}/sys/modeling/base/modelingAppListview.do?method=edit&fdModelId=' + listOption.param.fdAppModelId + '&fdId=' + id;
		 			//openPageInDialog(url, listOption.lang.dialogTitle);
		 			/* dialog.iframe(url, listOption.lang.dialogTitle, function(data){
		    			//回调
		    			topic.publish('list.refresh');
