...
<template:include ref="config.edit" sidebar="no">
    ...
    <template:replace name="content">
        <div class="lui_modeling">
            <div data-lui-type="sys/modeling/base/maintenance/userAssignUpgrade/userAssignUpgrade.js!UserAssignUpgrade" style="display:none;"
                 id="menuAside">
                <ui:source type="AjaxJson">
                    { url : '/sys/modeling/base/modeling.do?method=searchModeling&searchFlow=true'}
                </ui:source>
