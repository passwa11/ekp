...
<style type="text/css">
		...
		.model-edit-view-oper-content .model-edit-view-oper-content-item .lui-component {
			margin-left:15px;
		}
		.model-edit-view-oper-content .model-edit-view-oper-content-item .weui_switch_bd {
			margin-left:10px;
		}
...
<%
	request.setAttribute("fdModelId",request.getParameter("fdModelId"));
%>
			...
			<div data-lui-type="sys/modeling/base/resources/js/preview/preview!Preview" id="view_preview" style="display: none">
		        ...
		        <div data-lui-type="lui/view/render!Template" style="display:none;">
		            <script type="text/config">
 						{
							src : '/sys/modeling/base/resources/js/preview/view_pc.html#'
						}
                	</script>
		        </div>
		    </div>
			...
			<div class="model-edit-right-wrap">
				<div class="model-edit-view-title">
					...
					<c:if test="${modelingAppViewForm.method_GET=='edit' || modelingAppListviewForm.method_GET=='editTemplate'}">
						 <div onclick="if(validateDetail()){submit_custom('update');}"><bean:message key="button.update"/></div>
					</c:if>
					<c:if test="${modelingAppViewForm.method_GET=='add'}">
						<div onclick="if(validateDetail()){submit_custom('save');}"><bean:message key="button.save"/></div>
					</c:if>
				</div>
					    ...
					    <center>
					        <div style="width:100%;">
					            <table class="tb_simple model-view-panel-table" width="100%">
					                ...
					                <tr lui-pam-hidden="${param.isPcAndMobile}">
					                    <td colspan="3" width="85%" class="model-view-panel-table-td">
					                        ...
					                        <div id="_xform_fdName" _xform_type="text" style="width: 100%">
					                            <xform:text property="fdName" showStatus="edit" style="width:95%;height:28px!important;" />
					                        </div>
					                    </td>
					                </tr>
									<tr lui-pam-hidden="${param.isPcAndMobile}">
																	...
																	<li class='model-edit-view-oper-content-item first-item'>
																		...
																		<div class='item-content'>
										                                    ...
										                                    <div id="_xform_listOpers_Form[!{index}].fdOperationId" _xform_type="dialog" style="width:100%">
										                                        <xform:dialog style="width:100%;vertical-align: middle;"
                                                                                              propertyId="listOpers_Form[!{index}].fdOperationId"
                                                                                              propertyName="listOpers_Form[!{index}].fdOperationName"
                                                                                              subject="${lfn:message('sys-modeling-base:modelingAppViewopers.fdOperation')} "
                                                                                              showStatus="edit" validators=" required">
										                                            operationSelectViewOperation()
										                                        </xform:dialog>
										                                    </div>
																		</div>
																	</li>
																	...
																	<li class='model-edit-view-oper-content-item first-item'>
																		...
																		<div class='item-content'>
									                                        ...
									                                        <div id="_xform_listOpers_Form[${vstatus.index}].fdOperationId" _xform_type="dialog" style="width: 98%;">
									                                            <xform:dialog style="vertical-align: middle;width:100%"
                                                                                              propertyId="listOpers_Form[${vstatus.index}].fdOperationId"
                                                                                              propertyName="listOpers_Form[${vstatus.index}].fdOperationName"
                                                                                              validators=" required"
                                                                                              subject="${lfn:message('sys-modeling-base:modelingAppViewopers.fdOperation')}">
									                                                operationSelectViewOperation()
									                                            </xform:dialog>
																	...
																	<li class='model-edit-view-oper-content-item' data-lui-mark="view-oper-field-${vstatus.index}" <c:if test="${listOpers_FormItem.fdJudgeType eq '1'}"> style="display: none" </c:if>  style="display: none">
																		...
																		<div class='item-content'>
									                                        ...
									                                        <div id="_xform_listOpers_Form[${vstatus.index}].fdOperator" _xform_type="text" style="width:100%;display: ${listOpers_FormItem.fdField == '' ? 'none' : 'display'}">
									                                            <xform:select onValueChange="onOperatorChange" style="width:100%" property="listOpers_Form[${vstatus.index}].fdOperator" showStatus="edit" subject="${lfn:message('sys-modeling-base:modelingAppViewopers.fdOperator')}" showPleaseSelect="false">
									                                            	<xform:simpleDataSource value="equal">${lfn:message('sys-modeling-base:modelingAppListview.enum.equal') }</xform:simpleDataSource>
																					<xform:simpleDataSource value="notequal">${lfn:message('sys-modeling-base:modelingAppListview.enum.notequal') }</xform:simpleDataSource>
									                                            	<xform:simpleDataSource value="contain">${lfn:message('sys-modeling-base:modelingAppListview.enum.contain') }</xform:simpleDataSource>
									                                            	<xform:simpleDataSource value="notContain">${lfn:message('sys-modeling-base:modelingAppListview.enum.notContain') }</xform:simpleDataSource>
					                    	...
					                    	<table id="TABLE_DocList_listTabs_Form" class="tb_simple model-edit-view-oper-content-table" width="100%" style="position:relative;">
												...
												<tr style="display:none;" KMSS_IsReferRow="1" class="docListTr">
														...
														<div class="model-edit-view-oper" data-lui-position='fdTag-!{index}' onclick="switchSelectPosition(this,'right')">
															...
															<div class="model-edit-view-oper-content">
																<ul>
																	<li class='model-edit-view-oper-content-item first-item'>
																		...
																		<div class='item-content'>
										                                    ...
										                                    <div id="_xform_listTabs_Form[!{index}].fdName" _xform_type="text" style="width:100%">
										                                        <xform:text property="listTabs_Form[!{index}].fdName" showStatus="edit" subject="${lfn:message('sys-modeling-base:modelingAppViewtab.fdName')}" required="true" validators="maxLength(50)" style="width:95%;height:28px!important;" onValueChange="tagNameUpdate"/>
										                                    </div>
																		</div>
																	</li>
																	<%-- 默认展开 --%>
																	...
																	<input type="hidden" name="listTabs_Form[!{index}].fdIsShow" />
																	<li class='model-edit-view-oper-content-item'>
																		...
																		<div class='item-content'>
										                                    ...
										                                    <div id="_xform_listTabs_Form[!{index}].fdType" _xform_type="select" style="width: 100%">
										                                        <%-- <xform:radio property="listTabs_Form[!{index}].fdType" onValueChange="fdTypeChange" htmlElementProperties="id='listTabs_Form[!{index}].fdType'" subject="${lfn:message('sys-modeling-base:modelingAppViewtab.fdType')}">
										                                            <xform:enumsDataSource enumsType="sys_modeling_viewtab_type" />
										                                        </xform:radio> --%>
										                                         <div class="view_flag_radio" style="display: inline-block;">
										                                            <input type="hidden" name="listTabs_Form[!{index}].fdType" value>
																	...
																	<li class='model-edit-view-oper-content-item' id='tabSourceLi_index_!{index}'>
																		...
																		<div class='item-content'>
																			...
																			<div class="item-content-element-choose" onclick="chooseTabSource(this,'${fdAppId }');">
																	...
																	<li class='model-edit-view-oper-content-item last-item' style="height: auto">
																		...
																		<div class='item-content'>
													                        ...
													                        <div id="_xform_listTabs_Form[!{index}].fdRelationMainField" _xform_type="select" style="display :none;">
													                            <%-- 关联主模块字段--%>
																				<%-- ${lfn:message('sys-modeling-base:modelingAppViewtab.fdRelationMainField') }: --%>
													                        ...
													                        <div id="_xform_listTabs_Form[!{index}].fdListview">
																				<%-- ${lfn:message('sys-modeling-base:modelingAppViewtab.fdListview') }： --%>
																				<xform:select property="listTabs_Form[!{index}].fdListviewId" required="true" onValueChange="onFdListviewChange" subject="${lfn:message('sys-modeling-base:modelingAppViewtab.showData') }" style="width:95%">
													                            </xform:select>
													                            <input name='listTabs_Form[!{index}].fdListviewIncParams' type='hidden'/>
													                            <input name='listTabs_Form[!{index}].fdCollectionViewId' type='hidden'/>
														                        <div id="_xform_listTabs_Form[!{index}].fdListviewIncParams">
														                        </div>
													                        </div>
																			<%-- 链接--%>
																			<div id="_xform_listTabs_Form[!{index}].fdLink">
																				<xform:text property="listTabs_Form[!{index}].fdLinkParams" style="width: 95%;height: 28px!important;" className="inputsgl"/>
																				<span class="txtstrong">*</span>
						                            ...
						                            <c:choose>
							                            ...
							                            <tr KMSS_IsContentRow="1" class="docListTr model-businessTag-wrap" style="display:block;">
																		...
																		<ul>
																			<li class='model-edit-view-oper-content-item first-item'>
																				...
																				<div class='item-content'>
											                                        ...
											                                        <div id="_xform_listTabs_Form[${vstatus.index}].fdName" _xform_type="text" style="width:100%">
											                                            <xform:text property="listTabs_Form[${vstatus.index}].fdName" showStatus="edit" subject="${lfn:message('sys-modeling-base:modelingAppViewtab.fdName')}" required="true" validators="maxLength(50)" style="width:95%;height:28px!important;"  onValueChange="tagNameUpdate"/>
											                                        </div>
																				</div>
																			</li>
																			<%-- 默认展开 --%>
																			...
																			<li class='model-edit-view-oper-content-item'>
																				...
																				<div class='item-content'>
											                                        ...
											                                        <div id="_xform_listTabs_Form[${vstatus.index}].fdType" _xform_type="select" style="width:100%">
											                                            <%-- <xform:radio property="listTabs_Form[${vstatus.index}].fdType" onValueChange="fdTypeChange" htmlElementProperties="id='listTabs_Form[${vstatus.index}].fdType'" subject="${lfn:message('sys-modeling-base:modelingAppViewtab.fdType')}">
											                                                <xform:enumsDataSource enumsType="sys_modeling_viewtab_type" />
											                                            </xform:radio> --%>
											                                            <div class="view_flag_radio" style="display: inline-block;">
												                                            <input type="hidden" name="listTabs_Form[${vstatus.index}].fdType" value="${listTabs_FormItem.fdType}">
												                                            <div class="view_flag_radio_yes" style="display: inline-block;cursor: pointer;" index="1"  onclick="changeTargetForm(this,1)"><i class="view_flag_no"></i>${lfn:message('sys-modeling-base:enums.viewtab_type.1') }</div>
																							<div class="view_flag_radio_no view_flag_last" index="0" style="display:inline-block;cursor: pointer;"  onclick="changeTargetForm(this,0)"><i class="view_flag_no"></i>${lfn:message('sys-modeling-base:enums.viewtab_type.0') }</div>
																							<div class="view_flag_radio_no view_flag_last" index="2" style="display:inline-block;cursor: pointer;"  onclick="changeTargetForm(this,2)"><i class="view_flag_no"></i>${lfn:message('sys-modeling-base:view.link') }</div>
												                                        </div>
											                                        </div>
																			...
																			<li class='model-edit-view-oper-content-item last-item' style="height: auto">
																				...
																				<div class='item-content'>
																					...
																					<%--<xform:select property="listTabs_Form[${vstatus.index}].fdListviewId" onValueChange="onFdListviewChange" validators="${isListview ? 'required':''}" subject="${lfn:message('sys-modeling-base:modelingAppViewtab.fdListview') }" style="width:95%">
															                                <xform:beanDataSource serviceBean="modelingAppListviewService" selectBlock="fdId,fdName" whereBlock="modelingAppListview.fdModel='${listTabs_FormItem.fdModelId }'"/>
															                            </xform:select>--%>
																							<span class="txtstrong">*</span>
															                            <input name='listTabs_Form[${vstatus.index}].fdListviewIncParams' type='hidden' value="${listTabs_FormItem.fdListviewIncParams }"/>
																							<input name='listTabs_Form[${vstatus.index}].fdCollectionViewId' type='hidden' value="${listTabs_FormItem.fdCollectionViewId }"/>
																					...
																					<div id="_xform_listTabs_Form[${vstatus.index}].fdLink" style="display :${isLink ? 'block':'none'};">
																						<xform:text property="listTabs_Form[${vstatus.index}].fdLinkParams"  validators="${isLink ? 'urlCustomize urlLength':''}" style="width: 96%;height: 28px!important;" className="inputsgl"/>
																						<span class="txtstrong">*</span>
																						<div style="color: #999999;font-size: 12px;">${lfn:message('sys-modeling-base:modeling.system.link.only') }/sys/modeling/base/profile/nav/index.jsp</div>
																					</div>
																				</div>
					                ...
					                <%-- 入参查询条件 //2020.3.2 yanmj 隐藏，需恢复时从变更集历史记录中找 --%>
					            </table>
					        </div>
					    </center>
...
<script type="text/javascript">
    ...
    var initData = {
        contextPath: '${LUI_ContextPath}',
   		modelDict : '${modelDict}',
   		modelName : '${modelName}',
		fdListviewId:'${listTabs_FormItem.fdListviewId}'
    };
	...
	function packageData(callBack){
		if (validateDetail()  && validateLabel()) {
			submit_packageData()
			callBack()
		}
	}
