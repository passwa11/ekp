                    ...
                    <div class="lui_modeling">
                        <div class="lui_modeling_aside">
                            <div data-lui-type="lui/base!DataView" style="display:none;">
                                <ui:source type="Static">
                                    [{
                                    "text" : "${lfn:message('sys-modeling-base:modeling.maintenance.tool')}",
                                    "iframeId":"base_iframe",
                                    "selected":"true",
                                    "src" : "sys/modeling/base/maintenance/tools.jsp"
                                    },{
                                    "text" : "${lfn:message('sys-modeling-base:modeling.maintenance.log')}",
                                    "iframeId":"base_iframe",
                                    "src" : "sys/modeling/base/maintenance/log/index.jsp"
                                    }]
                                </ui:source>
                        ...
                        <div class="lui_modeling_main aside_main"style="height:100%">
                            <iframe id="base_iframe" class="lui_modeling_iframe_body" frameborder="no" border="0"
                                    src="<c:url value="/sys/modeling/base/maintenance/tools.jsp" />"style="height:80%;"></iframe>
                        </div>
                    </div>
...
<script>
    $(function () {
        var viewHeight = window.innerHeight - 40;
