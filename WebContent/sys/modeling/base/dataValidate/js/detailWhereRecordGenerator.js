...
define(function (require, exports, module) {
    ...
    var DetailWhereRecordGenerator = base.Component.extend({
        //=|等于，单选，like|包含 多选
        operatorMatch: 0,
        enumValues: {},
        initEnum: function () {
            ...
            if(this.isPreWhere){
                ...
                sourceData = this.parent.getDetailTargetData();
            }
        ...
        draw: function (container, isDetail) {
           ...
           // var $delTd = $("<td ></td>");
            ...
            if(self.isPreWhere){
            	...
            	self.parent.addWgt(this, "detailWhere");
            }
        },
        ...
        destroy: function ($super, cfg) {
        	if(this.isPreWhere){
        		 ...
        		 this.parent.deleteWgt(this, "detailWhere");
        	}
            $super(cfg);
        },
    ...
    exports.DetailWhereRecordGenerator = DetailWhereRecordGenerator;
});
