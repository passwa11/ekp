    ...
    <template:replace name="content">
        <div style="margin:5px 10px;">
            ...
            <list:criteria id="criteria1">
                ...
                <list:cri-auto modelName="com.landray.kmss.sys.modeling.base.business.model.ModelingCalendar"
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:appendQueryParameter('/sys/modeling/base/calendar.do?method=data&fdModelId=${param.fdModelId}')}
                </ui:source>
                <!-- 列表视图 -->
        ...
        <script>
            var listOption = {
                ...
                templateName: '',
                basePath: '/sys/modeling/base/calendar.do',
                canDelete: '${canDelete}',
                mode: '',
                templateService: '',
                ...
                lang: {
                    ...
                    comfirmCopyCalendar:'${lfn:message("sys-modeling-base:modelingCollectionView.copyViewsTitle")}'
                }
            ...
            seajs.use(["lui/jquery", "sys/ui/js/dialog", "lui/topic"], function ($, dialog, topic) {
                ...
                window.addDocById = function () {
                    var url = '${LUI_ContextPath}/sys/modeling/base/calendar.do?method=add&fdModelId=${param.fdModelId}';
                ...
                window.toEdit = function (fdId) {
                    var url = '${LUI_ContextPath}/sys/modeling/base/calendar.do?method=edit&fdId=' + fdId+'&fdModelId=${param.fdModelId}' ;
                    var iframe = window.parent.document.getElementById("trigger_iframe");
                    $(iframe).attr("src", url);
                    //修改样式
                    $(iframe).parents(".lui_modeling_main.aside_main").eq(0).css("padding-top", "0px");
                ...
                window.copyView = function() {
                    ...
                    dialog.confirm(listOption.lang.comfirmCopyCalendar,function(ok){

                        if(ok==true){
                            var del_load = dialog.loading();
                            var param = {"List_Selected":selected};
                            $.ajax({
                                url:'${LUI_ContextPath}/sys/modeling/base/calendar.do?method=copyView',
