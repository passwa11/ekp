    ...
    <template:replace name="content">
        <div style="margin:5px 10px;">
            ...
            <list:criteria id="criteria1">
                ...
                <list:cri-auto modelName="com.landray.kmss.sys.modeling.base.business.model.ModelingResourcePanel"
                ...
                <div style="float:right">
                    <div style="display: inline-block;vertical-align: middle;">
                        <ui:toolbar count="3">
                            ...
                            <ui:button text="${lfn:message('sys-modeling-base:modelingCollectionView.button.copyViews')}"  onclick="copyDoc()" order="3"/>
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:appendQueryParameter('/sys/modeling/base/resPanel.do?method=data&fdModelId=${param.fdModelId}')}
                </ui:source>
                <!-- 列表视图 -->
        ...
        <script>
            var listOption = {
                ...
                templateName: '',
                basePath: '/sys/modeling/base/resPanel.do',
                canDelete: '${canDelete}',
                mode: '',
                templateService: '',
                ...
                lang: {
                    ...
                    comfirmCopyPanel:'${lfn:message("sys-modeling-base:modelingCollectionView.copyViewsTitle")}'
                }
            ...
            seajs.use(["lui/jquery", "sys/ui/js/dialog", "lui/topic"], function ($, dialog, topic) {
                ...
                topic.subscribe("list.loaded", function () {
                    ...
                    if(bodyHeight == 70){
                        setTimeout("$('body', parent.document).find('#trigger_iframe').height($(document.body).outerHeight(true) + 70)",500);
                    }else {
                        $("body", parent.document).find('#trigger_iframe').height(bodyHeight);
                    }
                });
                window.addDocById = function () {
                    var url = '${LUI_ContextPath}/sys/modeling/base/resPanel.do?method=add&fdModelId=${param.fdModelId}';
                ...
                window.toEdit = function (fdId) {
                    var url = '${LUI_ContextPath}/sys/modeling/base/resPanel.do?method=edit&fdId=' + fdId ;
                    var iframe = window.parent.document.getElementById("trigger_iframe");
                    $(iframe).attr("src", url);
                    //修改样式
                    $(iframe).parents(".lui_modeling_main.aside_main").eq(0).css("padding-top", "0px");
                ...
                window.copyDoc = function() {
                    ...
                    dialog.confirm(listOption.lang.comfirmCopyPanel,function(ok){
                        if(ok==true){
                            ...
                            $.ajax({
                                url:'${LUI_ContextPath}/sys/modeling/base/resPanel.do?method=copyDoc',
