    ...
    <template:replace name="content">
        <div style="margin:5px 10px;">
            ...
            <list:criteria id="criteria1">
                ...
                <list:cri-auto modelName="com.landray.kmss.sys.modeling.base.business.model.ModelingGantt"
                ...
                <div class="lui_list_operation_sort_btn">
                    ...
                    <div class="lui_list_operation_sort_toolbar">
                        <ui:toolbar layout="sys.ui.toolbar.sort" style="float:left">
                            <list:sortgroup>
                                <list:sort property="modelingGantt.docCreateTime" text="${lfn:message('model.fdCreateTime') }"
                                           group="sort.list"></list:sort>
                                <list:sort property="modelingGantt.fdName"
            ...
            <list:listview id="listview">
                <ui:source type="AjaxJson">
                    {url:appendQueryParameter('/sys/modeling/base/gantt.do?method=data&fdModelId=${param.fdModelId}')}
                </ui:source>
                <!-- 列表视图 -->
        ...
        <script>
            var listOption = {
                ...
                templateName: '',
                basePath: '/sys/modeling/base/gantt.do',
                canDelete: '${canDelete}',
                mode: '',
                templateService: '',
                ...
                lang: {
                    ...
                    comfirmCopyGantt:'${lfn:message("sys-modeling-base:modelingCollectionView.copyViewsTitle")}'
            ...
            seajs.use(["lui/jquery", "sys/ui/js/dialog", "lui/topic"], function ($, dialog, topic) {
                ...
                window.addDocById = function () {
                    var url = '${LUI_ContextPath}/sys/modeling/base/gantt.do?method=add&fdModelId=${param.fdModelId}';
                ...
                window.toEdit = function (fdId) {
                    var url = '${LUI_ContextPath}/sys/modeling/base/gantt.do?method=edit&fdId=' + fdId ;
                    var iframe = window.parent.document.getElementById("trigger_iframe");
                    $(iframe).attr("src", url);
                    //修改样式
                    $(iframe).parents(".lui_modeling_main.aside_main").eq(0).css("padding-top", "0px");
                ...
                window.copyView = function() {
                    ...
                    dialog.confirm(listOption.lang.comfirmCopyGantt,function(ok){

                        if(ok==true){
                            var del_load = dialog.loading();
                            var param = {"List_Selected":selected};
                            $.ajax({
                                url:'${LUI_ContextPath}/sys/modeling/base/gantt.do?method=copyView',
