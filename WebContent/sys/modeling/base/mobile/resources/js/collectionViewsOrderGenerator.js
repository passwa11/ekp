...
define(function(require, exports, module) {
    ...
    var CollectionViewsOrderGenerator = headGenerator.extend({
        ...
        draw : function($super, cfg){
            ...
            var self = this;
            var html = ""
            this.content = $("<div class='model-edit-view-oper' data-lui-position='fdOrderBy-"+(rowIndex-1)+"' onclick=switchSelectPosition(this,'right')></div>");
            ...
            this.fieldWgt = new selectUnion({container: $fieldTd,parent:this,options:listviewOption.baseInfo.modelDict,type:"order",value:self.storeData.field, channel: this.channel});
            this.fieldWgt.draw();
            //排序
    ...
    module.exports = CollectionViewsOrderGenerator;
