...
define(function(require, exports, module) {
    ...
    var StatisticsRuleSettingWhere = base.Component.extend({
        ...
        delItem : function (dom) {
            ...
            var curIndex = $item.attr("index");
            var luiId = $item.parents("[data-lui-cid]").eq(0).attr("data-lui-cid");
            var parentIndex = $item.parents(".statisticsItem").attr("index");
            var kClassParent = LUI(luiId);
            var statisticsCollection = kClassParent.statisticsCollection;
            var statisticsWgt = statisticsCollection[parentIndex];
            var statisticsSettingButton =  statisticsWgt.statisticsSettingButton;
            var statisticsRuleSetting = statisticsSettingButton.statisticsRuleSetting;
            var statisticsRuleSettingWhereWgts = statisticsRuleSetting.statisticsRuleSettingWhereWgts;
            var wgt = statisticsRuleSettingWhereWgts[curIndex];
            $item.remove();
            topic.channel(this.channel).publish("statisticsRuleSettingWhereWgts.delete", {"wgt": wgt});
            wgt.destroy();
            return;
        },
    ...
    module.exports = StatisticsRuleSettingWhere;
})