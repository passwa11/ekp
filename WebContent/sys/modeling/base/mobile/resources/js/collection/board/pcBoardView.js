...
define(function(require, exports, module) {
    ...
    var PcBoardView = collectionBaseView["CollectionBaseView"].extend({
        ...
        startup : function($super, cfg) {
            this.setRender(new render.Template({
                src : "/sys/modeling/base/views/collection/board/pcViewRender.html#",
                parent : this
            }));
            this.render.startup();
            $super(cfg);
        ...
        renderCoverImg: function(){
            ...
            $showCoverImg.find("input[name*=fdShowCoverImg]").each(function (index, obj){
                $(obj).on("click",function() {
                    ...
                    var curVal = $("[name='fd_pc_ShowCoverImg']",$showCoverImg).val();
                    if(curVal == value){
                        return;
                    }
                    if(value == "1"){
    ...
    exports.PcBoardView = PcBoardView;
})