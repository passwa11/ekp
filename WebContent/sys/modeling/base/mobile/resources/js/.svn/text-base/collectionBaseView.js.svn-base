...
define(function(require, exports, module) {
    ...
    var CollectionBaseView = view["View"].extend({
        ...
        renderSelectDialog: function(){
            ...
            this.element.find(".multiSelectDialog").on("click",function(){
                ...
                dialog.iframe(url,modelingLang['modelingLang'],function(data){
                    ...
                    if($dom.attr("data-lui-position") === "fdDisplay") {
                        if(self.channel){
                            topic.channel(self.channel).publish("modeling.selectDisplay.change",{'thisObj':$dom,'data':data});
                        }else{
    ...
    exports.CollectionBaseView = CollectionBaseView;
})