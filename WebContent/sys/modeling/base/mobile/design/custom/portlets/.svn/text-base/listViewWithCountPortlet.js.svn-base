define(function(require, exports, module) {
    ...
    var ListViewWithCountPortlet = basePortlet.BasePortlet.extend({
        ...
        startup : function($super, cfg) {
            this.setRender(new render.Template({
                src : "/sys/modeling/base/mobile/design/custom/portlets/listViewWithCountViewRender.html#",
                parent : this
            }));
            this.render.startup();
            $super(cfg);
        ...
        setLeftShow : function() {
            ...
            for (var i = 0; i < data.attr.listViews.value.length;i++) {
                ...
                $icon.appendTo($listViewHtml);
                $("<strong></strong>").text(wgtValue.title || modelingLang["modeling.Undefined"]).appendTo($listViewHtml);
    ...
    module.exports = ListViewWithCountPortlet;
});