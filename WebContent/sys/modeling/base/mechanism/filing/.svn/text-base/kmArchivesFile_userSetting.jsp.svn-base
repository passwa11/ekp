    ...
    <tr><td class="heading" colspan="4">基本信息</td></tr>
		...
		<tr>
			...
			<td colspan="3">
				...
				<p>
					<div id="orgSelect">
						<xform:address orgType="ORG_TYPE_PERSON" htmlElementProperties="placeholder='请选择' " showStatus="edit" style="width:90%" subject="${lfn:message('km-archives:kmArchivesFileTemplate.fdFilePerson') }" propertyName="fdFilePersonName" propertyId="fdFilePersonId">
						</xform:address>
					</div>
...
Com_AddEventListener(window,"load",function(){
	...
	,function(formulaBuilder){
		formulaBuilder.initFieldList('${HtmlParam.xformId }');
         ...
         html.append("<input type='text' name='fdFilePersonFormula' class='inputsgl' style='width:150px' readonly/>");
         var $formula = $("<span class='highLight'><a href='javascrip:void(0);'>选择</a></span>");
        
         $formula.on("click", function (e) {
        	 Formula_Dialog('fdFilePersonFormula', 'fdFilePersonFormula', formulaBuilder.getFieldList() || "", "com.landray.kmss.sys.organization.model.SysOrgElement");
