...
<ui:button parentId="toolbar" order="2" text="${ lfn:message('kms-multidoc:button.subside') }" 
				...
				$.ajax({
					...
					success: function(data){
						...
						if(data.status == true){
							...
							var userSettingUrl = '/sys/modeling/base/mechanism/sediment/subsideSetting.jsp?fdModelName='+fdModelName+'&fdId='+id+'&serviceName='+serviceName+'&fdmodelId='+'${param.modelId}'+"&isFlow="+'${param.isFlow}';
