...
define(function (require, exports, module) {
    ...
    var ThroughRecordGenerator = base.Component.extend({
        ...
        selectView: function () {
            var self = this;
            dialog.iframe("/sys/modeling/base/relation/import/model_view_select.jsp?method=none&fdModelId=" + self.pcfg.modelMainId, "选择视图", function (value) {
                if (value == null)
                    return;
        ...
        getKeyData: function () {
            ...
            var keyData = {
                ...
                "viewModelId": self.pcfg.modelMainId,
                "viewModelName": "",
                "viewSet": {
                    "type": "1",
        ...
        initByStoreData: function (storeData) {
            var self = this;
            // console.log(this.feildName,storeData)
            // console.log(storeData.isThrough === true);
