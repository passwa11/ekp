...
<template:include ref="default.dialog">
    ...
    <template:replace name="content">
        <p class="txttitle" style="margin: 10px 0;">${lfn:message('sys-modeling-base:portal.select.view.list')}</p>
                    ...
                    <div style="max-height: 270px; overflow-y: auto;">
                        ...
                        <list:listview id="listview">
                            <ui:source type="AjaxJson">
                             {url:'/sys/modeling/base/pcAndMobileListView.do?method=findAllSelect&fdModelId=${param.fdModelId}&fdDevice=${param.fdDevice }'}
                            </ui:source>
                            <!-- 列表视图 -->
