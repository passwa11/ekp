                    ...
                    <div class="model-mask-panel-table">
                        <table class="tb_simple modeling_form_table " mdlng-rltn-mrk="regionTable" id="TB_MainTable">
                                ...
                                <td width="85%">
                                    ...
                                    <div id="_xform_fdType" _xform_type="radio">
                                        <xform:radio property="fdType" onValueChange="selectScenesType"
                                                     htmlElementProperties="id='fdType'" validators="required" required="true" showStatus="edit">
                                            <xform:enumsDataSource enumsType="sys_modeling_scenes"/>
                                        </xform:radio>
                                    </div>
                                    <div class="validation-advice" id="advice-_validate_fdType" style="display: none" _reminder="true">
                                        <table class="validation-table">
                                            ...
                                            <tr>
                                                ...
                                                <td class="validation-advice-msg">
                                                    <span class="validation-advice-title">${lfn:message('sys-modeling-base:sysModelingScenes.fdType')}</span> <bean:message key="errors.required" arg0=" "/>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                ...
                                <td width="85%">
                                    <div id="_xform_fdCronType" _xform_type="radio">
                                        <label><input type="radio" name="fdCronType" value="0" checked
                                                      onclick="changeInputType(value);"><bean:message
                                                bundle="sys-quartz"
                                ...
                                <td width="85%">
                                    ...
                                    <div id="_xform_fdRunType" _xform_type="radio">
                                        <xform:radio property="fdRunType"
                                                     value="${sysModelingScenesForm.fdRunType}"
                                                     showStatus="edit">
                            ...
                            <tr id="fdCron_Times" kmss_inputtype="0">
                                <td class="td_normal_title" width="15%">
                                    ${lfn:message('sys-modeling-base:sysModelingScenes.fdCronHz')}
                                </td>
                                <td colspan="3" width="85.0%">
                                        <%-- 运行频率。。--%>
                                    <div>
                                        <select name="fdCronTimes" onchange="refreshInpuType0();">
                                ...
                                <td colspan="3" style="padding-left: 25px;">
                                    <div>
                                        <span>
                                            ...
                                            <input name="fdYear" size="4" type="number" class="inputSgl">
                                            <bean:message bundle="sys-quartz"
                                        ...
                                        <span>
                                            ...
                                            <input name="fdMonth" size="2" type="number" class="inputSgl">
                                            <bean:message bundle="sys-quartz"
                                        ...
                                        <span>
                                            ...
                                            <input name="fdDay" size="2" type="number" class="inputSgl">
                                            <bean:message bundle="sys-quartz"
                                        ...
                                        <span>
                                            ...
                                            <input name="fdHour" size="2"  type="number" class="inputSgl">
                                            <bean:message bundle="sys-quartz"
                                        ...
                                        <span>
                                            ...
                                            <input name="fdMinute" size="2"  type="number" class="inputSgl">
                                            <bean:message bundle="sys-quartz"
                                        ...
                                        <span>
                                            ...
                                            <input name="fdSecond" size="2"  type="number" class="inputSgl">
                                            <bean:message bundle="sys-quartz"
                            ...
                            <tr kmss_inputtype="1" class="fdCron_Str" style="display:none">
                                ...
                                <td colspan="3">
                                    <div>
                                        <html:text property="fdCron" style="width:80%"/>
                                ...
                                <td width="85%">
                                    ...
                                    <div class="model-mask-panel-table-base" lui-mark-prop="behavior">
                                        ...
                                        <span class="behaviorSelect highLight"
                                              style="margin-bottom: 10px;display: block"> ${lfn:message('sys-modeling-base:behavior.select')}</span>
                                        <table class="tb_normal field_table fdBehaviorBox" width="100%">
                                            <thead>
                                            <tr>
                                                <td>${lfn:message('sys-modeling-base:behavior.trigger.name')}</td>
                                                <td width="30%">${lfn:message('sys-modeling-base:behavior.type')} </td>
                                            </tr>
                                            </thead>
                                        </table>
                                            <%--                                        </div>--%>
                        ...
                        <div class="toolbar-bottom">
                            <ui:button styleClass="lui_toolbar_btn_gray" text="${ lfn:message('button.close') }"
                                       order="5"
                                       onclick="Com_CloseWindow();"/>
                            <c:choose>
                                <c:when test="${ sysModelingScenesForm.method_GET == 'edit' }">
                                    <ui:button text="${ lfn:message('button.update') }" onclick="doSubmit('update');"/>
                                </c:when>
                                <c:when test="${ sysModelingScenesForm.method_GET == 'add' }">
        ...
        <script type="text/javascript">
            ...
            seajs.use(['lui/jquery', 'lui/dialog', 'lui/topic',
                ...
                window.doSubmit = function (type) {
                    ...
                    if(!fdType){
                        $("#advice-_validate_fdType").css("display","block");
                        return;
                    }else{
                        $("#advice-_validate_fdType").css("display","none");
                    }
                    //校验参数
