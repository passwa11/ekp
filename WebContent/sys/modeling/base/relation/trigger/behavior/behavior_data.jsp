...
<list:data>
    <list:data-columns var="sysModelingBehavior" list="${queryPage.list}" varIndex="status" custom="false">
        ...
        <list:data-column col="fdType"  title="${lfn:message('sys-modeling-base:sysModelingBehavior.fdType')}">
           <sunbor:enumsShow value="${sysModelingBehavior.fdType}" enumsType="sys_modeling_behavior_type" />
        </list:data-column>
