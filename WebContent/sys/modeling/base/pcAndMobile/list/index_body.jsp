    ...
    <template:replace name="content">
        ...
        <list:listview>
            <ui:source type="AjaxJson">
                {url:'/sys/modeling/base/pcAndMobileListView.do?method=list&fdModelId=${param.fdModelId}'}
            </ui:source>
        ...
        <script type="text/javascript">
            var listOption = {
                ...
                templateName: '',
                basePath: '/sys/modeling/base/pcAndMobileListView.do',
                canDelete: '${canDelete}',
                mode: '',
                templateService: '',
            ...
            seajs.use(['lui/jquery', 'lui/dialog', 'lui/topic'], function ($, dialog, topic) {
                ...
                window.addListview = function () {
                    ...
                    dialog.iframe(url, listOption.lang.dialogTitle, function (data) {
                        ...
                        //回调
                        $.ajax({
                            url: Com_Parameter.ContextPath + "sys/modeling/base/pcAndMobileListView.do?method=ajaxSaveBase",
                            dataType: 'json',
                            type: 'post',
                            data: {
                    ...
                    }, {width: 540, height: 400, params: dialogParams});
                };
                // 编辑
                window.edit = function (id) {
                    if (id) {
                        var url = Com_Parameter.ContextPath + "sys/modeling/base/pcAndMobileListView.do?method=edit&fdId="+id;
