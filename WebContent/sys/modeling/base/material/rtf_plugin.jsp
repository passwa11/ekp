...
<template:include file="/sys/profile/resource/template/list.jsp">
    <template:replace name="head">
        <link rel="stylesheet" type="text/css" href="${KMSS_Parameter_ContextPath}sys/modeling/base/material/source/material_main.css">
    </template:replace>
                ...
                <ui:content title="${lfn:message('sys-portal:sys.portal.material.rtf.pic') }">
                    ...
                    <list:listview channel="material_1">
                        <ui:source type="AjaxJson">
                            {url:'/sys/modeling/base/modelingMaterialMain.do?method=gridData&sort=ture'}
                        </ui:source>
