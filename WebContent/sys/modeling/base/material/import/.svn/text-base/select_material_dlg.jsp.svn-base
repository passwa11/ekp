...
<template:include ref="default.dialog">
    ...
    <template:replace name="content">
                                                ...
                                                <div class="lui_material_text">
                                                    <p class="lui_material_text_title">
                                                        ...
                                                        <input type="hidden" value="{% grid['imageUrl']%}"
                                                            id="url_{% grid['fdId']%}">
                                                        <input type="hidden" value="{% grid['fdAttrId']%}"
                                                               id="attrId_{% grid['fdId']%}">
                                                        <b> {%grid['fdName']%}</b>
                                                    </p>
                                                </div>
                                            </label>
        ...
        <div class="material_dlg_btn_bar">
            ...
            <span class="material_dlg_btn" onclick="uploadDoc();">${ lfn:message('sys-modeling-base:modelingMaterialMain.btn.upload')}</span>
        </div>
