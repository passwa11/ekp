     ...
     <div id="lui_material_preview_box" style="width:100%" align="center">
        ...
        <div class="lui_material_preview_option_box">
            <div class="lui_material_preview_option">
                ...
                <span class="lui_text_primary" onclick="resizeImg('origin')">${ lfn:message('sys-modeling-base:modelingMaterialMain.btn.originSize')}</span>
                 <span class="lui_text_primary" onclick="imgRotate('left')">${ lfn:message('sys-modeling-base:modelingMaterialMain.btn.turnLeft')}</span>
                  <span class="lui_material_mark_split "></span>
                <span class="lui_text_primary" onclick="imgRotate('right')">${ lfn:message('sys-modeling-base:modelingMaterialMain.btn.turnRight')}</span>
            </div>
        </div>
    </div>
