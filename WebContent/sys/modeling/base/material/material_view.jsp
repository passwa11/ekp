    ...
    <template:include ref="default.view">
        ...
        <template:replace name="toolbar">
            ...
            <ui:toolbar id="toolbar" layout="sys.ui.toolbar.float" count="3">
                ...
                <!--edit-->
                <kmss:auth requestURL="/sys/modeling/base/modelingMaterialMain.do?method=edit&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.edit')}" onclick="Com_OpenWindow('modelingMaterialMain.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
                </kmss:auth>
                <!--delete-->
                <kmss:auth requestURL="/sys/modeling/base/modelingMaterialMain.do?method=delete&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.delete')}" onclick="deleteDoc('modelingMaterialMain.do?method=delete&fdId=${param.fdId}');" order="4" />
                </kmss:auth>
        ...
        <template:replace name="path">
            <ui:menu layout="sys.ui.menu.nav">
                ...
                <ui:menu-item text="${ lfn:message('sys-modeling-base:table.modelingMaterialMain') }" href="/sys/modeling/base/" target="_self" />
            </ui:menu>
        </template:replace>
