	...
	th.width30{
		...
		<list:listview>
			...
			<list:colTable isDefault="false" layout="sys.ui.listview.columntable">
				...
				<list:col-auto props="fdName,docCreator.fdName,operations"></list:col-auto>
			</list:colTable>
		...
		<list:paging/>
 		...
 		seajs.use([ 'sys/ui/js/dialog' ,'lui/topic'],function(dialog,topic) {
			window.doSetting = function(fdAppModelId){
	 			var url='/sys/modeling/auth/xform_auth/sysModelingXformRightConfig.do?method=load&fdAppModelId=' + fdAppModelId;
