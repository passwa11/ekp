		...
		<td>
			<table class="tb_normal" width=95%>
				...
				<tr>
					...
					<td width="35%">
			             <iframe width="100%" height="100%" src="ModelingAppModelServiceClient.txt"></iframe>
			        </td>
				</tr>	
			</table>
		</td>
		...
		<td>
			<table class="tb_normal" width=95%>
				...
				<tr>
					...
					<td width="35%">
						<iframe width="100%" height="100%" src="modelingAppModelWebServiceUpdateClient.txt"></iframe>
					</td>
				</tr>
			</table>
		</td>
