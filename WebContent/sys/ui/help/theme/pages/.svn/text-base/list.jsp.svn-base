...
<template:include ref="default.list">
	...
	<template:replace name="title">样例-流程管理</template:replace>
			...
			<ui:accordionpanel>
				...
				<ui:content title="${ lfn:message('km-imeeting:kmImeeting.tree.stat') }"
					...
					<ui:menu layout="sys.ui.menu.ver.default">
						...
						<%--个人会议统计--%>
						<ui:menu-popup text="${ lfn:message('km-imeeting:kmImeeting.tree.stat.person')}"
							align="right-top" borderWidth="2"
							icon="lui_icon_s iconfont lui_iconfont_navleft_com_statistics">
							<div style="width: 500px;">
								<ui:dataview>
									<ui:source type="Static">
										[{
	...
	<template:replace name="content">
		<ui:tabpanel layout="sys.ui.tabpanel.list" >
			<ui:content id="customContent" title="我创建的">
			</ui:content>
			<ui:content id="customContent" title="待我审的">
			</ui:content>
		</ui:tabpanel>
		<%-- 筛选器 --%>
		<list:criteria>
		...
		<list:listview id="listview">
			<ui:source type="AjaxJson">
				{url:'/sys/ui/help/theme/data/listview-knowledge.jsp'}
			</ui:source>
			...
			<kmss:ifModuleExist path="/kms/knowledge/">
				<list:gridTable name="gridtable" columnNum="4" gridHref="!{href}">
