...
${param['jsname']}.VarSet.push({
	...
	"getter":function(){
		// 自定义
		if($("input[name='render_borderRadius_${ luivarid }']:checked").val() === 'custom'){
	...
	"setter":function(val){
		// 自定义
		if($.trim(val)==''){
			$("#render_borderRadius_${ luivarid }_theme").attr("checked",true);
			$("#render_borderRadius_${ luivarid }_custom").attr("checked",false);
		}
		else{
			$("#lui_varkind_borderRadius_wrap_tr_${ luivarid }").show();

			$("#render_borderRadius_${ luivarid }_theme").attr("checked",false);
			$("#render_borderRadius_${ luivarid }_custom").attr("checked",true);
...
function changeRadio_${ luivarid }(event){
	if($(event.target).val()===""){
		$("#lui_varkind_borderRadius_wrap_tr_${ luivarid }").hide();
	}else{
		$("#lui_varkind_borderRadius_wrap_tr_${ luivarid }").show();
	}
}
...
<tr>
	...
	<td>
		<label class="varkind_radio"><input type="radio" name="render_borderRadius_${ luivarid }" id="render_borderRadius_${ luivarid }_theme" onclick="changeRadio_${ luivarid }(event)" checked value="">
			<span>
				${ lfn:message('sys-portal:sysPortalPage.follow.theme') }
			</span>
		</label>
		<label class="varkind_radio"><input type="radio" name="render_borderRadius_${ luivarid }" id="render_borderRadius_${ luivarid }_custom" onclick="changeRadio_${ luivarid }(event)" value="custom">
			<span>
				${ lfn:message('sys-portal:sysPortal.portal.diy') }
			</span>
		</label>
	</td>
</tr>
<tr class="lui_varkind_borderRadius_wrap_tr" style="display: none;" id="lui_varkind_borderRadius_wrap_tr_${ luivarid }">
	<td >
	</td>
	<td>
