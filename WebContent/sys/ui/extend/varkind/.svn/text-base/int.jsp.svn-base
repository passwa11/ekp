...
<tr class="lui_varkind_int_wrap_tr">
	<td ><span>${ luivar['require'] ? "<i class='lui_varkind_require'>*</i>" : "" }${ lfn:msg(luivar['name']) }</span></td>
	<td><input class="inputsgl" id="${ luivarid }" style="width:36px;" type="text" value="${luivar['default']}" onkeyup='this.value=this.value.replace(/\D/gi,"")'/>
