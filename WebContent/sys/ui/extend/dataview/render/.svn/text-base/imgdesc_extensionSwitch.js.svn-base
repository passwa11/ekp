...
$('#'+render.dataview.cid+' .lui-image-desc-list-9 .lui-image-desc-list-item:first').addClass('lui-imgdesc-hover');
$('#'+render.dataview.cid+' .lui-image-desc-list-9 .lui-image-desc-list-item').hover(function () {
