define([ 
	...
	return declare("sys.unit.UnitCategoryPath", [ ScrollableCategoryPath, DialogChannelMixin ],
		{
			...
			// 获取详细信息地址
			detailUrl : '/sys/unit/sys_unit_data_center/sysUnitDataCenter.do?method=getCenters&fdId=!{curId}',
