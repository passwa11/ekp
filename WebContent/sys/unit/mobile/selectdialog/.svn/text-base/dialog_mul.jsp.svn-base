	...
	<div id="defaultView_{categroy.key}" data-dojo-type="dojox/mobile/View" >
        ...
        <div id="unitGroupView_{categroy.key}" data-dojo-type="dojox/mobile/View" >
				...
				data-dojo-props="scrollBar:false,threshold:100,key:'{categroy.key}',channel:'group'">
					...
					data-dojo-props="showAllGroup:${param.showAllGroup},isMul:{categroy.isMul},key:'{categroy.key}',allDataUrl:'{categroy.listDataUrl}',fieldParam:'{categroy.fieldParam}',curIds:'{categroy.curIds}',curNames:'{categroy.curNames}',selType:2,exceptValue:'{categroy.exceptValue}',channel:'group'">
				</ul>
	        </div>
       	</div>
		<c:if test="${showDec}">
