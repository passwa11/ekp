	...
	<template:replace name="content">
		...
		<list:listview>
			<ui:source type="AjaxJson">
				{url:'/sys/lbpmservice/support/LbpmToolsAction.do?method=listNodeName&cateIds=${JsParam.cateIds}&modelNames=${JsParam.modelNames}&templateIds=${JsParam.templateIds}&nodeName='+encodeURIComponent('${JsParam.nodeName}')}
			</ui:source>
