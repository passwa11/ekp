define([ "dojo/_base/declare", "dijit/_WidgetBase", "mui/util",
	...
	return declare('sys.lbpmservice.ding.audit.note', [ widgetBase, Contained,
			Container ], {

		url : '/sys/lbpmservice/support/lbpm_audit_note/lbpmAuditNote.do?method=listNote4Ding',
		...
		doLoad : function() {
			...
			this.getText(function(text) {
				...
				self.container = domConstruct.create('div', {
					className : 'muiDingAuditContainer'
				}, self.domNode, 'last');
