			...
			<c:if test="${param.viewName != 'none'}">
			 ...
			 data-dojo-mixins="sys/lbpmservice/mobile/common/_LbpmValidateMixin">
							...
							<c:if test="${sysWfBusinessForm.docStatus == null || sysWfBusinessForm.docStatus<'20'}">
								...
								<tr>
									<td colspan="2" style="display:none;">
										...
										<div  class="detailNode dingNodeContent" id="nextNodeTD">
											&nbsp;
										</div>
									</td>
								</tr>
						...
						<table class="muiSimple" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td colspan="2" id="notifyLevelRow" class="notifyLevelRow">
									<div class="titleNode operation_title dingNodeTitle">
				...
				<c:if test="${param.viewName != ''}">
					<ul id='lbpmViewOperationTabBar' data-dojo-type="mui/tabbar/TabBar" fixed="bottom" class="muiViewBottom">
						<li data-dojo-type="mui/tabbar/TabBarButton" data-dojo-props='id:"process_cancel_button",totalCopies:6,proportion:3' class="muiSplitterButton lbpmCancel"
						onclick="closeDialog()">
							<bean:message  key="button.cancel" /> 
						</li>
						<c:if test="${sysWfBusinessForm.docStatus<'30'}">
						<li data-dojo-type="mui/tabbar/TabBarButton" data-dojo-props='id:"process_review_button",totalCopies:6,proportion:3' class="mainTabBarButton lbpmSubmit"
						...
						<c:if test="${sysWfBusinessForm.docStatus>='30'}">
						<li data-dojo-type="mui/tabbar/TabBarButton" data-dojo-props='colSize:3'></li>
						</c:if>
					</ul>	
				</c:if>
				</div>
