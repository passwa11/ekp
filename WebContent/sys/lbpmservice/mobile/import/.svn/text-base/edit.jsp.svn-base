					...
					<td colspan="2"  id = "commonUsagesRow">
						...
						<c:if test="${isOpinionTypeEnabled eq 'true'}">
							<div id="opinionConfig">
								...
								<script type="text/javascript">
								require(["dijit/registry","dojo/topic","dojox/mobile/sniff","mui/device/device","dojo/query","dojo/dom-style","dojo/Deferred"], function(registry,topic,has,device,query,domStyle,Deferred) {
