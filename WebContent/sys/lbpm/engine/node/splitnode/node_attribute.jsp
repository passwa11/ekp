...
/* AttributeObject.CheckDataFuns.push(function(data) {
	if (data.splitType == "condition" || data.splitType == "custom") {
		if (data.startBranchHandlerId == "") {
			alert('<kmss:message key="FlowChartObject.Lang.Node.startBranchHandlerNotNull" bundle="sys-lbpm-engine-node-splitnode" />');
			return false;
		}
	} 
}); */
