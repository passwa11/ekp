...
<%@page import="com.landray.kmss.sys.oms.util.SysOmsUtil" %>
    ...
    <template:include ref="default.view">
        ...
        <template:replace name="title">
            <c:out value="${sysOmsOrgForm.fdName} - " />
            <c:out value="${ lfn:message('sys-oms:table.sysOmsOrg') }" />
        </template:replace>
        <template:replace name="toolbar">
            <script>
                ...
                var viewOption = {
                    ...
                    basePath: '/sys/oms/sys_oms_org/sysOmsOrg.do',
                    customOpts: {
            ...
            <ui:toolbar id="toolbar" layout="sys.ui.toolbar.float" count="3">
                ...
                <!--edit-->
                <kmss:auth requestURL="/sys/oms/sys_oms_org/sysOmsOrg.do?method=edit&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.edit')}" onclick="Com_OpenWindow('sysOmsOrg.do?method=edit&fdId=${param.fdId}','_self');" order="2" />
                </kmss:auth>
                <!--delete-->
                <kmss:auth requestURL="/sys/oms/sys_oms_org/sysOmsOrg.do?method=delete&fdId=${param.fdId}">
                    <ui:button text="${lfn:message('button.delete')}" onclick="deleteDoc('sysOmsOrg.do?method=delete&fdId=${param.fdId}');" order="4" />
                </kmss:auth>
        ...
        <template:replace name="path">
            <ui:menu layout="sys.ui.menu.nav">
                ...
                <ui:menu-item text="${ lfn:message('sys-oms:table.sysOmsOrg') }" href="/sys/oms/sys_oms_org/" target="_self" />
            </ui:menu>
        </template:replace>
                ...
                <ui:content title="${ lfn:message('sys-oms:py.JiBenXinXi') }" expand="true">
                    <div class='lui_form_title_frame'>
                        <div class='lui_form_subject'>
                            ${lfn:message('sys-oms:table.sysOmsOrg')}
                        </div>
                    ...
                    <table class="tb_normal" width="100%">
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdName')}
                            </td>
                            <td width="35%">
                                <%-- 名称--%>
                            ...
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdIsAvailable')}
                            </td>
                            <td width="35%">
                                <%-- 是否有效--%>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdShortName')}
                            </td>
                            <td width="35%">
                                <%-- 简称--%>
                            ...
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdNo')}
                            </td>
                            <td width="35%">
                                <%-- 编号--%>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdKeyword')}
                            </td>
                            <td width="35%">
                                <%-- 关键字--%>
                            ...
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdImportinfo')}
                            </td>
                            <td width="35%">
                                <%-- 映射关系--%>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdIsBusiness')}
                            </td>
                            <td width="35%">
                                <%-- 是否业务相关--%>
                            ...
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdMemo')}
                            </td>
                            <td width="35%">
                                <%-- 备注--%>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdThisLeader')}
                            </td>
                            <td width="35%">
                                <%-- 本级领导--%>
                            ...
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdSuperLeader')}
                            </td>
                            <td width="35%">
                                <%-- 上级领导--%>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdParent')}
                            </td>
                            <td width="35%">
                                <%-- 上级部门--%>
                            ...
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdRecordStatus')}
                            </td>
                            <td width="35%">
                                <%-- 更新状态--%>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdCreateTime')}
                            </td>
                            <td width="35%">
                                <%-- 创建时间--%>
                            ...
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdAlterTime')}
                            </td>
                            <td width="35%">
                                <%-- 更新时间--%>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdLdapDn')}
                            </td>
                            <td width="35%">
                                <%-- LDAP DN--%>
                            ...
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdHandleStatus')}
                            </td>
                            <td width="35%">
                                <%-- 处理状态--%>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdCreator')}
                            </td>
                            <td width="35%">
                                <%-- 创建者--%>
                            ...
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdOrgEmail')}
                            </td>
                            <td width="35%">
                                <%-- 组织邮箱--%>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdOrder')}
                            </td>
                            <td width="35%">
                                <%-- 排序号--%>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdDynamicMap')}
                            </td>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdCustomMap')}
                            </td>
                            <td colspan="3" width="85.0%">
                                <%-- 自定义参数--%>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdAuthAdmins')}
                            </td>
                            <td colspan="3" width="85.0%">
                                <%-- 管理员--%>
                        ...
                        <tr>
                            <td class="td_normal_title" width="15%">
                                ${lfn:message('sys-oms:sysOmsOrg.fdViewRange')}
                            </td>
                            <td colspan="3" width="85.0%">
                                <%-- 查看范围--%>
