define([
	...
	"sys/attend/mobile/resource/js/stat/AttendMStatItemMixin"
	], function(declare,locale,muiMsg,query, topic,viewRegistry,registry,domStyle, lang,util, _TemplateItemListMixin, AttendMStatItemMixin) {
	
	return declare("sys.attend.AttendMStatItemListMixin", [_TemplateItemListMixin], {
		
		itemTemplateString : null,
		
		itemRenderer: AttendMStatItemMixin,
