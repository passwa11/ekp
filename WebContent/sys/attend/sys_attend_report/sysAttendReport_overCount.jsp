			 	...
			 	<div style="margin-top: 20px; padding: 0 30px;">
				 	<table class="tb_normal" width=100%>
				 		...
				 		<tr>
							...
							<td>
								<input type="hidden" name="fdDateType" value="1">
								<%-- 按月统计 --%>
					 	...
					 	<tr>
					 		...
					 		<td>
					 			<xform:checkbox property="fdShowCols" showStatus="edit" isArrayValue="false" value="fdStaffNo;docCreator.fdName;fdDept;fdEntryTime;fdCategoryName;fdMonth;fdShouldDays;fdHolidays;fdWorkDateDays;fdActualDays;fdStatusDays;fdAbsentDays;fdTripDays;fdOffDays;fdLateCount;fdLateExcCount;fdLateTime;fdLeftCount;fdLeftExcCount;fdLeftTime;fdOutsideCount;fdMissedCount;fdMissedExcCount;fdTotalTime;fdOverTime;fdWorkOverTime;fdOffOverTime;fdHolidayOverTime;fdOutgoingTime;${fdoffTypeNames }" onValueChange="changeColumn">
									<xform:simpleDataSource value="fdMonth">月份</xform:simpleDataSource>
									...
									<%--加班费工时--%>
									<xform:simpleDataSource value="fdWorkOverPayTime">实际加班费平日加班</xform:simpleDataSource>
									<xform:simpleDataSource value="fdOffOverPayTime">实际加班费周末加班</xform:simpleDataSource>
									<xform:simpleDataSource value="fdHolidayOverPayTime">实际加班费法定节假日加班</xform:simpleDataSource>
									<xform:simpleDataSource value="fdOverPayTime">实际加班费小时</xform:simpleDataSource>
									<%--加班费申请工时--%>
									<xform:simpleDataSource value="fdWorkOverPayApplyTime">申请加班费平日加班</xform:simpleDataSource>
									<xform:simpleDataSource value="fdOffOverPayApplyTime">申请加班费周末加班</xform:simpleDataSource>
									<xform:simpleDataSource value="fdHolidayOverPayApplyTime">申请加班费法定节假日加班</xform:simpleDataSource>
									<xform:simpleDataSource value="fdOverPayApplyTime">申请加班费小时</xform:simpleDataSource>
									<%--调休工时--%>
									<xform:simpleDataSource value="fdWorkOverTurnTime">实际调休平日加班</xform:simpleDataSource>
									<xform:simpleDataSource value="fdOffOverTurnTime">实际调休周末加班</xform:simpleDataSource>
									<xform:simpleDataSource value="fdHolidayOverTurnTime">实际调休法定节假日加班</xform:simpleDataSource>
									<xform:simpleDataSource value="fdOverTurnTime">实际调休小时</xform:simpleDataSource>
									<%--调休申请工时--%>
									<xform:simpleDataSource value="fdWorkOverTurnApplyTime">申请调休平日加班</xform:simpleDataSource>
									<xform:simpleDataSource value="fdOffOverTurnApplyTime">申请调休周末加班</xform:simpleDataSource>
									<xform:simpleDataSource value="fdHolidayOverTurnApplyTime">申请调休法定节假日加班</xform:simpleDataSource>
									<xform:simpleDataSource value="fdOverTurnApplyTime">申请调休小时</xform:simpleDataSource>
									<%--加班结转工时--%>
									<xform:simpleDataSource value="fdWorkOverRestTime">平时加班结转工时</xform:simpleDataSource>
									<xform:simpleDataSource value="fdOffOverRestTime">周末加班结转工时</xform:simpleDataSource>
									<xform:simpleDataSource value="fdHolidayOverRestTime">法定节假日加班结转工时</xform:simpleDataSource>
									<xform:simpleDataSource value="fdOverRestTime">加班结转工时</xform:simpleDataSource>
									<%--加班结转工时--%>
									<xform:simpleDataSource value="fdWorkRestTurnTime">平时结转调休工时</xform:simpleDataSource>
									<xform:simpleDataSource value="fdOffRestTurnTime">周末结转调休工时</xform:simpleDataSource>
									<xform:simpleDataSource value="fdHolidayRestTurnTime">法定节假日结转调休工时</xform:simpleDataSource>
									<xform:simpleDataSource value="fdRestTurnTime">结转调休工时</xform:simpleDataSource>
								</xform:checkbox>
					 		</td>
					 	</tr>
				 	</table>
			 ...
			 <div class="lui-attend-stat-table lui_attend_report_list" style="display:none;">
			 	<list:listview id="monthListview">
					...
					<list:colTable isDefault="false" layout="sys.attend.listview.month">
						...
						<list:col-auto props="fdMonth;fdFirstLevelDepartment;fdSecondLevelDepartment;fdThirdLevelDepartment"></list:col-auto>
						<list:col-auto props="fdStaffNo;fdOrgPost;fdStaffingLevel"></list:col-auto>
						<list:col-auto props="docCreator.fdName;"></list:col-auto>

						<list:col-column property="fdWorkOverPayTime" sort="fdWorkOverPayTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdWorkOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdOffOverPayTime" sort="fdOffOverPayTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdOffOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdHolidayOverPayTime" sort="fdHolidayOverPayTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdHolidayOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdOverPayTime" sort="fdOverPayTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>

						<list:col-column property="fdWorkOverPayApplyTime" sort="fdWorkOverPayApplyTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdWorkOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdOffOverPayApplyTime" sort="fdOffOverPayApplyTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdOffOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdHolidayOverPayApplyTime" sort="fdHolidayOverPayApplyTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdHolidayOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdOverPayApplyTime" sort="fdOverPayApplyTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>

						<list:col-column property="fdWorkOverTurnTime" sort="fdWorkOverTurnTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdWorkOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdOffOverTurnTime" sort="fdOffOverTurnTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdOffOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdHolidayOverTurnTime" sort="fdHolidayOverTurnTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdHolidayOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdOverTurnTime" sort="fdOverTurnTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>

						<list:col-column property="fdWorkOverTurnApplyTime" sort="fdWorkOverTurnApplyTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdWorkOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdOffOverTurnApplyTime" sort="fdOffOverTurnApplyTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdOffOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdHolidayOverTurnApplyTime" sort="fdHolidayOverTurnApplyTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdHolidayOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdOverTurnApplyTime" sort="fdOverTurnApplyTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>

						<list:col-column property="fdWorkOverRestTime" sort="fdWorkOverRestTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdWorkOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdOffOverRestTime" sort="fdOffOverRestTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdOffOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdHolidayOverRestTime" sort="fdHolidayOverRestTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdHolidayOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdOverRestTime" sort="fdOverRestTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						
						<list:col-column property="fdWorkRestTurnTime" sort="fdWorkRestTurnTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdWorkOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdOffRestTurnTime" sort="fdOffRestTurnTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdOffOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdHolidayRestTurnTime" sort="fdHolidayRestTurnTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdHolidayOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
						<list:col-column property="fdRestTurnTime" sort="fdRestTurnTime" headerClass="lui_thead" title="${ lfn:message('sys-attend:sysAttendStatMonth.fdOverTime.br') }" headerStyle="min-width: 100px;"></list:col-column>
					</list:colTable>
				</list:listview> 
	 		...
	 		seajs.use(['lui/jquery','lui/dialog','lui/topic','lui/data/source','sys/attend/resource/js/dateUtil'], function($, dialog , topic, Source, dateUtil){
				...
				window.listReport = function(){
					...
					var doSearch = function(dateType){
						if(dateType == '1'){
							var __url = '/sys/attend/sys_attend_report/sysAttendReport.do?method=listReport&fdType=over&r='+Math.random();
				...
				window.exportReport = function(){
					...
					var dateType = $('[name="fdDateType"]').val();
					if(dateType == '1'){
						console.log($(document.forms['monthForm']).serializeArray());
						window.top.exportCommon('${KMSS_Parameter_ContextPath}sys/attend/sys_attend_report/sysAttendReport.do?method=exportReport&fdType=over',$(document.forms['monthForm']).serializeArray(),"2");
