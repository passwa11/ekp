...
$(function(){
	...
	createSelectHTML('#fdOverHandle', 'fdOverHandle', 'String;String[]');
	createSelectHTML('#fdMealTimes', 'fdMealTimes', 'String;String[]');
});
...
<table id="List_ViewTable" class="tb_normal" width="98%">
	...
	<tr height="21">
		...
		<td id='fdOverHandle'>
			<span class="txtstrong">*</span><span style="margin-left: 5px;color: #999">只支持字符格式</span>
		</td>
	</tr>
	<tr height="21">
		<td class="td_normal_title" width="20%">
