...
<list:data>
	<list:data-columns var="sysAttendMain" list="${queryPage.list}" varIndex="status">
		...
		<list:data-column col="fdBaseWorkDate"  title="${lfn:message('sys-attend:sysAttendStatDetail.fdDate') }">
			<fmt:formatDate value="${sysAttendMain.fdBaseWorkTime}" pattern="yyyy-MM-dd" />
		</list:data-column>
		<list:data-column col="docCreateTime"  title="${_docCreateTime }">
			<fmt:formatDate value="${sysAttendMain.docCreateTime}" pattern="HH:mm" />
		</list:data-column>
		<list:data-column col="fdBaseWorkTime"  title="${ lfn:message('sys-attend:sysAttendMain.fdBaseWorkTime') }">
			<fmt:formatDate value="${sysAttendMain.fdBaseWorkTime}" pattern="HH:mm" />
		</list:data-column>

		<list:data-column col="docCreator" title="${ lfn:message('sys-attend:sysAttendMain.docCreator') }">
			<c:out value="${sysAttendMain.docCreator.fdName}" />
		</list:data-column>
		<list:data-column col="docCreatorDept" title="${ lfn:message('sys-attend:sysAttendMain.docCreatorDept') }">
			<c:out value="${sysAttendMain.docCreator.fdParent.deptLevelNames}" />
		</list:data-column>

		<list:data-column col="fdWeek" title="${ lfn:message('sys-attend:sysAttendCategoryTimesheet.fdWeek') }">
			<sunbor:enumsShow value="${sysAttendMain.docCreateTime.getDay()}" enumsType="sysAttendCategory_fdWeek" />
		</list:data-column>
		...
		<list:data-column col="fdWorkType" title="${ lfn:message('sys-attend:sysAttendMain.fdWorkType') }">
			<c:if test="${sysAttendMain.fdWorkType==0}">
				${ lfn:message('sys-attend:sysAttendMain.fdWorkType.onwork') }
			</c:if>
			<c:if test="${sysAttendMain.fdWorkType==1}">
