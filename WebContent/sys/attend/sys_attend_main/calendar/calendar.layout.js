seajs.use(['lang!','lang!sys-ui'],function(lang,uilang){
	...
	function createHeader(){
		...
		$('<div class="lui_calendar_header_date" cal-mode="attendCalendar"/>').attr('title',uilang['ui.calendar.mode.list']).appendTo(rightTd).click(function(){
			calendar.changeMode('attendCalendar');
		});
	...
	function displayChange(info){
		...
		if(mode=="default" || mode=="attendCalendar"){
