...
<div class="lui_summary_dataview_content">
    <div class="lui_summary_list">
        <ul>
            ...
            {$
            <li class="lui_summary_item" data-item-fdId="{%item.fdTemplateId%}" data-item-fdName="{%item.templateName%}" data-href="{%Com_Parameter.ContextPath%}{%item.addUrl%}" onclick="Com_OpenNewWindow(this)">
