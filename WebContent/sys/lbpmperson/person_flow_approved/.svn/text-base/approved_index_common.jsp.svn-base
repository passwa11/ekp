...
<list:criteria channel="channel_common_approved" id="criteria1" expand="false"
	...
	<%--处理时间--%>
	<list:cri-ref ref="criterion.sys.calendar" key="resolveTime"
	  	title="${lfn:message('sys-lbpmperson:lbpmperson.person.resolveTime') }" />
		...
		<div style="display: inline-block; vertical-align: middle;">
			<ui:toolbar layout="sys.ui.toolbar.sort" style="float:left" count="6" channel="channel_common_approved">
				...
				<c:if
					...
					<list:sort property="resolveTime"
						   text="${lfn:message('sys-lbpmperson:lbpmperson.order.resolveTime')}"
						   group="sort.list" value="down"></list:sort>
				</list:sortgroup>
			</ui:toolbar>
		</div>
...
<list:listview id="list_approved" channel="channel_common_approved">
	<ui:source type="AjaxJson">
													{url:'/sys/lbpmperson/sys_lbpmperson_myprocess/SysLbpmPersonMyProcess.do?method=listApprovedData&modelName=${JsParam.modelName }&fdStatus=${JsParam.fdStatus}&fdType=${JsParam.fdType}'}
											</ui:source>
