	...
	<template:replace name="content">
		...
		<list:listview cfg-needMinHeight="false">
			<ui:source type="AjaxJson">
				{url:'/sys/organization/sys_org_dept/sysOrgDept.do?method=list&fdIsExternal=false&available=${JsParam.available}&all=${JsParam.all}&sys_page=${JsParam.sys_page}&parent=${JsParam.parent}&fdFlagDeleted=${JsParam.fdFlagDeleted}&fdImportInfo=${JsParam.fdImportInfo}'}
			</ui:source>
