			...
			<div style="border: 1px #e8e8e8 solid;padding: 5px;height:auto;">
				<list:listview id="sourceList">
					<ui:source type="AjaxJson">
						{"url":"/sys/xform/sys_form_common_template_new/sysFormCommonTemplate.do?method=data&isInSide=1&rowsize=8&fdModelName=${JsParam.fdModelName}&fdKey=${JsParam.fdKey}"}
					</ui:source>
