define([
  ...
  "dojo/date/locale",
  "dojo/date/stamp",
  "mui/datetime/SpinWheelDatePicker_yearMonth",
      ...
      for (var i = 0; i < len; i++) {
        ...
        array.forEach(
            ...
            function(node) {
              ...
              tmpHtml =
                  tmpHtml +
                  '<span style="display: none;" class="mblSpainWheelSlotLabelText">' +
                  this.disText +
                  "</span>";
  ...
  var claz = declare("mui.datetime.DatePicker_yearMonth", [SpinWheelDatePicker_yearMonth], {
    yearPattern: "yyyy",
    ...
    _getValueAttr: function() {
      ...
      var dateStr= datestamp.toISOString(date, { selector: "date" });

      var result = datelocale.format(date, {
        datePattern: "yyyy-MM",
        selector: "date"
      });
      return result;
