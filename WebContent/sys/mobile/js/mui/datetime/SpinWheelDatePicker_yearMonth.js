define([
	...
	"dojo/_base/declare",
	"dojo/dom-class",
	"mui/datetime/_DatePickerMixin_yearMonth",
	"dojox/mobile/SpinWheel",
	"dojox/mobile/SpinWheelSlot"
], function(array, declare, domClass, _DatePickerMixin_yearMonth, SpinWheel, SpinWheelSlot){

	// module:
	//		dojox/mobile/SpinWheelDatePicke

	return declare("mui.datetime.SpinWheelDatePicker_yearMonth", [SpinWheel, _DatePickerMixin_yearMonth], {
		// summary:
