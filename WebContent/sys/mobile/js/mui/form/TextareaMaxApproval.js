define([
  ...
  Textarea
	...
	var claz = declare("mui.form.TextareaMaxApproval", [Textarea], {
	    // 构建编辑视图
	    buildEdit: function () {
	      ...
	      textareaNodeBox.innerHTML =
	        "<textarea class='muiTextarea muiScaleTextarea' name=" + this.name + "></textarea><i class='textarea_dropbox_icon'></i>";
