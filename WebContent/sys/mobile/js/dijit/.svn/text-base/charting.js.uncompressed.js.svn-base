...
define(["../main", "dojo/_base/lang", "dojo/_base/array","dojo/_base/declare", "dojo/dom-style",
	...
	"dojox/gfx", "require", "dojox/lang/functional", "dojox/lang/functional/fold", "dojox/lang/functional/reversed"],
	...
	var Chart = declare( false ? "dojox.charting.NonBidiChart" : "dojox.charting.Chart", null, {
		// summary:
		...
		_renderTitle: function(dim, offsets){
			...
			var forceHtmlLabels = (g.renderer == "canvas") && this.htmlLabels,
				labelType = forceHtmlLabels || !has("ie") && ! false  && this.htmlLabels ? "html" : "gfx",
				tsize = g.normalizedLength(g.splitFontString(this.titleFont).size),
				tBox = g._base._getTextBox(this.title,{ font: this.titleFont });
				
			var titleAlign = this.titleAlign;
			var isRtl =  false  && this.isRightToLeft();
	...
	return  false ? declare("dojox.charting.Chart", [Chart, BidiChart]) : Chart;
});
...
define(["dojo/_base/lang", "dojo/_base/array", "dojo/sniff", "dojo/_base/declare",
	...
	var Default = declare( false ? "dojox.charting.axis2d.NonBidiDefault" : "dojox.charting.axis2d.Default", Invisible, {
		// summary:
		...
		render: function(dim, offsets){
			...
			var s = this.group,
				...
				labelType = (!o.title || !titleRotation) && !rotation && this.opt.htmlLabels && !has("ie") && ! false  ? "html" : "gfx",
	...
	return  false ? declare("dojox.charting.axis2d.Default", [Default, BidiDefault]) : Default;
});
...
define(["dojo/_base/lang", "dojo/_base/array" ,"dojo/_base/declare", "dojo/dom-geometry", "dojo/_base/Color",
	...
	return declare("dojox.charting.plot2d.Pie", [Base, PlotEvents], {
		...
		render: function(dim, offsets){
			...
			// draw labels
			if(this.opt.labels){
				var isRtl =  false  && this.chart.isRightToLeft();
