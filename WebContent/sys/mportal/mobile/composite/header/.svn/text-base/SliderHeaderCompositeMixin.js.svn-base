	...
	buildTmpl: function() {
      ...
      if (this.headerType == "1") {
        this.tmpl =
          ...
          "			</li>" +
          "		</ul>" +
          '		<div data-dojo-type="sys/mportal/mobile/composite/header/SliderHeaderSearchBtn" data-dojo-props="searchHost:\'' +
          config.searchHost +
        ...
        this.tmpl =
          "<div>" +
          '	<div class="mui_ekp_portal_title_info_sec_container" data-dojo-type="sys/mportal/mobile/composite/header/HeaderRobot" data-dojo-props="itEnabled:\'' +
          config.itEnabled +
          "',logo:'" +
          this.logo +
          "',itUrl:'" +
