...
<input type="hidden" name="openType" value="online">
<!-- 标题栏 -->
		...
		<ul>
			<li style="list-style-type:none;">
				<div >
					...
					<a href="javascript:addseal(1);" class="tipFont"><img src="${KMSS_Parameter_ContextPath}sys/attachment/view/img/esignature-min.png" style="vertical-align:text-top;">${lfn:message('sys-attachment:attachment.signature.e')}</a>
					&nbsp;&nbsp;
					<a href="javascript:saveFileServer('${KMSS_Parameter_ContextPath}sys/attachment/sys_att_main/dianju/format/dianju_format_save.jsp?attMainId=${attMainId}&type=attachment','${attMainFileName}');" class="tipFont">
