...
<%
	...
	request.setAttribute("_isWpsoaassistEmbed", new Boolean(SysAttWpsoaassistUtil.isWPSOAassistEmbed(request)));
%>

<c:choose>
	<c:when test="${_isWpsoaassistEmbed == 'true'&&isUseWpsLinux=='true'}">
