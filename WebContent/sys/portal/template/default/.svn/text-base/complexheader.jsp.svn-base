...
<div class="lui_portal_header_complex_frame${ param['scene'] eq 'portal' ? '' : ' ' }">
	<div style="width: ${ empty param['width'] ? '980px' : param['width'] };min-width:980px;max-width:${ param['width'] == '100%' ? '100%' : fdHeaderMaxWidth };"  class="lui_portal_header_complex_content clearfloat">
	...
	<div style="width: ${ empty param['width'] ? '980px' : param['width'] };min-width:980px;max-width:${ param['width'] == '100%' ? '100%' : fdHeaderMaxWidth };"  class="lui_portal_header_complex_menu clearfloat">
