...
<div class="lui_portal_header_simple_frame${ param['scene'] eq 'portal' ? '' : ' lui_portal_header_nofixed' }">
	...
	<div style="width: ${ empty param['width'] ? '980px' : param['width'] };min-width:980px;max-width:${ param['width'] == '100%' ? '100%' : fdHeaderMaxWidth };"  class="lui_portal_header_simple_content clearfloat">
	...
	<div class="lui_portal_header_simple_menu_wrapper">
		<div style="width: ${ empty param['width'] ? '980px' : param['width'] };min-width:980px;max-width:${ param['width'] == '100%' ? '100%' : fdHeaderMaxWidth };"  class="lui_portal_header_simple_menu clearfloat">
