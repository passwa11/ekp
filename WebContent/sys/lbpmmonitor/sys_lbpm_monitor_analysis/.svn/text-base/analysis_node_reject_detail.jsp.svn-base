	   ...
	   seajs.use(['lui/jquery','lui/dialog','lui/topic'], function($ ,dialog, topic) {
		 ...
		 //待办最多的流程
			 ...
			 rejectNodeItem.on('click', function (param) { 
			       ...
			       dialog.iframe('/sys/lbpmmonitor/sys_lbpm_monitor_analysis/analysis_list.jsp?fdNodeId=' + fdNodeId+"&fdTempletModelId="+fdTempletModelId+"&fdCreateTime="+ createTime+"&excuteType=reject",
				 			"流程清单", null, {
						width : 960,
						height : 400
					});
