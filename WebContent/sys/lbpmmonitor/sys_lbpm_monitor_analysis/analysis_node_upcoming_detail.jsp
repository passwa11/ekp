	   ...
	   seajs.use(['lui/jquery','lui/dialog','lui/topic'], function($ ,dialog, topic) {
		   ...
		   var createTime="";
			 ...
			 upcomingNodeItem.on('click', function (param) { 
			       ...
			       dialog.iframe('/sys/lbpmmonitor/sys_lbpm_monitor_analysis/analysis_list.jsp?fdNodeId=' + fdNodeId+"&fdTempletModelId="+fdTempletModelId+"&fdCreateTime="+ createTime+"&excuteType=upcomingNode",
				 			"流程清单", null, {
						width : 960,
						height : 400
					});
				    ...
				    if(data.criterions.length>1){
				    	for(var i=0;i<data.criterions[1].value.length;i++){
				    		if("fdModelName" === data.criterions[1].key){
				    			console.log("key:"+data.criterions[1].key);
