	   ...
	   seajs.use(['lui/jquery','lui/dialog','lui/topic'], function($ ,dialog, topic) {
		   ...
		   var createTime="";
			 ...
			 peopleUrgentItem.on('click', function (param) { 
			       ...
			       dialog.iframe('/sys/lbpmmonitor/sys_lbpm_monitor_analysis/analysis_list.jsp?fdPersonId=' + fdPersonId+"&status=20&excuteType=peopleUrgent&fdModelName="+modelName+"&fdCreateTime="+ createTime,
				 			"流程清单", null, {
						width : 960,
						height : 400
					});
