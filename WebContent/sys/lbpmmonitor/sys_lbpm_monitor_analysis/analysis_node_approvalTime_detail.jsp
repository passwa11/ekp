...
<template:include ref="default.simple">
	...
	<list:criteria channel="channel_common_approve"  expand="false" multi="false">
		...
		<list:cri-auto modelName="com.landray.kmss.sys.lbpm.engine.persistence.model.LbpmProcess" title="时间范围" property="fdCreateTime" /> 
	</list:criteria>
      ...
      <div class="lui-flowMonitor-tab-pane fade active in">
	   ...
	   seajs.use(['lui/jquery','lui/dialog','lui/topic'], function($ ,dialog, topic) {
			 ...
			 nodeApprovalTimeItem.on('click', function (param) { 
			       ...
			       dialog.iframe('/sys/lbpmmonitor/sys_lbpm_monitor_analysis/analysis_list.jsp?fdNodeId=' + fdNodeId+"&fdTempletModelId="+fdTempletModelId+"&fdCreateTime="+ createTime,
				 			"流程清单", null, {
						width : 960,
						height : 400
					});
