...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="${ LUI_ContextPath }/third/mall/resource/css/templateList.css?s_cache=${LUI_Cache}"/>
    <title>
...
<body class="lui_print_body" style="height:100%;">
                ...
                <div>
                    ...
                    <c:if test="${'true' eq isExist}">
                        <ui:iframe id="main_show_iframe"
                                   src='${LUI_ContextPath }/third/mall/thirdMallPublic.do?method=publicIndex&type=sysMain'>
                        </ui:iframe>
                    </c:if>
