	...
	<template:replace name="body">
		...
		<script type="text/javascript">
			...
			function serializeObject(form) {
				...
				var _s = new Array("fdPerson","fdProLongDate","fdLeaveType","fdYear");
			...
			LUI.ready(function(){
				createSelectElementHTML("fdPerson");
				createSelectElementHTML("fdProLongDate");
				createSelectElementHTML("fdLeaveType");
				createSelectElementHTML("fdYear");
				setLeaveType();
			});
		...
		<center>
			<form id="mainForm" action="">
				...
				<table width="100%" class="tb_normal">
					...
					<tr align="center">
						<td>姓名</td><td id="fdPerson"></td>
						<td>年度</td><td id="fdYear"></td>
					</tr>
					<tr align="center">
						<td>延长日期</td><td id="fdProLongDate"></td>
						<td>假期类型</td><td id="fdLeaveType"></td>
					</tr>
				</table>
			</form>
		</center>
