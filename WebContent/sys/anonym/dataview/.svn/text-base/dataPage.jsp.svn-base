		...
		<div style="margin: 5px 10px;">
            ...
            <div class="lui_list_operation">
                ...
                <div style="float:left">
                    <div style="display: inline-block;vertical-align: middle;padding-top: 8px;">
			...
			<list:listview id="listview">
				<ui:source type="AjaxJson">
                    {url:appendQueryParameter('/sys/anonym/sysAnonymData.do?method=dataCommonList&formatKey=listTable&fdModelName=${JsParam.fdModelName}&fdCategoryId=${JsParam.fdCategoryId}&rowsize=${JsParam.rowsize}')}
                </ui:source>
				<!-- 列表视图 -->
